...
def saveresults(r, df, program, index, chunk, MaxChunk=150, elements=1, fields =None):
                ...
                if len(r["results"]) > 0:
                    ...
                    for key in r["results"]:
                        ...
                        if "errorMessage" in key:
                            ...
                            if(len(records) > 0 and fields is not None and len(fields) > 0):
                                fields_list = fields.split("|")
                                for field in fields_list:
                                    for record in records:
                                        df.loc[newindex, field] = record[field]
