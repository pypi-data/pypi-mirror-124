...
class StateFileLocator(abc.ABC):
 location="_none_"
 active_instance=mMDlS
 @abc.abstractmethod
 def get_state_file_location_by_key(self,key:mMDlW)->mMDlW:
  pass
 @mMDlI
 def get(cls,requested_file_locator:mMDlW):
...
class ObjectStorageProvider(abc.ABC):
 ...
 active_instance=mMDlS
 @mMDlI
 def get(cls,state_file_locator:mMDlW,requested_storage:mMDlW,serializers:Dict[mMDlW,CPVCSSerializer]):
  ...
  return cls.active_instance
 def __init__(self,state_file_locator:StateFileLocator,serializers:Dict[mMDlW,CPVCSSerializer]):
 ...
 def get_state_file_location_by_key(self,key:mMDlW)->mMDlW:
  pass
 @abc.abstractmethod
 def get_version_by_key(self,key:mMDlW)->Version:
  pass
 @abc.abstractmethod
 def get_revision_by_key(self,key:mMDlW)->Revision:
  pass
 @abc.abstractmethod
 def get_revision_or_version_by_key(self,key:mMDlW)->Union[Revision,Version]:
  pass
 @abc.abstractmethod
 def get_delta_file_by_key(self,key:mMDlW)->mMDlW:
  pass
 @abc.abstractmethod
 def upsert_objects(self,*args:CPVCSObj)->List[mMDlW]:
  pass
 @abc.abstractmethod
 def update_revision_key(self,old_key:mMDlW,new_key:mMDlW,referenced_by_version:mMDlW=mMDlS):
  pass
 @abc.abstractmethod
 def version_exists(self,key:mMDlW)->mMDlT:
  pass
 @abc.abstractmethod
 def _update_key(self,old_key:mMDlW,new_key:mMDlW,base_path:mMDlW)->mMDlT:
  pass
 @abc.abstractmethod
 def _serialize(self,*args:CPVCSObj)->List[mMDlW]:
  pass
 @abc.abstractmethod
 def _deserialize(self,key_serializer:Dict[mMDlW,mMDlW])->List[CPVCSObj]:
  pass
