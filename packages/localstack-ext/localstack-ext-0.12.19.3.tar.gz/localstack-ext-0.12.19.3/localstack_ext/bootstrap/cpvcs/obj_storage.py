...
class StateFileLocator(abc.ABC):
 location="_none_"
 active_instance=wOlBq
 @abc.abstractmethod
 def get_state_file_location_by_key(self,key:wOlBm)->wOlBm:
  pass
 @wOlBs
 def get(cls,requested_file_locator:wOlBm):
...
class ObjectStorageProvider(abc.ABC):
 ...
 active_instance=wOlBq
 @wOlBs
 def get(cls,state_file_locator:wOlBm,requested_storage:wOlBm,serializers:Dict[wOlBm,CPVCSSerializer]):
  ...
  return cls.active_instance
 def __init__(self,state_file_locator:StateFileLocator,serializers:Dict[wOlBm,CPVCSSerializer]):
 ...
 def get_state_file_location_by_key(self,key:wOlBm)->wOlBm:
  pass
 @abc.abstractmethod
 def get_version_by_key(self,key:wOlBm)->Version:
  pass
 @abc.abstractmethod
 def get_revision_by_key(self,key:wOlBm)->Revision:
  pass
 @abc.abstractmethod
 def get_revision_or_version_by_key(self,key:wOlBm)->Union[Revision,Version]:
  pass
 @abc.abstractmethod
 def upsert_objects(self,*args:CPVCSObj)->List[wOlBm]:
  pass
 @abc.abstractmethod
 def update_revision_key(self,old_key:wOlBm,new_key:wOlBm,referenced_by_version:wOlBm=wOlBq):
  pass
 @abc.abstractmethod
 def version_exists(self,key:wOlBm)->wOlBo:
  pass
 @abc.abstractmethod
 def _update_key(self,old_key:wOlBm,new_key:wOlBm,base_path:wOlBm)->wOlBo:
  pass
 @abc.abstractmethod
 def _serialize(self,*args:CPVCSObj)->List[wOlBm]:
  pass
 @abc.abstractmethod
 def _deserialize(self,key_serializer:Dict[wOlBm,wOlBm])->List[CPVCSObj]:
  pass
