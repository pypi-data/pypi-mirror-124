...
class StateFileLocator(abc.ABC):
 location="_none_"
 active_instance=sRciE
 @abc.abstractmethod
 def get_state_file_location_by_key(self,key:sRcin)->sRcin:
  pass
 @sRciY
 def get(cls,requested_file_locator:sRcin):
...
class ObjectStorageProvider(abc.ABC):
 ...
 active_instance=sRciE
 @sRciY
 def get(cls,state_file_locator:sRcin,requested_storage:sRcin,serializers:Dict[sRcin,CPVCSSerializer]):
  ...
  return cls.active_instance
 def __init__(self,state_file_locator:StateFileLocator,serializers:Dict[sRcin,CPVCSSerializer]):
 ...
 def get_state_file_location_by_key(self,key:sRcin)->sRcin:
  pass
 @abc.abstractmethod
 def get_version_by_key(self,key:sRcin)->Version:
  pass
 @abc.abstractmethod
 def get_revision_by_key(self,key:sRcin)->Revision:
  pass
 @abc.abstractmethod
 def get_revision_or_version_by_key(self,key:sRcin)->Union[Revision,Version]:
  pass
 @abc.abstractmethod
 def upsert_objects(self,*args:CPVCSObj)->List[sRcin]:
  pass
 @abc.abstractmethod
 def update_revision_key(self,old_key:sRcin,new_key:sRcin,referenced_by_version:sRcin=sRciE):
  pass
 @abc.abstractmethod
 def version_exists(self,key:sRcin)->sRciw:
  pass
 @abc.abstractmethod
 def _update_key(self,old_key:sRcin,new_key:sRcin,base_path:sRcin)->sRciw:
  pass
 @abc.abstractmethod
 def _serialize(self,*args:CPVCSObj)->List[sRcin]:
  pass
 @abc.abstractmethod
 def _deserialize(self,key_serializer:Dict[sRcin,sRcin])->List[CPVCSObj]:
  pass
