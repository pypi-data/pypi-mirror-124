...
from seti_python.class_read import ResponseCreateUser, ResponseReadCash, ResponseReadCashOut, ResponseReadPayment, ResponseReadTransactions, ResponseReadWallet, ResponseReadWalletsTransactions, ResponseValidateUser
...
class Seti():
    ...
    def validate_exist_user(self,email:str):
        ...
        VALIDATE_USERS_EXIST = "validate-user"
        encode_data = self.sign_data(user_data)
        return ResponseValidateUser(self.send_request(user_data,encode_data,VALIDATE_USERS_EXIST))
    
    def create_user(self,email:str,name:str,phone:str,iso_code:str):
        self.is_error =False
        self.validate_email(email)
        self.validate_currency(iso_code)
        user_data = {
        ...
        VALIDATE_USERS_EXIST = "create-user"
        encode_data = self.sign_data(user_data)
        return ResponseCreateUser(self.send_request(user_data,encode_data,VALIDATE_USERS_EXIST))
