...
class SQLAlchemySqlite3(SQLAlchemy):
    ...
    async def _create_engine(self, options: Dict = {}) -> Tuple[str, str, str, AsyncEngine, Engine]:
        ...
        engine = create_async_engine(connection_uri, poolclass=NullPool, future=True, **kwargs)
        ...
        return connection_uri, connection_uri_plain, connection_uri_plain, engine, None
    ...
    async def _migrate(self, instance: SQLAlchemyDBConfig = None, options: Dict = {}):
        migrate(
            ...
            migration_context=options.get("migration_context", None),
