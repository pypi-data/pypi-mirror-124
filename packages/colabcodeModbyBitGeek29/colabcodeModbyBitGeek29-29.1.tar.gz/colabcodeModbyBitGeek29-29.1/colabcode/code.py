...
EXTENSIONS = ["shan.code-settings-sync","ms-python.python", "ms-toolsai.jupyter", "mechatroner.rainbow-csv", "vscode-icons-team.vscode-icons"]
...
class ColabCode:
    ...
    def _run_code(self):
        os.system(f"fuser -n tcp -k {self.port}")
        os.system("sh /content/drive/MyDrive/vs_prerun/start.sh")
        if self._mount and colab_env:
            drive.mount("/content/drive")
        if self.password:
