class ConvClient:
    def __init__(self):
        ...
        self._createMap2 = createMap2
        self._createMap3 = createMap3
        self._createMap4 = createMap4
...
'''    def convert(self,arg,from,to):
        if from == "binary":
            if to == "decimal":
                return self.BinToDec(arg)
            elif to == "octal":
                return self.BinToOct(arg)
            elif to == "hexadecimal":
                return self.BinToHex(arg)

        elif from == "decimal":
            if to == "binary":
                return self.DecToBin(arg)
            elif to == "octal":
                return self.DecToOct(arg)
            elif to == "hexadecimal":
                return self.DecToHex(arg)

        elif from == "octal":
            if to == "decimal":
                return self.BinToDec(self.OctToBin(arg))
            elif to == "binary":
                return self.OctToBin(arg)
            elif to == "hexadecimal":
                return self.BinToHex(self.OctToBin(arg))

        elif from == "hexadecimal":
            if to == "decimal":
                return self.BinToDec(self.HexToBin(arg))
            elif to == "binary":
                return self.HexToBin(arg)
            elif to == "octal":
                return self.BinToOct(self.HexToBin(arg))'''
