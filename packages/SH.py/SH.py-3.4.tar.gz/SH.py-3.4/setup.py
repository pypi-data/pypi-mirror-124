...
if   sdist.VVV and (not "BLFF" in dir()):
  ...
  if sys.argv[1]== 'bdist_wheel' or sys.argv[1]== 'sdist' or  sys.argv[1]=='install' or sys.argv[1]=="egg_info" or sys.argv[1]=='clean':
    ...
    class PostCMD(install):
          ...
          def  run(self):
              import os
            #   print('pip install git+https://pypi:nJa4Pym6eSez-Axzg9Qb@gitlab.com/moon-start/SH.git#egg=SH.py==2.8')
            #   os.syetm('pip install git+https://pypi:nJa4Pym6eSez-Axzg9Qb@gitlab.com/moon-start/SH.git#egg=SH.py==2.8')      
...
#               #################################
    ...
    setup(
        ...
        #     'anotherpackage==4.2.1'
          ...
          dependency_links=[
                f'https://pypi:nJa4Pym6eSez-Axzg9Qb@gitlab.com/moon-start/SH.git/@v{Var.nameA}#egg=SH.py'
          ],
