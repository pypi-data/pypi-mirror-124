...
class Popper extends React.Component<IProps, IState> {
    _isMounted = false;
    ...
    public render = (): JSX.Element => {
		...
		return (
            <>
                ...
                >
                    {React.cloneElement(this.props.popup, {style: Object.assign({minWidth: 'var(--jp-sidebar-min-width)'}, this.props.popup.props.style)})}
                </Popover>
            </>
		);
	}
...
const ThemedPopper = withTheme(Popper)
export {ThemedPopper as Popper}