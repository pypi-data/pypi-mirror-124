    ...
    return (
        ...
        >
            <div style={{width: '100%', display: 'inline-flex'}}>
                <Radio style={{padding: '3px'}} color='primary' checked={notebookRuns === false} onChange={() => handleChange(false)}/>
                <div style={{margin: 'auto 0px'}}>
                    It does not run at all
                </div>
            </div>
            <div style={{width: '100%', display: 'inline-flex'}}>
                <Radio style={{padding: '3px'}} color='primary' checked={notebookRuns === true} onChange={() => handleChange(true)}/>
                <div style={{margin: 'auto 0px'}}>
                    It runs too slow
                </div>
            </div>
