...
class Anaml:
    ...
    def preview_feature_and_plot(self, feature: Union[List[Feature], Feature]) -> None:
    ...
    def preview_feature_set(self, feature_set: Union[FeatureSet, FeatureSetCreationRequest]) -> pandas.DataFrame:
