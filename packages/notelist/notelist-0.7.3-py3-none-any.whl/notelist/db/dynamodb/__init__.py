...
from notelist.db.base import MainDbManager
...
class DynamoDbManager(MainDbManager):
    """DynamoDB manager."""
    ...
    def __init__(
        ...
        # Managers
        self._users = DynamoDbUserManager(self, res.Table(us_tab))
        self._notebooks = DynamoDbNotebookManager(self, res.Table(nb_tab))
        self._notes = DynamoDbNoteManager(self, res.Table(no_tab))
        self._blocklist = DynamoDbBlockListManager(self, res.Table(bl_tab))
