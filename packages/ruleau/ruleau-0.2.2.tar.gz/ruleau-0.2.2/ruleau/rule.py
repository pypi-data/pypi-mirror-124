...
def remove_stale_data(rule):
    """
    Recursively removes stale data from nested Rules
    """

    rule.execution_result.failed = False
    rule.execution_result.original_result = None
    rule.execution_result.override = None
    rule.execution_result.payload = None
    rule.execution_result.result = None
    rule.execution_result.skipped = True

    for dependency in rule.depends_on:
        remove_stale_data(dependency)
