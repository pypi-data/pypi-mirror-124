...
extras_require = \
{'all': ['opentelemetry-propagator-b3==1.6.2',
         'opentelemetry-exporter-jaeger-thrift==1.6.2',
         'opentelemetry-exporter-otlp-proto-grpc==1.6.2'],
 'b3': ['opentelemetry-propagator-b3==1.6.2'],
 'jaeger': ['opentelemetry-exporter-jaeger-thrift==1.6.2'],
 'otlp': ['opentelemetry-exporter-otlp-proto-grpc==1.6.2']}
