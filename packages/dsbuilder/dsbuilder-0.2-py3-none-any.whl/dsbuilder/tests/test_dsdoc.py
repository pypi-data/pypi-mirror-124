...
from dsbuilder.dsdoc import RSTDocWriter, DSDoc, dsdoc_main
import numpy as np
...
def setup_dsb(
    variables_defs=setup_variables_defs(), metadata_defs=setup_metadata_defs()
):
    return DSBuilder(variables_defs=variables_defs, metadata_defs=metadata_defs)
...
class TestRSTDocWriter(unittest.TestCase):
    ...
    @patch("dsbuilder.dsdoc.RSTDocWriter.create_table")
    ...
    @patch("dsbuilder.dsdoc.RSTDocWriter._create_rst_heading")
    ...
    @patch("dsbuilder.dsdoc.RSTDocWriter.create_heading")
    ...
    @patch("dsbuilder.dsdoc.RSTDocWriter.create_subheading")
    ...
    @patch("dsbuilder.dsdoc.RSTDocWriter.create_subsubheading")
...
class TestDSDoc(unittest.TestCase):
    @patch("dsbuilder.dsdoc.RSTDocWriter.add_table")
    ...
    @patch("dsbuilder.dsdoc.DSDoc.add_var_table")
