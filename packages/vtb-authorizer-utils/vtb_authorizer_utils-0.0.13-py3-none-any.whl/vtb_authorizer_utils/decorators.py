...
def register_default_authorizer_resource_rules(view_class,
    ...
    methods = _create_methods(base_url_pattern, url_pattern_postfix)
    _register_default_http_methods(view_class, methods, default_context_types, default_access_type)
    _register_default_actions(view_class, base_url_pattern, methods, default_context_types, default_access_type,
                              url_pattern_postfix)


def _create_methods(base_url_pattern: str, url_pattern_postfix: Optional[str] = '/') -> Dict[str, Tuple[str, str]]:
    ...
    detail_url = _join_url(base_url_pattern, '{id}', postfix=url_pattern_postfix)
    methods = {
...
def _register_default_actions(view_class,
    ...
    for view_method_name in view_methods:
        ...
        if hasattr(view_method, 'mapping') and hasattr(view_method, 'detail'):
            ...
            url_parts = (base_url_pattern, '{id}', url_path) if detail else (base_url_pattern, url_path)
