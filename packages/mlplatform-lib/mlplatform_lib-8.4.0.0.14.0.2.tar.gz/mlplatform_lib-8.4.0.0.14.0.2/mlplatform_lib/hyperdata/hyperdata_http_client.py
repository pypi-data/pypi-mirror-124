from python.mlplatform_lib.mlplatform_lib.dataclass import selector_property
    ...
    def download_do_to_csv(self, do_id: int) -> Tuple[HyperdataRequestResult, str, str]:
        ...
        file_download = FileDownload(
            ...
            selector_property=SelectorProperty(
                column_select_options=[ColumnOption(
                    name=col_info.name,
                    alias=col_info.name,
                    type="VARCHAR"
        ...
        # 4. download csv file
        download_info_encoded_str = base64.b64decode(download_info.encode("utf-8")).decode("utf-8")
        return self.send_request(
            "",
