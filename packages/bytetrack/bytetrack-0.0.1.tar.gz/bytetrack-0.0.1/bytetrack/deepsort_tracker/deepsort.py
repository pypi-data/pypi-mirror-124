...
from bytetrack.deepsort_tracker import kalman_filter, linear_assignment, iou_matching
from bytetrack.data.dataloading import get_bytetrack_datadir
...
class DeepSort(object):
    ...
    def update(self, output_results, img_info, img_size, img_file_name):
        img_file_name = os.path.join(get_bytetrack_datadir(), 'mot', 'train', img_file_name)
