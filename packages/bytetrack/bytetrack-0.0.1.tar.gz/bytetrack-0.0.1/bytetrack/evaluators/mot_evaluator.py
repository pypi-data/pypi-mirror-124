...
from bytetrack.sort_tracker.sort import Sort
from bytetrack.deepsort_tracker.deepsort import DeepSort
from bytetrack.motdt_tracker.motdt_tracker import OnlineTracker
...
class MOTEvaluator:
    ...
    def evaluate_prediction(self, data_dict, statistics):
        ...
        if len(data_dict) > 0:
            ...
            '''
            try:
                from bytetrack.layers import COCOeval_opt as COCOeval
            except ImportError:
