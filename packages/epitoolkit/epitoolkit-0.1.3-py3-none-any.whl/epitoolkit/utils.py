...
def extract_probes_from_region(manifest: DataFrame, probes: set, chr: str, start: int, end: int) -> list:
...
def extract_category_from_manifest(manifest: DataFrame, category: str, mynorm_probes: t.Collection) -> DataFrame:
