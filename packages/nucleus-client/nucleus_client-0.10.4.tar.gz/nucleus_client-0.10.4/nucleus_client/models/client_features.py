...
class ClientFeatures(object):
    ...
    def __init__(self, dataset_upload=None, default_login_policy=None, default_user_id=None, default_user_token=None, glossary=None, page_editor=None, sql_query=None, sso=None, user_roles=None):  # noqa: E501
