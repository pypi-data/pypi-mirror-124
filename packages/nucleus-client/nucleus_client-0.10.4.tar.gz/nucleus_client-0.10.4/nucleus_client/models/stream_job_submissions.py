...
class StreamJobSubmissions(object):
    ...
    def __init__(self, client_id=None, dt_submitted=None, integration_id=None, job_id=None, job_name=None, new_supervisor=None, previous_datasources=None, proposed_datasource=None, status=None, stream_job_type=None, sub_status=None, table_name=None):  # noqa: E501
