...
class LoadTableOperation(object):
    ...
    def __init__(self, activity_type=None, alias=None, client_id=None, connector=None, data_format=None, integration_id=None, partner_id=None, schema=None, schema_id=None, start_offset=None):  # noqa: E501
