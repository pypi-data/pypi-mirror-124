...
class ClientUpdate(object):
    ...
    def __init__(self, amity_key=None, colors=None, dataset_metadata=None, dt_u=None, features=None, field_metadata=None, is_partner=None, name=None, nav_page_ids=None, null_default_value=None, partner_client_settings=None, schedule=None, short_name=None):  # noqa: E501
