...
extras_require = \
{'all': ['dbt-postgres>=0.19,<0.22',
         'dbt-redshift>=0.19,<0.22',
         'dbt-snowflake>=0.19,<0.22',
         'dbt-bigquery>=0.19,<0.22'],
 'amazon': ['apache-airflow-providers-amazon>=2.1.0,<3.0.0'],
 'bigquery': ['dbt-bigquery>=0.19,<0.22'],
 'docs': ['Sphinx==4.2.0',
          'sphinx-rtd-theme==1.0.0',
          'sphinxcontrib-napoleon==0.7'],
 'postgres': ['dbt-postgres>=0.19,<0.22'],
 'redshift': ['dbt-redshift>=0.19,<0.22'],
 'snowflake': ['dbt-snowflake>=0.19,<0.22']}
