...
class Programming():
    ...
    def createFunction(self, name:str, languageVersion:str, description:str=None, files:list=None) -> str:
        ...
        if files == None: 
            ...
            self.deployFunction(functionId, name, 'Python')
            return functionId
    ...
    def commitFunctionFiles(self, functionId:str, files:list=None) -> None:
        ...
        if result == None: 
            ...
            logger.info(f"Commited files: {fileList}")

        return result

    def deployFunction(self, functionId, functionName, automationTopic):
        """Deploys a function"""
        ...
        graphQLString = f'''mutation deployFunction {{
            deployFunction(
                ...
                automationTopic: "{automationTopic}"
                }}
            ) {{
                deploymentId
                errors {{
