...
FAILED_TO_CONCLUDE_AWS_DEFAULT_REGION_MESSAGE = 'Failed to conclude the default region.\n' \
                                                'You must provide a default region. ' \
                                                'A default region chosen by the first option from the below options:\n' \
                                                '1. Specify the region for all the provider blocks in your terraform files.\n' \
                                                '2. Use --aws-default-region to specify the default region.\n' \
                                                '3. Set environment variable "AWS_DEFAULT_REGION".\n' \
                                                '4. Set environment variable "AWS_REGION".'
...
def generate_unknown_aws_region_failure_message():
    return generate_simple_message(FAILED_TO_CONCLUDE_AWS_DEFAULT_REGION_MESSAGE)
