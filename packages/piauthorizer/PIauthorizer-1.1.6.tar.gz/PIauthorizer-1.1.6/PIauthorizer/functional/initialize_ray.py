...
def initialize_ray(app: FastAPI, namespace: str, packages: list = [], init: bool = False) -> None:
    """
    ...
    Args:
        ...
        packages (list, optional): a list of namespace specific packages to install upon connecting. Defaults to [].
