...
from pspman import print
from pspman.errors import CommandError
...
def process_comm(*cmd: str,
    ...
    if process.returncode != 0:
        if fail_handle == 'fail':
            raise CommandError(cmd_l, p_name, stderr)
...
def git_comm(
        ...
        prockwargs: typing.Dict[str,
                                typing.Any] = None) -> typing.Optional[str]:
    '''
...
def git_pull(
    ...
    cmd: typing.List[str] = [
        'git', '-C',
        str(clone_dir), 'pull', '--recurse-submodules'
    ]
    return git_comm(cmd,
                    g_name='pull',
                    gitkwargs=gitkwargs,
...
def git_clone(
    ...
    # Default $0 command
    cmd: typing.List[str] = [
        'git', '-C', str(clone_dir.parent), 'clone', url, name
    ]
    return git_comm(cmd,
                    g_name='clone',
                    gitkwargs=gitkwargs,
