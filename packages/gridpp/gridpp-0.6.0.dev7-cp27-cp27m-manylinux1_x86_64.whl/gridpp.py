...
def calc_neighbourhood(array, search_array, halfwidth, search_criteria_min, search_criteria_max, search_target_min, search_target_max, search_delta):
    return _gridpp.calc_neighbourhood(array, search_array, halfwidth, search_criteria_min, search_criteria_max, search_target_min, search_target_max, search_delta)
