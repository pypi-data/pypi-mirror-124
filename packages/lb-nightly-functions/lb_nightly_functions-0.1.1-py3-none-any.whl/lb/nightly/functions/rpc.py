...
from .common import download_and_unzip, get_artifacts_list, get_build_method
...
def build(
    ...
    build_env[
        "CMAKE_PREFIX_PATH"
    ] = "/cvmfs/lhcb.cern.ch/lib/lhcb:/cvmfs/lhcb.cern.ch/lib/lcg/releases:/cvmfs/projects.cern.ch/intelsw/psxe/linux/x86_64/2019/vtune_amplifier"
