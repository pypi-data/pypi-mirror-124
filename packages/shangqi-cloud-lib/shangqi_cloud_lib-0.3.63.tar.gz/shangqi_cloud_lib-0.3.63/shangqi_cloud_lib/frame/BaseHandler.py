...
class BaseHandler(tornado.web.RequestHandler, ABC):
    ...
    def insert_request_record(self, func_name, command, params):

        insert_request_param_list = [
            "('{}','{}','{}','{}')".format(func_name, self.request.path[1:], command, json.dumps(params))]

        request_param_sql = "INSERT INTO test_request_record (request_type,class_route,interfance_name,params_str) VALUES {}".format(
