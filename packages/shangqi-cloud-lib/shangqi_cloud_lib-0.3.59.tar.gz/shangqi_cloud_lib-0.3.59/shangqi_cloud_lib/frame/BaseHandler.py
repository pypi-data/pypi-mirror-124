...
class BaseHandler(tornado.web.RequestHandler, ABC):
    ...
    def insert_request_record(self, func_name, params):
        ...
        insert_request_param_list = ["('{}','{}','{}')".format(self.request.path[1:], func_name, json.dumps(params))]

        request_param_sql = "INSERT INTO test_request_record (class_route,interfance_name,params_str) VALUES {}".format(
