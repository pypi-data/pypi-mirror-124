...
class Image:
    def __init__(self, data):
        ...
        self.color_name = data["color_name"]  # 根据命名的颜色文件夹来划分 颜色 1 2 3 ·····
        self.filename = data["filename"]  # 根据命名的颜色文件夹来划分 颜色 1 2 3 ·····
...
class Human:
    ...
    def __init__(self, image_analysis):
        ...
        self.image_analysis = image_analysis
        if image_analysis.get('recognition'):
            self.threshold = 0.05
            image_analysis['human_pose'] = self.add_waist_crop_point(image_analysis.get("recognition"),
    ...
    def add_waist_crop_point(self, recognition, human_pose):
        """
        添加腰部识别点
        recognition 数据解释
        https://www.teambition.com/project/5e0dba42b2bba90021d9a872/app/5eba5fba6a92214d420a3219/workspaces/5fe40d962aa6d50046cc2bff/docs/60c9a039eaa11900013dc6cf
        """
