...
class ImageCrop:
    def __init__(self):
        self.si = ShouldIndex()
        #  Todo 裁剪点 顺序
        self.crop_sequence = ['pic_top', 'human_top', 'eye', 'nose', 'ear', 'mouth', 'shoulder', 'elbow', 'wrist',
                              "waist", 'hip', 'knee', 'ankle', 'human_bottom', 'pic_bottom']
    ...
    def crop(self, slot_config, img):
        ...
        if get_crop_point_result_dict['crop_top_name'] == 'pic_top' and get_crop_point_result_dict['crop_bottom_name'] == 'pic_bottom':
            # 居中裁剪 并往上移动
            # print(123123123123)
            return self.need_pic_top_and_pic_bottom_crop(crop_dict, slot_width, slot_height, img, get_crop_point_result_dict)
