...
from teyespider import constants
from teyespider.core.client import client
from teyespider.core.config import config
from teyespider.config import VERSION
...
@click.command('hello', help='hello to teye-spider')
def hello():
    print('Welcome to Teye-Spider~')
...
banner = """           
 _                                   _      _             
| |                                 (_)    | |            
| |_  ___  _   _   ___   ___  _ __   _   __| |  ___  _ __ 
| __|/ _ \| | | | / _ \ / __|| '_ \ | | / _` | / _ \| '__|
| |_|  __/| |_| ||  __/ \__ \| |_) || || (_| ||  __/| |   
 \__|\___| \__, | \___| |___/| .__/ |_| \__,_| \___||_|   
            __/ |            | |                          
           |___/             |_|     
"""
