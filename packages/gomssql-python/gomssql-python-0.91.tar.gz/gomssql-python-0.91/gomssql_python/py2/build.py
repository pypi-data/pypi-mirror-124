# python build stubs for package gomssql_python_go
...
mod = Module('_gomssql_python_go')
mod.add_include('"gomssql_python_go_go.h"')
...
mod.add_function('gomssql_python_go_GetPyPy', retval('bool'), [])
mod.add_function('gomssql_python_go_RPCExecute', retval('uint64_t'), [param('uint64_t', 'sessionID'), param('char*', 'query')])
mod.add_function('gomssql_python_go_RPCQuery', retval('uint64_t'), [param('uint64_t', 'sessionID'), param('char*', 'query')])
mod.add_function('gomssql_python_go_SetPyPy', None, [param('bool', 'goRun')])
mod.add_function('gomssql_python_go_NewRPCSession', retval('uint64_t'), [param('char*', 'dataSourceName')])
mod.add_function('gomssql_python_go_RPCClose', retval('char*'), [param('uint64_t', 'sessionID')])
mod.add_function('gomssql_python_go_RPCConnect', retval('char*'), [param('uint64_t', 'sessionID')])
mod.add_function('gomssql_python_go_RPCFetchAll', retval('char*'), [param('uint64_t', 'sessionID'), param('uint64_t', 'rowsID')])
mod.add_function('gomssql_python_go_RPCGetRowsAffected', retval('int64_t'), [param('uint64_t', 'sessionID'), param('uint64_t', 'resultID')])

mod.generate(open('gomssql_python_go.c', 'w'))
