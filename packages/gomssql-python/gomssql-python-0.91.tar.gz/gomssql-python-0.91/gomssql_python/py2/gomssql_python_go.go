/*
cgo stubs for package gomssql_python_go.
...
#cgo CFLAGS: -I/Users/edwardbeech/.venv/gomssql-python/include/python2.7
...
import (
	...
	"gomssql_python/gomssql_python_go"
)
...
// --- generated code for package: gomssql_python_go below: ---
...
//export gomssql_python_go_GetPyPy
func gomssql_python_go_GetPyPy() C.char {
	return boolGoToPy(gomssql_python_go.GetPyPy())

}

//export gomssql_python_go_RPCExecute
func gomssql_python_go_RPCExecute(sessionID C.ulonglong, query *C.char) C.ulonglong {
	cret, __err := gomssql_python_go.RPCExecute(uint64(sessionID), C.GoString(query))
...
//export gomssql_python_go_RPCQuery
func gomssql_python_go_RPCQuery(sessionID C.ulonglong, query *C.char) C.ulonglong {
	cret, __err := gomssql_python_go.RPCQuery(uint64(sessionID), C.GoString(query))
...
//export gomssql_python_go_SetPyPy
func gomssql_python_go_SetPyPy(goRun C.char) {
	if boolPyToGo(goRun) {
		go gomssql_python_go.SetPyPy()
	} else {
		gomssql_python_go.SetPyPy()
	}
}

//export gomssql_python_go_NewRPCSession
func gomssql_python_go_NewRPCSession(dataSourceName *C.char) C.ulonglong {
	return C.ulonglong(gomssql_python_go.NewRPCSession(C.GoString(dataSourceName)))

}

//export gomssql_python_go_RPCClose
func gomssql_python_go_RPCClose(sessionID C.ulonglong) *C.char {
	var __err error
	__err = gomssql_python_go.RPCClose(uint64(sessionID))
...
//export gomssql_python_go_RPCConnect
func gomssql_python_go_RPCConnect(sessionID C.ulonglong) *C.char {
	var __err error
	__err = gomssql_python_go.RPCConnect(uint64(sessionID))
...
//export gomssql_python_go_RPCFetchAll
func gomssql_python_go_RPCFetchAll(sessionID C.ulonglong, rowsID C.ulonglong) *C.char {
	cret, __err := gomssql_python_go.RPCFetchAll(uint64(sessionID), uint64(rowsID))
...
//export gomssql_python_go_RPCGetRowsAffected
func gomssql_python_go_RPCGetRowsAffected(sessionID C.ulonglong, resultID C.ulonglong) C.longlong {
	cret, __err := gomssql_python_go.RPCGetRowsAffected(uint64(sessionID), uint64(resultID))
