...
/* package gomssql_python/gomssql_python/py2 */
...
extern char gomssql_python_go_GetPyPy();

extern long long unsigned int gomssql_python_go_RPCExecute(long long unsigned int p0, char* p1);

extern long long unsigned int gomssql_python_go_RPCQuery(long long unsigned int p0, char* p1);

extern void gomssql_python_go_SetPyPy(char p0);

extern long long unsigned int gomssql_python_go_NewRPCSession(char* p0);

extern char* gomssql_python_go_RPCClose(long long unsigned int p0);

extern char* gomssql_python_go_RPCConnect(long long unsigned int p0);

extern char* gomssql_python_go_RPCFetchAll(long long unsigned int p0, long long unsigned int p1);

extern long long int gomssql_python_go_RPCGetRowsAffected(long long unsigned int p0, long long unsigned int p1);
