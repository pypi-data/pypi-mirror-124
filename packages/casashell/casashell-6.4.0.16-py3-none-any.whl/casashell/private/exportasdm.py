...
##################### 435b977743610839ef7e689833b55baa ##############################
...
class _exportasdm:
    ...
    def __showversion_inp(self):
        def xml_default( ):
            ...
            if dflt is not None: return dflt
            return False
        description = 'Deprecated: Report the version of ASDM class set being used'
        ...
        self.__do_inp_output('%-15.15s = %s%-23s%s' % ('showversion',pre,self.__to_string_(value),post),description,0+len(pre)+len(post))
    def __useversion_inp(self):
        def xml_default( ):
            ...
            if dflt is not None: return dflt
            return 'deprecated'
        description = 'Deprecated: Selects the version of MS2asdm to be used'
        ...
        self.__do_inp_output('%-15.15s = %s%-23s%s' % ('useversion',pre,self.__to_string_(value),post),description,0+len(pre)+len(post))
