...
##################### 06603dede96d135a64ec590e3923b8ee ##############################
...
class _importasdm:
    ...
    overwrite                Over write an existing MS(s) or MS(s), if the option
                             ...
                             online flag file.
    showversion              Deprecated. This parameter will be removed in a future release, this is no longer relevant.
                             Report the version of asdm2MS being used
                                     Default: False
                                     Options: False|True
    useversion               Deprecated. This parameter will be removed in a future release. This is no longer relevant.
                             Version of asdm2MS to be used
                                     Default: 'deprecated' (should work for all data)
                                     Options: deprecated, v3
    ...
    def __showversion_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__showversion_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return False
        description = 'Deprecated: Report the version of asdm2MS being used'
        value = self.__showversion( self.__globals_( ) )
        (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'showversion': value},{'showversion': self.__schema['showversion']}) else ('\x1B[91m','\x1B[0m')
        self.__do_inp_output('%-24.24s = %s%-23s%s' % ('showversion',pre,self.__to_string_(value),post),description,0+len(pre)+len(post))
    def __useversion_inp(self):
        def xml_default( ):
            ## play the crazy subparameter shell game
            dflt = self.__useversion_dflt( self.__globals_( ) )
            if dflt is not None: return dflt
            return 'deprecated'
        description = 'Deprecated: Version of asdm2MS to be used (should work for all data)'
        value = self.__useversion( self.__globals_( ) )
        (pre,post) = (('','') if value == xml_default( ) else ('\x1B[34m','\x1B[0m')) if self.__validate_({'useversion': value},{'useversion': self.__schema['useversion']}) else ('\x1B[91m','\x1B[0m')
        self.__do_inp_output('%-24.24s = %s%-23s%s' % ('useversion',pre,self.__to_string_(value),post),description,0+len(pre)+len(post))
    ...
    def __call__( self, asdm=None, vis=None, createmms=None, separationaxis=None, numsubms=None, corr_mode=None, srt=None, time_sampling=None, ocorr_mode=None, compression=None, lazy=None, asis=None, wvr_corrected_data=None, scans=None, ignore_time=None, process_syspower=None, process_caldevice=None, process_pointing=None, process_flags=None, tbuff=None, applyflags=None, savecmds=None, outfile=None, flagbackup=None, verbose=None, overwrite=None, showversion=None, useversion=None, bdfflags=None, with_pointing_correction=None, convert_ephem2geo=None, polyephem_tabtimestep=None ):
        ...
        _arguments = [asdm,vis,createmms,separationaxis,numsubms,corr_mode,srt,time_sampling,ocorr_mode,compression,lazy,asis,wvr_corrected_data,scans,ignore_time,process_syspower,process_caldevice,process_pointing,process_flags,tbuff,applyflags,savecmds,outfile,flagbackup,verbose,overwrite,showversion,useversion,bdfflags,with_pointing_correction,convert_ephem2geo,polyephem_tabtimestep]
        _invocation_parameters = OrderedDict( )
