  ...
  def clip_parameters(self):
      ...
      for k in self.v:
          ...
          if key == 'n.u.':
             ...
             if self.nn:
                if key =='bo1':
                   self.p[k] = tf.clip_by_value(self.v[k],-0.35,-0.15)
                elif key =='bo3':
                   self.p[k] = tf.clip_by_value(self.v[k],-0.35,-0.1)
                elif key =='bo5':
                   self.p[k] = tf.clip_by_value(self.v[k],-0.35,-0.05)
             ...
             if self.nn:
                if key =='bo2':
                   self.p[k] = tf.clip_by_value(self.v[k],3.5,8.5)
                elif key =='bo4':
                   self.p[k] = tf.clip_by_value(self.v[k],1.5,8.5)
                elif key =='bo6':
                   self.p[k] = tf.clip_by_value(self.v[k],1.0,8.5)
