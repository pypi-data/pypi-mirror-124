...
def submit(cpp_files, safety, testcase, timelimit):
    ...
    print(f"Starting stresstest ({round(time.perf_counter() - start, 3)} sec)")
    # executing stress-test 
    dbg_res = stresstest(safety, testcase, timelimit)
    print(f"Stresstest completed ({round(time.perf_counter() - start, 3)} sec)")
    ...
    print(f"Removing temporary files ({round(time.perf_counter() - start, 3)} sec)")
    ...
    print(f"Removed temporary files ({round(time.perf_counter() - start, 3)} sec)")
