...
class FiberDataFromCRMLeadLine:
    ...
    def build(self):
        ...
        return FiberData(
            ...
            old_contract_pon=isp_info.old_contract_pon,
            old_contract_fiber_speed=self._old_contract_fiber_speed(
                isp_info.old_contract_fiber_speed)
        )
    ...
    def _old_contract_fiber_speed(self, value):
        if value:
