...
class BroadbandISPInfoTest(SCTestCase):
    ...
    def test_address_change_attributes(self):
        ...
        broadband_isp_info_args_copy.update({
            'old_contract_pon': 'VFH5000084937',
        ...
        self.assertEqual(broadband_isp_info.old_contract_pon, 'VFH5000084937')
        self.assertEqual(broadband_isp_info.old_contract_fiber_speed, '100Mb')
