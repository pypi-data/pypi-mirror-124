...
def mobilenet_imagenette_pretrained(alpha=1.0):
    ...
    if alpha == 1.0:
        ...
        file_hash = '9e5f7294c2462fadee74499ac463c734acff571796ea1313e4e3eb6f93a4b090'
    elif alpha == 0.5:
        model_name = 'mobilenet_imagenette_224_alpha_50_iq8_wq4_aq4.h5'
        file_hash = '0fcf9a1bd6a82042bf27b70fd337f38f2557fdbe3eb33ced76f6ce2c8bb6a710'
    elif alpha == 0.25:
        model_name = 'mobilenet_imagenette_224_alpha_25_iq8_wq4_aq4.h5'
        file_hash = 'b0dbd0d87b7e496afdd62400760fe1cccecebb18a4b2b8db1edb6eb65a31beb8'
    else:
        raise ValueError(
            f"Requested model with alpha={alpha} is not available.")
