...
"""
    ...
    The version of the OpenAPI document: 0.0.1507
...
class PolicyCollectionCreationRequest(object):
    ...
    def code(self, code):
        ...
        if (self.local_vars_configuration.client_side_validation and
                code is not None and not re.search(r'^(?![0-9]*$)[a-zA-Z0-9]+[a-zA-Z0-9-_ +]{2,100}$', code)):  # noqa: E501
            raise ValueError(r"Invalid value for `code`, must be a follow pattern or equal to `/^(?![0-9]*$)[a-zA-Z0-9]+[a-zA-Z0-9-_ +]{2,100}$/`")  # noqa: E501
