...
class PyHtmlGui():
    def __init__(self,
                 ...
                 # create only one instance and share it between all connected websockets, this is the default, so there is only one instance of appViewClass shared by all connected frntends
                 ):
