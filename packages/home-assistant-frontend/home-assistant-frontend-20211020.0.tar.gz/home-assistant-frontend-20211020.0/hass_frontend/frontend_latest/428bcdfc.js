...
`,E=(e,t,r)=>{const o=getComputedStyle(t).getPropertyValue(`--weather-icon-${e}`);return o?i.dy`
  ...
  ${p.has(e)?i.YP`
    ...
    `}}]}}),i.oi)},26136:(e,t,r)=>{r.a(e,(async e=>{var t=r(7599),i=r(50467),n=r(99476),o=e([n]);n=(o.then?await o:o)[0];class s extends n.p{async getCardSize(){if(!this._cards)return 0;const e=[];for(const t of this._cards)e.push((0,i.N)(t));return(await Promise.all(e)).reduce(((e,t)=>e+t),0)}static get styles(){return[super.sharedStyles,t.iv`
      ...
      `;const o=!1!==(null===(e=this._config)||void 0===e?void 0:e.show_forecast)&&null!==(r=n.attributes.forecast)&&void 0!==r&&r.length?n.attributes.forecast.slice(0,this._veryVeryNarrow?3:5):void 0;let l,h;if(null!=o&&o.length&&(null==o?void 0:o.length)>2){const e=new Date(o[1].datetime),t=new Date(o[2].datetime).getTime()-e.getTime();if(l=t<j,l){const e=new Date(o[0].datetime),t=new Date(o[o.length-1].datetime).getTime()-e.getTime();h=t>j}}const u=(0,m.Cq)(n.state,this),v=null!==(i=this._config.name)&&void 0!==i?i:(0,d.C)(n);return t.dy`
      <ha-card
        @action=${this._handleAction}
        ...
        <div class="content">
          ...
          <div class="info">
            ...
            <div class="temp-attribute">
              <div class="temp">
                ${(0,f.u)(n.attributes.temperature,this.hass.locale)}&nbsp;<span>${(0,m.pv)(this.hass,"temperature")}</span>
              </div>
              <div class="attribute">
                ${void 0!==this._config.secondary_info_attribute?t.dy`
                      ...
                      ${"wind_speed"===this._config.secondary_info_attribute?(0,m.NF)(this.hass,n.attributes.wind_speed,n.attributes.wind_bearing):t.dy`
                            ${(0,f.u)(n.attributes[this._config.secondary_info_attribute],this.hass.locale)}
    ...
    `}}]}}),i.oi)}}]);
//# sourceMappingURL=428bcdfc.js.map