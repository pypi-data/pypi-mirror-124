...
@dataclass
class PandasCategorical(ExternalTypeSerializer):
...
@dataclass
class PandasInterval(ExternalTypeSerializer):
...
class TypeSerde(ExternalTypeSerializer):
    ...
    def from_json(self, value: str) -> type:  # type: ignore
        return {class_.__name__: class_ for class_ in self._whitelisted_types}[value]
