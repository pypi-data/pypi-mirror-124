...
from kolibri.task.text.topics.topics_lda import get_available_models
import pandas as pd
import datetime
...
#            if self.verbose:
    ...
    def optimize(self, custom_grid=None):
        ...
        for i in param_grid:
            ...
            self.trainer.config["num_topics"]=i
        ...
        for i in master:
            ...
            model = CoherenceModel(
                    model=i.model, texts=self._data, dictionary=i.indexer, coherence="c_v"
                )
