...
class Driver(object):
    ...
    def __init__(self, serial_no=None, pkg_name=None):
        ...
        exe_path_77 = os.path.join(os.path.dirname(os.path.realpath(__file__)), 'chromedriver', '77',
                                   'chromedriver.exe')
        exe_path_83 = os.path.join(os.path.dirname(os.path.realpath(__file__)), 'chromedriver', '83',
                                   'chromedriver.exe')
        try:
