...
class PatentPage:
    def __init__(self, d):
        self.d = d
        self.search_input = Element(driver, By.CLASS_NAME, 'h-b-content')
...
class PatentPage:
    def __init__(self, d):
        ...
        self.search_input = Element(driver, By.ID, 'driver-home-step1')
...
"""
    ...
    demo_case_h5 = """
import allure
from core.h5.driver import Driver
from pages.android.demo_page import HomePage
from pages.h5.patent_page import PatentPage
...
"""
    demo_case_web = """
import allure
from pages.web.patent_page import PatentPage
