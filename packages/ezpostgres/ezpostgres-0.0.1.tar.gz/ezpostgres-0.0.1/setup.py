...
PROJECT_NAME = "ezpostgres"  # What shows up on pypi and is used for pip install
AUTHOR = "Noctsol"              # Author of this project
EMAIL = "noctsol@pm.me"         # Your email address

# Quick description of your project
SHORT_DESCRIPT = "Quick, dumbed-down wrapper around psycopg2 to use Postgres with Python"

# URL of your project - usually github repo
PROJECT_URL = "https://github.com/Noctsol/lib-py-ezpostgres"
