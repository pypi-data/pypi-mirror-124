...
set_target_properties(mongo::mongoc_shared PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libmongoc-1.0.0.0.0.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libmongoc-1.0.0.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS mongo::mongoc_shared )
list(APPEND _IMPORT_CHECK_FILES_FOR_mongo::mongoc_shared "${_IMPORT_PREFIX}/lib/libmongoc-1.0.0.0.0.dylib" )
