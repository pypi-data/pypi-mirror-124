...
class TestClient(unittest.TestCase):
  ...
  def test_snippets_rendering(self):
    ...
    query = "\nselect *, date_trunc('month', CONVERT_TIMEZONE ('UTC', 'America/New_York', getdate()))::date\nfrom  geranium-navy.example_source_schema_public.table_1 table_1\njoin  geranium-navy.example_source_schema_public.table_2 table_2\non table_1.id = table_2.id\njoin  geranium-navy.example_source_schema_public.table_3 table_3\non table_2.table_3_id = table_3.id"
  ...
  def test_vars_rendering_single_model(self):
    ...
    query = "\nselect *, 'some_value'\nfrom  terra_prod.example_model_prep.example_1"
    self.assertEqual(rendered_query, query)
  ...
  def test_dynamic_env_is_set_only_affected_tables(self):
    ...
    expected_output = '\nselect *\nfrom  terra_prod.example_model.example_3\njoin  lunaup_dev.test_custom_prep_schema.enrich_example_1\njoin  terra_prod.example_model_prep.example_1'
