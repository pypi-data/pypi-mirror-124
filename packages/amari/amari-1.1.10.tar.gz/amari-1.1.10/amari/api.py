...
class AmariClient:
    ...
    def __init__(
        ...
        *,
        ...
        if useCache:
            # The math calculates the max requests you can make in the ttl length
            self.cache = TTLCache(
                self.max_requests * (ttl_length / self.request_period), ttl_length
            )
...
async def test():
    client = AmariClient("5f10a19a2a90e7fae82f0a9c.9e6d14.a4f45c3c2d1bc569f6772ad5403")
    for _ in range(80):
        await client.fetch_user(856142662623952907, 374147012599218176)
