...
import compas_rhino
from compas_igs.utilities.equilibrium import check_deviations
...
def RunCommand(is_interactive):
    ...
    check = check_deviations(form.diagram, force.diagram, tol_angle=threshold, tol_force=threshold)
