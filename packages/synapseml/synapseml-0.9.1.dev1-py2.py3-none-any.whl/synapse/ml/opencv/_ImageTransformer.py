...
class _ImageTransformer(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    Args:
        ...
        tensorChannelOrder (object): The color channel order of the output channels. Valid values are RGB and GBR. Default: RGB.
    ...
    tensorChannelOrder = Param(Params._dummy(), "tensorChannelOrder", "The color channel order of the output channels. Valid values are RGB and GBR. Default: RGB.")
    ...
    def __init__(
        ...
        normalizeMean=None,
        normalizeStd=None,
        outputCol="ImageTransformer_7e0bf7f5263e_output",
        stages=None,
        ...
        self._setDefault(outputCol="ImageTransformer_7e0bf7f5263e_output")
