...
class PII(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        domain=None,
        domainCol=None,
        errorCol="PII_d4df63efe091_error",
        handler=None,
        language=None,
        languageCol=None,
        modelVersion=None,
        modelVersionCol=None,
        outputCol="PII_d4df63efe091_output",
        piiCategories=None,
        ...
        self._setDefault(errorCol="PII_d4df63efe091_error")
        self._setDefault(outputCol="PII_d4df63efe091_output")
