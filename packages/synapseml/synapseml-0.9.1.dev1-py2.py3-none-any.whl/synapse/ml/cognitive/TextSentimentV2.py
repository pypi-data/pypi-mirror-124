...
class TextSentimentV2(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="TextSentimentV2_936ef783ef48_error",
        handler=None,
        language=None,
        languageCol=None,
        outputCol="TextSentimentV2_936ef783ef48_output",
        ...
        self._setDefault(errorCol="TextSentimentV2_936ef783ef48_error")
        self._setDefault(outputCol="TextSentimentV2_936ef783ef48_output")
