...
class RecognizeText(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    mode = Param(Params._dummy(), "mode", "If this parameter is set to 'Printed', printed text recognition is performed. If 'Handwritten' is specified, handwriting recognition is performed")
    ...
    def __init__(
        ...
        errorCol="RecognizeText_8efd4c79d954_error",
        imageBytes=None,
        imageBytesCol=None,
        imageUrl=None,
        imageUrlCol=None,
        ...
        mode=None,
        modeCol=None,
        outputCol="RecognizeText_8efd4c79d954_output",
        pollingDelay=300,
        ...
        self._setDefault(errorCol="RecognizeText_8efd4c79d954_error")
        self._setDefault(maxPollingRetries=1000)
        self._setDefault(outputCol="RecognizeText_8efd4c79d954_output")
