...
class AnalyzeBusinessCards(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    includeTextDetails = Param(Params._dummy(), "includeTextDetails", "Include text lines and element references in the result.")
    
    locale = Param(Params._dummy(), "locale", "Locale of the receipt. Supported locales: en-AU, en-CA, en-GB, en-IN, en-US.")
    ...
    def __init__(
        ...
        errorCol="AnalyzeBusinessCards_b78cb34561d6_error",
        imageBytes=None,
        imageBytesCol=None,
        imageUrl=None,
        imageUrlCol=None,
        ...
        outputCol="AnalyzeBusinessCards_b78cb34561d6_output",
        pages=None,
        pagesCol=None,
        pollingDelay=300,
        ...
        self._setDefault(errorCol="AnalyzeBusinessCards_b78cb34561d6_error")
        self._setDefault(maxPollingRetries=1000)
        self._setDefault(outputCol="AnalyzeBusinessCards_b78cb34561d6_output")
    ...
    def getIncludeTextDetails(self):
        ...
        Returns:
            includeTextDetails: Include text lines and element references in the result.
        """
        return self.getOrDefault(self.includeTextDetails)
