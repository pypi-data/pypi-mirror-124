...
class EntityDetectorV2(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="EntityDetectorV2_ac2c9ef7e96e_error",
        handler=None,
        language=None,
        languageCol=None,
        outputCol="EntityDetectorV2_ac2c9ef7e96e_output",
        ...
        self._setDefault(errorCol="EntityDetectorV2_ac2c9ef7e96e_error")
        self._setDefault(outputCol="EntityDetectorV2_ac2c9ef7e96e_output")
