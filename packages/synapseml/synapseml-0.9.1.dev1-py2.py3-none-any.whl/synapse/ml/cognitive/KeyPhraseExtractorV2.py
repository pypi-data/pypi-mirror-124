...
class KeyPhraseExtractorV2(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="KeyPhraseExtractorV2_3aa06dfc5efd_error",
        handler=None,
        language=None,
        languageCol=None,
        outputCol="KeyPhraseExtractorV2_3aa06dfc5efd_output",
        ...
        self._setDefault(errorCol="KeyPhraseExtractorV2_3aa06dfc5efd_error")
        self._setDefault(outputCol="KeyPhraseExtractorV2_3aa06dfc5efd_output")
