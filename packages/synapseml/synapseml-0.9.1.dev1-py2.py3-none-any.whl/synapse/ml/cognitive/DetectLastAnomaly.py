...
class DetectLastAnomaly(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="DetectLastAnomaly_7ef859d23f41_error",
        granularity=None,
        granularityCol=None,
        handler=None,
        maxAnomalyRatio=None,
        maxAnomalyRatioCol=None,
        outputCol="DetectLastAnomaly_7ef859d23f41_output",
        period=None,
        periodCol=None,
        sensitivity=None,
        sensitivityCol=None,
        ...
        self._setDefault(errorCol="DetectLastAnomaly_7ef859d23f41_error")
        self._setDefault(outputCol="DetectLastAnomaly_7ef859d23f41_output")
