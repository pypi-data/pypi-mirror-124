...
class BreakSentence(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    script = Param(Params._dummy(), "script", "Script tag identifying the script used by the input text. If a script is not specified, the default script of the language will be assumed.")
    ...
    def __init__(
        ...
        errorCol="BreakSentence_24e861ee77e9_error",
        handler=None,
        language=None,
        languageCol=None,
        outputCol="BreakSentence_24e861ee77e9_output",
        script=None,
        scriptCol=None,
        ...
        self._setDefault(errorCol="BreakSentence_24e861ee77e9_error")
        self._setDefault(outputCol="BreakSentence_24e861ee77e9_output")
    ...
    def getScript(self):
        ...
        Returns:
            script: Script tag identifying the script used by the input text. If a script is not specified, the default script of the language will be assumed.
        """
        return self.getOrDefault(self.script)
