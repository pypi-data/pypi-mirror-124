...
class AnalyzeCustomModel(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    modelId = Param(Params._dummy(), "modelId", "Model identifier.")
    ...
    def __init__(
        ...
        errorCol="AnalyzeCustomModel_c265f79e6a82_error",
        imageBytes=None,
        imageBytesCol=None,
        imageUrl=None,
        imageUrlCol=None,
        ...
        modelId=None,
        modelIdCol=None,
        outputCol="AnalyzeCustomModel_c265f79e6a82_output",
        pollingDelay=300,
        ...
        self._setDefault(errorCol="AnalyzeCustomModel_c265f79e6a82_error")
        self._setDefault(maxPollingRetries=1000)
        self._setDefault(outputCol="AnalyzeCustomModel_c265f79e6a82_output")
