...
class DictionaryExamples(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    fromLanguage = Param(Params._dummy(), "fromLanguage", "Specifies the language of the input text. The source language must be one of the supported languages included in the dictionary scope.")
    ...
    textAndTranslation = Param(Params._dummy(), "textAndTranslation", " A string specifying the translated text previously returned by the Dictionary lookup operation.")
    ...
    toLanguage = Param(Params._dummy(), "toLanguage", "Specifies the language of the output text. The target language must be one of the supported languages included in the dictionary scope.")
    ...
    def __init__(
        ...
        errorCol="DictionaryExamples_006c35c7feb9_error",
        fromLanguage=None,
        fromLanguageCol=None,
        handler=None,
        outputCol="DictionaryExamples_006c35c7feb9_output",
        ...
        self._setDefault(errorCol="DictionaryExamples_006c35c7feb9_error")
        self._setDefault(outputCol="DictionaryExamples_006c35c7feb9_output")
    ...
    def getTextAndTranslation(self):
        ...
        Returns:
            textAndTranslation:  A string specifying the translated text previously returned by the Dictionary lookup operation.
        """
        return self.getOrDefault(self.textAndTranslation)
