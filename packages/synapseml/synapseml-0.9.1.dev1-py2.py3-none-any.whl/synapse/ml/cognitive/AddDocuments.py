...
class AddDocuments(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    indexName = Param(Params._dummy(), "indexName", "")
    ...
    def __init__(
        ...
        errorCol="AddDocuments_0698f350f864_error",
        handler=None,
        indexName=None,
        outputCol="AddDocuments_0698f350f864_output",
        serviceName=None,
        ...
        self._setDefault(errorCol="AddDocuments_0698f350f864_error")
        self._setDefault(outputCol="AddDocuments_0698f350f864_output")
