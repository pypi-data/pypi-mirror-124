...
class AnalyzeImage(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    details = Param(Params._dummy(), "details", "what visual feature types to return")
    ...
    language = Param(Params._dummy(), "language", "the language of the response (en if none given)")
    ...
    visualFeatures = Param(Params._dummy(), "visualFeatures", "what visual feature types to return")
    ...
    def __init__(
        ...
        details=None,
        detailsCol=None,
        errorCol="AnalyzeImage_5a0d9cf0662c_error",
        handler=None,
        imageBytes=None,
        imageBytesCol=None,
        imageUrl=None,
        ...
        language=None,
        languageCol=None,
        outputCol="AnalyzeImage_5a0d9cf0662c_output",
        ...
        self._setDefault(errorCol="AnalyzeImage_5a0d9cf0662c_error")
        self._setDefault(outputCol="AnalyzeImage_5a0d9cf0662c_output")
    ...
    def getDetails(self):
        ...
        Returns:
            details: what visual feature types to return
        """
        return self.getOrDefault(self.details)
    ...
    def getVisualFeatures(self):
        ...
        Returns:
            visualFeatures: what visual feature types to return
        """
        return self.getOrDefault(self.visualFeatures)
