...
class RecognizeDomainSpecificContent(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    model = Param(Params._dummy(), "model", "the domain specific model: celebrities, landmarks")
    ...
    def __init__(
        ...
        errorCol="RecognizeDomainSpecificContent_72eca51b5134_error",
        handler=None,
        imageBytes=None,
        imageBytesCol=None,
        imageUrl=None,
        ...
        model=None,
        modelCol=None,
        outputCol="RecognizeDomainSpecificContent_72eca51b5134_output",
        ...
        self._setDefault(errorCol="RecognizeDomainSpecificContent_72eca51b5134_error")
        self._setDefault(outputCol="RecognizeDomainSpecificContent_72eca51b5134_output")
