...
class DictionaryLookup(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="DictionaryLookup_35b425eafd37_error",
        fromLanguage=None,
        fromLanguageCol=None,
        handler=None,
        outputCol="DictionaryLookup_35b425eafd37_output",
        ...
        self._setDefault(errorCol="DictionaryLookup_35b425eafd37_error")
        self._setDefault(outputCol="DictionaryLookup_35b425eafd37_output")
