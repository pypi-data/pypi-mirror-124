...
class DetectFace(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="DetectFace_38611582fe45_error",
        handler=None,
        imageUrl=None,
        imageUrlCol=None,
        outputCol="DetectFace_38611582fe45_output",
        ...
        self._setDefault(errorCol="DetectFace_38611582fe45_error")
        self._setDefault(outputCol="DetectFace_38611582fe45_output")
