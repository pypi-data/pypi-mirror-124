...
class IdentifyFaces(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    faceIds = Param(Params._dummy(), "faceIds", "Array of query faces faceIds, created by the Face - Detect. Each of the faces are identified independently. The valid number of faceIds is between [1, 10]. ")
    
    handler = Param(Params._dummy(), "handler", "Which strategy to use when handling requests")
    
    largePersonGroupId = Param(Params._dummy(), "largePersonGroupId", "largePersonGroupId of the target large person group, created by LargePersonGroup - Create. Parameter personGroupId and largePersonGroupId should not be provided at the same time.")
    
    maxNumOfCandidatesReturned = Param(Params._dummy(), "maxNumOfCandidatesReturned", "The range of maxNumOfCandidatesReturned is between 1 and 100 (default is 10).")
    
    outputCol = Param(Params._dummy(), "outputCol", "The name of the output column")
    
    personGroupId = Param(Params._dummy(), "personGroupId", "personGroupId of the target person group, created by PersonGroup - Create. Parameter personGroupId and largePersonGroupId should not be provided at the same time.")
    ...
    def __init__(
        ...
        errorCol="IdentifyFaces_8728e178b411_error",
        faceIds=None,
        faceIdsCol=None,
        handler=None,
        ...
        outputCol="IdentifyFaces_8728e178b411_output",
        personGroupId=None,
        ...
        self._setDefault(errorCol="IdentifyFaces_8728e178b411_error")
        self._setDefault(outputCol="IdentifyFaces_8728e178b411_output")
    ...
    def getConfidenceThreshold(self):
        ...
        Returns:
            confidenceThreshold: Optional parameter.Customized identification confidence threshold, in the range of [0, 1].Advanced user can tweak this value to override defaultinternal threshold for better precision on their scenario data.Note there is no guarantee of this threshold value workingon other data and after algorithm updates.
        """
        return self.getOrDefault(self.confidenceThreshold)
