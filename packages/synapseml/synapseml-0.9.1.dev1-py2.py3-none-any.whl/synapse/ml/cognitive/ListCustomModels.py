...
class ListCustomModels(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    op = Param(Params._dummy(), "op", "Specify whether to return summary or full list of models.")
    ...
    def __init__(
        ...
        errorCol="ListCustomModels_4edbad0387a4_error",
        handler=None,
        op=None,
        opCol=None,
        outputCol="ListCustomModels_4edbad0387a4_output",
        ...
        self._setDefault(errorCol="ListCustomModels_4edbad0387a4_error")
        self._setDefault(outputCol="ListCustomModels_4edbad0387a4_output")
    ...
    def getOp(self):
        ...
        Returns:
            op: Specify whether to return summary or full list of models.
        """
        return self.getOrDefault(self.op)
