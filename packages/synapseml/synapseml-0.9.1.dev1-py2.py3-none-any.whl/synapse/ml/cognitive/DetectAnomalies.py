...
class DetectAnomalies(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="DetectAnomalies_224e18c4f2e6_error",
        granularity=None,
        granularityCol=None,
        handler=None,
        maxAnomalyRatio=None,
        maxAnomalyRatioCol=None,
        outputCol="DetectAnomalies_224e18c4f2e6_output",
        period=None,
        periodCol=None,
        sensitivity=None,
        sensitivityCol=None,
        ...
        self._setDefault(errorCol="DetectAnomalies_224e18c4f2e6_error")
        self._setDefault(outputCol="DetectAnomalies_224e18c4f2e6_output")
