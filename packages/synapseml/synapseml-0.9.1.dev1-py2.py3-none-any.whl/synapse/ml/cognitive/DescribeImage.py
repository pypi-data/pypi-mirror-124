...
class DescribeImage(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    language = Param(Params._dummy(), "language", "Language of image description")
    
    maxCandidates = Param(Params._dummy(), "maxCandidates", "Maximum candidate descriptions to return")
    ...
    def __init__(
        ...
        errorCol="DescribeImage_c66f2bbc83c9_error",
        handler=None,
        imageBytes=None,
        imageBytesCol=None,
        imageUrl=None,
        ...
        outputCol="DescribeImage_c66f2bbc83c9_output",
        ...
        self._setDefault(errorCol="DescribeImage_c66f2bbc83c9_error")
        self._setDefault(outputCol="DescribeImage_c66f2bbc83c9_output")
    ...
    def getMaxCandidates(self):
        ...
        Returns:
            maxCandidates: Maximum candidate descriptions to return
        """
        return self.getOrDefault(self.maxCandidates)
