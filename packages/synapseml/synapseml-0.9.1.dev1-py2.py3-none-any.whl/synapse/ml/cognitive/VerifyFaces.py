...
class VerifyFaces(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    faceId = Param(Params._dummy(), "faceId", "faceId of the face, comes from Face - Detect.")
    
    faceId1 = Param(Params._dummy(), "faceId1", "faceId of one face, comes from Face - Detect.")
    
    faceId2 = Param(Params._dummy(), "faceId2", "faceId of another face, comes from Face - Detect.")
    
    handler = Param(Params._dummy(), "handler", "Which strategy to use when handling requests")
    
    largePersonGroupId = Param(Params._dummy(), "largePersonGroupId", "Using existing largePersonGroupId and personId for fast adding a specified person. largePersonGroupId is created in LargePersonGroup - Create. Parameter personGroupId and largePersonGroupId should not be provided at the same time.")
    
    outputCol = Param(Params._dummy(), "outputCol", "The name of the output column")
    
    personGroupId = Param(Params._dummy(), "personGroupId", "Using existing personGroupId and personId for fast loading a specified person. personGroupId is created in PersonGroup - Create. Parameter personGroupId and largePersonGroupId should not be provided at the same time.")
    
    personId = Param(Params._dummy(), "personId", "Specify a certain person in a person group or a large person group. personId is created in PersonGroup Person - Create or LargePersonGroup Person - Create.")
    ...
    def __init__(
        ...
        errorCol="VerifyFaces_75c71fb065a6_error",
        faceId=None,
        faceIdCol=None,
        faceId1=None,
        faceId1Col=None,
        ...
        outputCol="VerifyFaces_75c71fb065a6_output",
        personGroupId=None,
        ...
        self._setDefault(errorCol="VerifyFaces_75c71fb065a6_error")
        self._setDefault(outputCol="VerifyFaces_75c71fb065a6_output")
    ...
    def getFaceId1(self):
        ...
        Returns:
            faceId1: faceId of one face, comes from Face - Detect.
        """
        return self.getOrDefault(self.faceId1)
    ...
    def getFaceId2(self):
        ...
        Returns:
            faceId2: faceId of another face, comes from Face - Detect.
        """
        return self.getOrDefault(self.faceId2)
    ...
    def getLargePersonGroupId(self):
        ...
        Returns:
            largePersonGroupId: Using existing largePersonGroupId and personId for fast adding a specified person. largePersonGroupId is created in LargePersonGroup - Create. Parameter personGroupId and largePersonGroupId should not be provided at the same time.
        """
        return self.getOrDefault(self.largePersonGroupId)
    ...
    def getPersonGroupId(self):
        ...
        Returns:
            personGroupId: Using existing personGroupId and personId for fast loading a specified person. personGroupId is created in PersonGroup - Create. Parameter personGroupId and largePersonGroupId should not be provided at the same time.
        """
        return self.getOrDefault(self.personGroupId)
    ...
    def getPersonId(self):
        ...
        Returns:
            personId: Specify a certain person in a person group or a large person group. personId is created in PersonGroup Person - Create or LargePersonGroup Person - Create.
        """
        return self.getOrDefault(self.personId)
