...
class GroupFaces(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    faceIds = Param(Params._dummy(), "faceIds", "Array of candidate faceId created by Face - Detect. The maximum is 1000 faces.")
    ...
    def __init__(
        ...
        errorCol="GroupFaces_d6f831420156_error",
        faceIds=None,
        faceIdsCol=None,
        handler=None,
        outputCol="GroupFaces_d6f831420156_output",
        ...
        self._setDefault(errorCol="GroupFaces_d6f831420156_error")
        self._setDefault(outputCol="GroupFaces_d6f831420156_output")
