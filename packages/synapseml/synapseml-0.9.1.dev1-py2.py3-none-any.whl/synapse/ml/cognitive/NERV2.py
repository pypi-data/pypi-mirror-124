...
class NERV2(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="NERV2_e245be717da6_error",
        handler=None,
        language=None,
        languageCol=None,
        outputCol="NERV2_e245be717da6_output",
        ...
        self._setDefault(errorCol="NERV2_e245be717da6_error")
        self._setDefault(outputCol="NERV2_e245be717da6_output")
