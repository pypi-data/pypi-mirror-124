...
class GenerateThumbnails(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    height = Param(Params._dummy(), "height", "the desired height of the image")
    ...
    smartCropping = Param(Params._dummy(), "smartCropping", "whether to intelligently crop the image")
    ...
    width = Param(Params._dummy(), "width", "the desired width of the image")
    ...
    def __init__(
        ...
        errorCol="GenerateThumbnails_e774a1508b4a_error",
        handler=None,
        height=None,
        heightCol=None,
        imageBytes=None,
        ...
        imageUrl=None,
        imageUrlCol=None,
        outputCol="GenerateThumbnails_e774a1508b4a_output",
        smartCropping=None,
        ...
        self._setDefault(errorCol="GenerateThumbnails_e774a1508b4a_error")
        self._setDefault(outputCol="GenerateThumbnails_e774a1508b4a_output")
    ...
    def getSmartCropping(self):
        ...
        Returns:
            smartCropping: whether to intelligently crop the image
        """
        return self.getOrDefault(self.smartCropping)
