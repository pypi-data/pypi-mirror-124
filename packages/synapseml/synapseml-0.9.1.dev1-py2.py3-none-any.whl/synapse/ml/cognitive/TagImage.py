...
class TagImage(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    language = Param(Params._dummy(), "language", "The desired language for output generation.")
    ...
    def __init__(
        ...
        errorCol="TagImage_fd7ad790513d_error",
        handler=None,
        imageBytes=None,
        imageBytesCol=None,
        imageUrl=None,
        ...
        language=None,
        languageCol=None,
        outputCol="TagImage_fd7ad790513d_output",
        ...
        self._setDefault(errorCol="TagImage_fd7ad790513d_error")
        self._setDefault(outputCol="TagImage_fd7ad790513d_output")
