...
class LanguageDetectorV2(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="LanguageDetectorV2_e8525e3f24bf_error",
        handler=None,
        language=None,
        languageCol=None,
        outputCol="LanguageDetectorV2_e8525e3f24bf_output",
        ...
        self._setDefault(errorCol="LanguageDetectorV2_e8525e3f24bf_error")
        self._setDefault(outputCol="LanguageDetectorV2_e8525e3f24bf_output")
