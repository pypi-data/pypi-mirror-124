...
class Transliterate(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    language = Param(Params._dummy(), "language", "Language tag identifying the language of the input text. If a code is not specified, automatic language detection will be applied.")
    ...
    def __init__(
        ...
        errorCol="Transliterate_2ba4297bb1de_error",
        fromScript=None,
        fromScriptCol=None,
        handler=None,
        language=None,
        languageCol=None,
        outputCol="Transliterate_2ba4297bb1de_output",
        ...
        self._setDefault(errorCol="Transliterate_2ba4297bb1de_error")
        self._setDefault(outputCol="Transliterate_2ba4297bb1de_output")
