...
class Detect(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="Detect_eae4870538fb_error",
        handler=None,
        outputCol="Detect_eae4870538fb_output",
        ...
        self._setDefault(errorCol="Detect_eae4870538fb_error")
        self._setDefault(outputCol="Detect_eae4870538fb_output")
