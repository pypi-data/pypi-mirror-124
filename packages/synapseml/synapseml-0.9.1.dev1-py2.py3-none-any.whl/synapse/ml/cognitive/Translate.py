...
class Translate(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    allowFallback = Param(Params._dummy(), "allowFallback", "Specifies that the service is allowed to fall back to a general system when a custom system does not exist. ")
    
    category = Param(Params._dummy(), "category", "A string specifying the category (domain) of the translation. This parameter is used to get translations from a customized system built with Custom Translator. Add the Category ID from your Custom Translator project details to this parameter to use your deployed customized system. Default value is: general.")
    ...
    fromLanguage = Param(Params._dummy(), "fromLanguage", "Specifies the language of the input text. Find which languages are available to translate from by looking up supported languages using the translation scope. If the from parameter is not specified, automatic language detection is applied to determine the source language. You must use the from parameter rather than autodetection when using the dynamic dictionary feature.")
    
    fromScript = Param(Params._dummy(), "fromScript", "Specifies the script of the input text.")
    
    handler = Param(Params._dummy(), "handler", "Which strategy to use when handling requests")
    
    includeAlignment = Param(Params._dummy(), "includeAlignment", "Specifies whether to include alignment projection from source text to translated text.")
    
    includeSentenceLength = Param(Params._dummy(), "includeSentenceLength", "Specifies whether to include sentence boundaries for the input text and the translated text. ")
    
    outputCol = Param(Params._dummy(), "outputCol", "The name of the output column")
    
    profanityAction = Param(Params._dummy(), "profanityAction", "Specifies how profanities should be treated in translations. Possible values are: NoAction (default), Marked or Deleted. ")
    
    profanityMarker = Param(Params._dummy(), "profanityMarker", "Specifies how profanities should be marked in translations. Possible values are: Asterisk (default) or Tag.")
    
    subscriptionKey = Param(Params._dummy(), "subscriptionKey", "the API key to use")
    
    subscriptionRegion = Param(Params._dummy(), "subscriptionRegion", "the API region to use")
    
    suggestedFrom = Param(Params._dummy(), "suggestedFrom", "Specifies a fallback language if the language of the input text can't be identified. Language autodetection is applied when the from parameter is omitted. If detection fails, the suggestedFrom language will be assumed.")
    
    text = Param(Params._dummy(), "text", "the string to translate")
    
    textType = Param(Params._dummy(), "textType", "Defines whether the text being translated is plain text or HTML text. Any HTML needs to be a well-formed, complete element. Possible values are: plain (default) or html.")
    ...
    toLanguage = Param(Params._dummy(), "toLanguage", "Specifies the language of the output text. The target language must be one of the supported languages included in the translation scope. For example, use to=de to translate to German. It's possible to translate to multiple languages simultaneously by repeating the parameter in the query string. For example, use to=de&to=it to translate to German and Italian.")
    
    toScript = Param(Params._dummy(), "toScript", "Specifies the script of the translated text.")
    ...
    def __init__(
        ...
        errorCol="Translate_6a193a21fd85_error",
        fromLanguage=None,
        ...
        outputCol="Translate_6a193a21fd85_output",
        ...
        self._setDefault(errorCol="Translate_6a193a21fd85_error")
        self._setDefault(outputCol="Translate_6a193a21fd85_output")
    ...
    def getAllowFallback(self):
        ...
        Returns:
            allowFallback: Specifies that the service is allowed to fall back to a general system when a custom system does not exist. 
        """
        return self.getOrDefault(self.allowFallback)
    ...
    def getCategory(self):
        ...
        Returns:
            category: A string specifying the category (domain) of the translation. This parameter is used to get translations from a customized system built with Custom Translator. Add the Category ID from your Custom Translator project details to this parameter to use your deployed customized system. Default value is: general.
        """
        return self.getOrDefault(self.category)
    ...
    def getFromLanguage(self):
        ...
        Returns:
            fromLanguage: Specifies the language of the input text. Find which languages are available to translate from by looking up supported languages using the translation scope. If the from parameter is not specified, automatic language detection is applied to determine the source language. You must use the from parameter rather than autodetection when using the dynamic dictionary feature.
        """
        return self.getOrDefault(self.fromLanguage)
    ...
    def getFromScript(self):
        ...
        Returns:
            fromScript: Specifies the script of the input text.
        """
        return self.getOrDefault(self.fromScript)
    ...
    def getIncludeAlignment(self):
        ...
        Returns:
            includeAlignment: Specifies whether to include alignment projection from source text to translated text.
        """
        return self.getOrDefault(self.includeAlignment)
    ...
    def getIncludeSentenceLength(self):
        ...
        Returns:
            includeSentenceLength: Specifies whether to include sentence boundaries for the input text and the translated text. 
        """
        return self.getOrDefault(self.includeSentenceLength)
    ...
    def getProfanityAction(self):
        ...
        Returns:
            profanityAction: Specifies how profanities should be treated in translations. Possible values are: NoAction (default), Marked or Deleted. 
        """
        return self.getOrDefault(self.profanityAction)
    ...
    def getProfanityMarker(self):
        ...
        Returns:
            profanityMarker: Specifies how profanities should be marked in translations. Possible values are: Asterisk (default) or Tag.
        """
        return self.getOrDefault(self.profanityMarker)
    ...
    def getSubscriptionRegion(self):
        ...
        Returns:
            subscriptionRegion: the API region to use
        """
        return self.getOrDefault(self.subscriptionRegion)
    ...
    def getSuggestedFrom(self):
        ...
        Returns:
            suggestedFrom: Specifies a fallback language if the language of the input text can't be identified. Language autodetection is applied when the from parameter is omitted. If detection fails, the suggestedFrom language will be assumed.
        """
        return self.getOrDefault(self.suggestedFrom)
    ...
    def getTextType(self):
        ...
        Returns:
            textType: Defines whether the text being translated is plain text or HTML text. Any HTML needs to be a well-formed, complete element. Possible values are: plain (default) or html.
        """
        return self.getOrDefault(self.textType)
    ...
    def getToLanguage(self):
        ...
        Returns:
            toLanguage: Specifies the language of the output text. The target language must be one of the supported languages included in the translation scope. For example, use to=de to translate to German. It's possible to translate to multiple languages simultaneously by repeating the parameter in the query string. For example, use to=de&to=it to translate to German and Italian.
        """
        return self.getOrDefault(self.toLanguage)
    ...
    def getToScript(self):
        ...
        Returns:
            toScript: Specifies the script of the translated text.
        """
        return self.getOrDefault(self.toScript)
