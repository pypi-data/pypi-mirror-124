...
class SimpleDetectAnomalies(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    groupbyCol = Param(Params._dummy(), "groupbyCol", "column that groups the series")
    ...
    timestampCol = Param(Params._dummy(), "timestampCol", "column representing the time of the series")
    
    url = Param(Params._dummy(), "url", "Url of the service")
    
    valueCol = Param(Params._dummy(), "valueCol", "column representing the value of the series")
    ...
    def __init__(
        ...
        errorCol="SimpleDetectAnomalies_a52eb02376d8_error",
        granularity=None,
        granularityCol=None,
        groupbyCol=None,
        handler=None,
        ...
        outputCol="SimpleDetectAnomalies_a52eb02376d8_output",
        period=None,
        periodCol=None,
        sensitivity=None,
        sensitivityCol=None,
        ...
        self._setDefault(errorCol="SimpleDetectAnomalies_a52eb02376d8_error")
        self._setDefault(outputCol="SimpleDetectAnomalies_a52eb02376d8_output")
