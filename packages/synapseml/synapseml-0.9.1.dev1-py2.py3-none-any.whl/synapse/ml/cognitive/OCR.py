...
class OCR(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    detectOrientation = Param(Params._dummy(), "detectOrientation", "whether to detect image orientation prior to processing")
    ...
    language = Param(Params._dummy(), "language", "the language to use")
    ...
    def __init__(
        ...
        errorCol="OCR_1ff94a1f6856_error",
        handler=None,
        imageBytes=None,
        imageBytesCol=None,
        imageUrl=None,
        ...
        language=None,
        languageCol=None,
        outputCol="OCR_1ff94a1f6856_output",
        ...
        self._setDefault(errorCol="OCR_1ff94a1f6856_error")
        self._setDefault(outputCol="OCR_1ff94a1f6856_output")
    ...
    def getDetectOrientation(self):
        ...
        Returns:
            detectOrientation: whether to detect image orientation prior to processing
        """
        return self.getOrDefault(self.detectOrientation)
