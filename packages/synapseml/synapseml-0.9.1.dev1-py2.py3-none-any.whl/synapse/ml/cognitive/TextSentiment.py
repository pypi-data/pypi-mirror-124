...
class TextSentiment(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    opinionMining = Param(Params._dummy(), "opinionMining", "if set to true, response will contain not only sentiment prediction but also opinion mining (aspect-based sentiment analysis) results.")
    ...
    def __init__(
        ...
        errorCol="TextSentiment_66b4acd8a7e2_error",
        handler=None,
        language=None,
        languageCol=None,
        modelVersion=None,
        ...
        outputCol="TextSentiment_66b4acd8a7e2_output",
        showStats=None,
        showStatsCol=None,
        ...
        self._setDefault(errorCol="TextSentiment_66b4acd8a7e2_error")
        self._setDefault(outputCol="TextSentiment_66b4acd8a7e2_output")
    ...
    def getOpinionMining(self):
        ...
        Returns:
            opinionMining: if set to true, response will contain not only sentiment prediction but also opinion mining (aspect-based sentiment analysis) results.
        """
        return self.getOrDefault(self.opinionMining)
