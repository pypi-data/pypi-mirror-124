...
class ComputePerInstanceStatistics(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    scoredLabelsCol = Param(Params._dummy(), "scoredLabelsCol", "Scored labels column name, only required if using SparkML estimators")
    
    scoredProbabilitiesCol = Param(Params._dummy(), "scoredProbabilitiesCol", "Scored probabilities, usually calibrated from raw scores, only required if using SparkML estimators")
    
    scoresCol = Param(Params._dummy(), "scoresCol", "Scores or raw prediction column name, only required if using SparkML estimators")
