...
class _VowpalWabbitContextualBandit(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaEstimator):
    ...
    Args:
        ...
        args (object): VW command line arguments passed
        chosenActionCol (object): Column name of chosen action
        epsilon (float): epsilon used for exploration
        featuresCol (object): features column name
        hashSeed (int): Seed used for hashing
        ignoreNamespaces (object): Namespaces to be ignored (first letter only)
        ...
        probabilityCol (object): Column name of probability of chosen action
        sharedCol (object): Column name of shared features
    ...
    args = Param(Params._dummy(), "args", "VW command line arguments passed")
    
    chosenActionCol = Param(Params._dummy(), "chosenActionCol", "Column name of chosen action")
    ...
    ignoreNamespaces = Param(Params._dummy(), "ignoreNamespaces", "Namespaces to be ignored (first letter only)")
    ...
    probabilityCol = Param(Params._dummy(), "probabilityCol", "Column name of probability of chosen action")
    
    sharedCol = Param(Params._dummy(), "sharedCol", "Column name of shared features")
    ...
    def setArgs(self, value):
        """
        Args:
            args: VW command line arguments passed
        """
