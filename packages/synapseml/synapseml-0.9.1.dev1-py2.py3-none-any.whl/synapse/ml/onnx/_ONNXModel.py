...
class _ONNXModel(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    Args:
        ...
        deviceType (object): Specify a device type the model inference runs on. Supported types are: CPU or CUDA.If not specified, auto detection will be used.
        ...
        optimizationLevel (object): Specify the optimization level for the ONNX graph optimizations. Details at https://onnxruntime.ai/docs/resources/graph-optimizations.html#graph-optimization-levels. Supported values are: NO_OPT; BASIC_OPT; EXTENDED_OPT; ALL_OPT. Default: ALL_OPT.
    ...
    deviceType = Param(Params._dummy(), "deviceType", "Specify a device type the model inference runs on. Supported types are: CPU or CUDA.If not specified, auto detection will be used.")
    ...
    optimizationLevel = Param(Params._dummy(), "optimizationLevel", "Specify the optimization level for the ONNX graph optimizations. Details at https://onnxruntime.ai/docs/resources/graph-optimizations.html#graph-optimization-levels. Supported values are: NO_OPT; BASIC_OPT; EXTENDED_OPT; ALL_OPT. Default: ALL_OPT.")
