...
class TabularSHAP(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    targetClassesCol = Param(Params._dummy(), "targetClassesCol", "The name of the column that specifies the indices of the classes for multinomial classification models.")
    
    targetCol = Param(Params._dummy(), "targetCol", "The column name of the prediction target to explain (i.e. the response variable). This is usually set to \"prediction\" for regression models and \"probability\" for probabilistic classification models. Default value: probability")
    ...
    def __init__(
        ...
        model=None,
        numSamples=None,
        outputCol="TabularSHAP_dedb679a84d3__output",
        targetClasses=[],
        ...
        self._setDefault(outputCol="TabularSHAP_dedb679a84d3__output")
