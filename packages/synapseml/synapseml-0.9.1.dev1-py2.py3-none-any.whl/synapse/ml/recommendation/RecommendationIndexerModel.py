...
class RecommendationIndexerModel(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaModel):
    ...
    Args:
        ...
        itemInputCol (object): Item Input Col
        itemOutputCol (object): Item Output Col
        ratingCol (object): Rating Col
        userIndexModel (object): userIndexModel
        userInputCol (object): User Input Col
        userOutputCol (object): User Output Col
    """

    itemIndexModel = Param(Params._dummy(), "itemIndexModel", "itemIndexModel")
    
    itemInputCol = Param(Params._dummy(), "itemInputCol", "Item Input Col")
    
    itemOutputCol = Param(Params._dummy(), "itemOutputCol", "Item Output Col")
    
    ratingCol = Param(Params._dummy(), "ratingCol", "Rating Col")
    
    userIndexModel = Param(Params._dummy(), "userIndexModel", "userIndexModel")
    
    userInputCol = Param(Params._dummy(), "userInputCol", "User Input Col")
    
    userOutputCol = Param(Params._dummy(), "userOutputCol", "User Output Col")
