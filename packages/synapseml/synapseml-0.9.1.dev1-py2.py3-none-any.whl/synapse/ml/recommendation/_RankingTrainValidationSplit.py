...
class _RankingTrainValidationSplit(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaEstimator):
    ...
    Args:
        ...
        trainRatio (float): ratio between training set and validation set (>= 0 && <= 1)
    ...
    trainRatio = Param(Params._dummy(), "trainRatio", "ratio between training set and validation set (>= 0 && <= 1)", typeConverter=TypeConverters.toFloat)
