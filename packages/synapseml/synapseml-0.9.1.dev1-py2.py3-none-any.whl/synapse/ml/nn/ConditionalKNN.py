...
class ConditionalKNN(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaEstimator):
    ...
    conditionerCol = Param(Params._dummy(), "conditionerCol", "column holding identifiers for features that will be returned when queried")
    
    featuresCol = Param(Params._dummy(), "featuresCol", "The name of the features column")
    ...
    valuesCol = Param(Params._dummy(), "valuesCol", "column holding values for each feature (key) that will be returned when queried")
    ...
    def __init__(
        ...
        labelCol="labels",
        leafSize=50,
        outputCol="ConditionalKNN_f53f2b96864a_output",
        valuesCol="values"
        ):
        ...
        self._setDefault(outputCol="ConditionalKNN_f53f2b96864a_output")
