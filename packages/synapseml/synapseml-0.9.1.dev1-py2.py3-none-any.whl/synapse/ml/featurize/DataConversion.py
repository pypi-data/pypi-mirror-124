...
class DataConversion(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    Args:
        ...
        convertTo (object): The result type
        dateTimeFormat (object): Format for DateTime when making DateTime:String conversions
    """
    ...
    convertTo = Param(Params._dummy(), "convertTo", "The result type")
    
    dateTimeFormat = Param(Params._dummy(), "dateTimeFormat", "Format for DateTime when making DateTime:String conversions")
