...
class ValueIndexerModel(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaModel):
    """
    Args:
        dataType (object): The datatype of the levels as a Json string
    ...
    dataType = Param(Params._dummy(), "dataType", "The datatype of the levels as a Json string")
    ...
    def __init__(
        ...
        inputCol="input",
        levels=None,
        outputCol="ValueIndexerModel_f8e745fcc436_output"
        ):
        ...
        self._setDefault(outputCol="ValueIndexerModel_f8e745fcc436_output")
