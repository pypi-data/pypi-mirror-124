...
class PageSplitter(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    boundaryRegex = Param(Params._dummy(), "boundaryRegex", "how to split into words")
    ...
    def __init__(
        ...
        outputCol="PageSplitter_e704bff7805d_output"
        ):
        ...
        self._setDefault(outputCol="PageSplitter_e704bff7805d_output")
