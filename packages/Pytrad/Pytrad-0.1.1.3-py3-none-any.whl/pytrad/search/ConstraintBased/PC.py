import time
from pytrad.utils.PCUtils import Algorithm1, Algorithm2, Algorithm3, Helper
from itertools import permutations, combinations
from pytrad.graph.GraphClass import CausalGraph
import numpy as np
from pytrad.utils.cit import fisherz, chisq, gsq, mv_fisherz, kci, mc_fisherz
...
def pc(data, alpha, indep_test, stable, uc_rule, uc_priority, mvpc=False, correction_name='MV_Crtn_Fisher_Z'):
    if mvpc:
        ...
        return pc_alg(data=data, alpha=alpha, indep_test=indep_test, stable=stable, uc_rule=uc_rule, uc_priority=uc_priority)



def pc_alg(data, alpha, indep_test, stable, uc_rule, uc_priority):
    '''
