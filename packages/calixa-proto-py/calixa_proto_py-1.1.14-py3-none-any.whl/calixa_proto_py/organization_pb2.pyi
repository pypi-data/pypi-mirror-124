...
CustomerPropertyFieldTypeValue = typing___NewType('CustomerPropertyFieldTypeValue', builtin___int)
type___CustomerPropertyFieldTypeValue = CustomerPropertyFieldTypeValue
CustomerPropertyFieldType: _CustomerPropertyFieldType
class _CustomerPropertyFieldType(google___protobuf___internal___enum_type_wrapper____EnumTypeWrapper[CustomerPropertyFieldTypeValue]):
    DESCRIPTOR: google___protobuf___descriptor___EnumDescriptor = ...
    CUSTOMER_PROPERTY_FIELD_TYPE_UNSPECIFIED = typing___cast(CustomerPropertyFieldTypeValue, 0)
    CUSTOMER_PROPERTY_FIELD_TYPE_INTEGER = typing___cast(CustomerPropertyFieldTypeValue, 1)
    CUSTOMER_PROPERTY_FIELD_TYPE_DECIMAL = typing___cast(CustomerPropertyFieldTypeValue, 2)
    CUSTOMER_PROPERTY_FIELD_TYPE_STRING = typing___cast(CustomerPropertyFieldTypeValue, 3)
    CUSTOMER_PROPERTY_FIELD_TYPE_BOOLEAN = typing___cast(CustomerPropertyFieldTypeValue, 4)
    CUSTOMER_PROPERTY_FIELD_TYPE_TIMESTAMP = typing___cast(CustomerPropertyFieldTypeValue, 5)
CUSTOMER_PROPERTY_FIELD_TYPE_UNSPECIFIED = typing___cast(CustomerPropertyFieldTypeValue, 0)
CUSTOMER_PROPERTY_FIELD_TYPE_INTEGER = typing___cast(CustomerPropertyFieldTypeValue, 1)
CUSTOMER_PROPERTY_FIELD_TYPE_DECIMAL = typing___cast(CustomerPropertyFieldTypeValue, 2)
CUSTOMER_PROPERTY_FIELD_TYPE_STRING = typing___cast(CustomerPropertyFieldTypeValue, 3)
CUSTOMER_PROPERTY_FIELD_TYPE_BOOLEAN = typing___cast(CustomerPropertyFieldTypeValue, 4)
CUSTOMER_PROPERTY_FIELD_TYPE_TIMESTAMP = typing___cast(CustomerPropertyFieldTypeValue, 5)
type___CustomerPropertyFieldType = CustomerPropertyFieldType
...
class Settings(google___protobuf___message___Message):
    ...
    @property
    def custom_property_definitions(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[type___CustomPropertyDefinition]: ...
    ...
    def __init__(self,
        *,
        ...
        custom_property_definitions : typing___Optional[typing___Iterable[type___CustomPropertyDefinition]] = None,
        ) -> None: ...
    ...
    def ClearField(self, field_name: typing_extensions___Literal[u"custom_property_definitions",b"custom_property_definitions",u"new_user_experience_calixa_api_selected_at",b"new_user_experience_calixa_api_selected_at",u"new_user_experience_completed_at",b"new_user_experience_completed_at",u"preferred_account_sources",b"preferred_account_sources"]) -> None: ...
type___Settings = Settings

class CustomPropertyDefinition(google___protobuf___message___Message):
    DESCRIPTOR: google___protobuf___descriptor___Descriptor = ...
    entity_type: common_pb2___EntityTypeValue = ...
    display_name: typing___Text = ...
    property_name: typing___Text = ...
    property_type: type___CustomerPropertyFieldTypeValue = ...
    ...
    def __init__(self,
        *,
        ...
        property_type : typing___Optional[type___CustomerPropertyFieldTypeValue] = None,
        ) -> None: ...
    def ClearField(self, field_name: typing_extensions___Literal[u"display_name",b"display_name",u"entity_type",b"entity_type",u"property_name",b"property_name",u"property_type",b"property_type"]) -> None: ...
type___CustomPropertyDefinition = CustomPropertyDefinition
