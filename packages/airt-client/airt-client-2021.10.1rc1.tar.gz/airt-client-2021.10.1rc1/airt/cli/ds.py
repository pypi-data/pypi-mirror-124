...
def head(
    ...
    """Return first few records for the given data source."""
...
def details(
    ...
    df = DataSource.details(data_id=int(data_id))
...
def rm(
    ...
    df = DataSource.delete(data_id=int(data_id))
