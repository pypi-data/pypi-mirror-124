...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, tls_validation=None, total_timeout=None, proxy_url=None, download_concurrency=None, pulp_labels=None, pulp_created=None, pulp_last_updated=None, url=None, headers=None, sock_connect_timeout=None, max_retries=None, connect_timeout=None, ca_cert=None, rate_limit=None, client_cert=None, sock_read_timeout=None, name=None, pulp_href=None, metadata_only=None, local_vars_configuration=None):  # noqa: E501
