...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, name=None, max_retries=None, tls_validation=None, url=None, pulp_created=None, pulp_href=None, download_concurrency=None, proxy_url=None, client_cert=None, sock_read_timeout=None, connect_timeout=None, sock_connect_timeout=None, total_timeout=None, pulp_labels=None, ca_cert=None, rate_limit=None, pulp_last_updated=None, headers=None, metadata_only=None, local_vars_configuration=None):  # noqa: E501
