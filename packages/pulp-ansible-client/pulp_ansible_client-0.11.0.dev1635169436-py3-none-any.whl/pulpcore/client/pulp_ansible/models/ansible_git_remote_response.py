...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, sock_connect_timeout=None, total_timeout=None, name=None, pulp_href=None, download_concurrency=None, connect_timeout=None, tls_validation=None, rate_limit=None, sock_read_timeout=None, proxy_url=None, headers=None, max_retries=None, pulp_labels=None, url=None, pulp_last_updated=None, client_cert=None, pulp_created=None, ca_cert=None, metadata_only=None, local_vars_configuration=None):  # noqa: E501
