...
class AnsibleGitRemote(object):
    ...
    def __init__(self, sock_connect_timeout=None, total_timeout=None, name=None, download_concurrency=None, password=None, username=None, connect_timeout=None, tls_validation=None, rate_limit=None, proxy_username=None, sock_read_timeout=None, proxy_url=None, headers=None, client_key=None, proxy_password=None, max_retries=None, pulp_labels=None, url=None, client_cert=None, ca_cert=None, metadata_only=None, local_vars_configuration=None):  # noqa: E501
