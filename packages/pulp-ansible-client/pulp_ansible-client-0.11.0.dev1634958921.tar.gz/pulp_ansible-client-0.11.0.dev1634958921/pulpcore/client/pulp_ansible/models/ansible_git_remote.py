...
class AnsibleGitRemote(object):
    ...
    def __init__(self, url=None, download_concurrency=None, proxy_password=None, connect_timeout=None, password=None, client_key=None, name=None, proxy_url=None, pulp_labels=None, ca_cert=None, sock_connect_timeout=None, tls_validation=None, proxy_username=None, total_timeout=None, max_retries=None, headers=None, username=None, client_cert=None, sock_read_timeout=None, rate_limit=None, metadata_only=None, local_vars_configuration=None):  # noqa: E501
