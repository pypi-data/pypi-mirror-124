...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, pulp_labels=None, total_timeout=None, download_concurrency=None, pulp_created=None, max_retries=None, client_cert=None, tls_validation=None, ca_cert=None, headers=None, proxy_url=None, pulp_href=None, rate_limit=None, pulp_last_updated=None, connect_timeout=None, sock_connect_timeout=None, sock_read_timeout=None, name=None, url=None, metadata_only=None, local_vars_configuration=None):  # noqa: E501
