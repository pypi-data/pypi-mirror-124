...
class AnsibleGitRemote(object):
    ...
    def __init__(self, name=None, connect_timeout=None, sock_read_timeout=None, tls_validation=None, password=None, headers=None, proxy_password=None, client_key=None, proxy_url=None, client_cert=None, download_concurrency=None, rate_limit=None, sock_connect_timeout=None, max_retries=None, proxy_username=None, total_timeout=None, username=None, url=None, ca_cert=None, pulp_labels=None, metadata_only=None, local_vars_configuration=None):  # noqa: E501
