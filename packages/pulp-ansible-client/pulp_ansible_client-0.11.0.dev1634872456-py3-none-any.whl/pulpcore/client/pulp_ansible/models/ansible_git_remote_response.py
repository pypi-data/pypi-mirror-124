...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, name=None, connect_timeout=None, sock_read_timeout=None, pulp_href=None, tls_validation=None, headers=None, proxy_url=None, client_cert=None, download_concurrency=None, rate_limit=None, pulp_created=None, sock_connect_timeout=None, max_retries=None, total_timeout=None, pulp_last_updated=None, url=None, ca_cert=None, pulp_labels=None, metadata_only=None, local_vars_configuration=None):  # noqa: E501
