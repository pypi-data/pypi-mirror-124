...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, pulp_last_updated=None, url=None, download_concurrency=None, connect_timeout=None, name=None, proxy_url=None, pulp_labels=None, ca_cert=None, sock_connect_timeout=None, tls_validation=None, total_timeout=None, pulp_href=None, max_retries=None, headers=None, client_cert=None, sock_read_timeout=None, pulp_created=None, rate_limit=None, metadata_only=None, local_vars_configuration=None):  # noqa: E501
