...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, pulp_created=None, client_cert=None, ca_cert=None, total_timeout=None, rate_limit=None, connect_timeout=None, url=None, download_concurrency=None, sock_read_timeout=None, pulp_last_updated=None, headers=None, max_retries=None, name=None, pulp_labels=None, tls_validation=None, sock_connect_timeout=None, pulp_href=None, proxy_url=None, metadata_only=None, local_vars_configuration=None):  # noqa: E501
