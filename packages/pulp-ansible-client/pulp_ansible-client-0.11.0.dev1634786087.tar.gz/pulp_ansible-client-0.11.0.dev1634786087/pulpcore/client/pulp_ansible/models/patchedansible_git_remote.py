...
class PatchedansibleGitRemote(object):
    ...
    def __init__(self, client_cert=None, ca_cert=None, total_timeout=None, rate_limit=None, connect_timeout=None, url=None, password=None, download_concurrency=None, sock_read_timeout=None, headers=None, proxy_password=None, client_key=None, max_retries=None, name=None, pulp_labels=None, tls_validation=None, username=None, sock_connect_timeout=None, proxy_username=None, proxy_url=None, metadata_only=None, local_vars_configuration=None):  # noqa: E501
