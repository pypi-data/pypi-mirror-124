...
class AnsibleGitRemote(object):
    ...
    def __init__(self, client_key=None, tls_validation=None, total_timeout=None, proxy_url=None, download_concurrency=None, pulp_labels=None, url=None, proxy_username=None, headers=None, sock_connect_timeout=None, password=None, max_retries=None, connect_timeout=None, ca_cert=None, rate_limit=None, client_cert=None, username=None, sock_read_timeout=None, name=None, proxy_password=None, metadata_only=None, local_vars_configuration=None):  # noqa: E501
