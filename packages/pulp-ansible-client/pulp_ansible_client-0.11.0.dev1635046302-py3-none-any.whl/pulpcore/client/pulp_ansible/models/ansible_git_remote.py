...
class AnsibleGitRemote(object):
    ...
    def __init__(self, headers=None, proxy_password=None, client_key=None, name=None, pulp_labels=None, connect_timeout=None, password=None, rate_limit=None, proxy_username=None, ca_cert=None, download_concurrency=None, sock_connect_timeout=None, username=None, client_cert=None, sock_read_timeout=None, max_retries=None, proxy_url=None, tls_validation=None, url=None, total_timeout=None, metadata_only=None, local_vars_configuration=None):  # noqa: E501
