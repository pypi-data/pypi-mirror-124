...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, pulp_created=None, headers=None, name=None, pulp_labels=None, connect_timeout=None, rate_limit=None, pulp_href=None, ca_cert=None, download_concurrency=None, sock_connect_timeout=None, client_cert=None, sock_read_timeout=None, max_retries=None, pulp_last_updated=None, proxy_url=None, tls_validation=None, url=None, total_timeout=None, metadata_only=None, local_vars_configuration=None):  # noqa: E501
