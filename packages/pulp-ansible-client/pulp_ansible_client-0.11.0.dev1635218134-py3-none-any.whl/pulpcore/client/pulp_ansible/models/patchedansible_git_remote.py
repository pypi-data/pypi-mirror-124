...
class PatchedansibleGitRemote(object):
    ...
    def __init__(self, pulp_labels=None, client_key=None, total_timeout=None, download_concurrency=None, max_retries=None, client_cert=None, tls_validation=None, ca_cert=None, headers=None, username=None, proxy_url=None, proxy_username=None, rate_limit=None, password=None, connect_timeout=None, sock_connect_timeout=None, proxy_password=None, sock_read_timeout=None, name=None, url=None, metadata_only=None, local_vars_configuration=None):  # noqa: E501
