...
class classification:
	...
	classifier='GP', 'SVM', 'RandomForest', 'KNN', 'NeuralNet', 'LDA', 'NaiveBayes', 'GradientBoosting'
...
def run_every_classifier(data, y=None, y_column_name=None, order_by='Test'):
	...
	order_by: 'Test', 'Train'
	'''
	regressors=['GP', 'SVM', 'RandomForest', 'KNN', 'NeuralNet', 'LDA', 'NaiveBayes', 'GradientBoosting']
	results = {}
