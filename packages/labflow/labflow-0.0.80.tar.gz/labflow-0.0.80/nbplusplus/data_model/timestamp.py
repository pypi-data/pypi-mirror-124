...
class Timestamp(NamedTuple):
    ...
    def current(cls) -> Timestamp:
        # TODO: shouldn't have to go through nbpp() singleton to get the cell counter,
        #  but the dependency structure prevents us from importing from nbplusplus.data_model.code_cell
        return cls(nbpp().cell_counter(), tracer().module_stmt_counter())
