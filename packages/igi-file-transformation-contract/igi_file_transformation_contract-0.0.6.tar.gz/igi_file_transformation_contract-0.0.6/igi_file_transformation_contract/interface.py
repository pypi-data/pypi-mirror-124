...
class IFileTransformer(ABC):
    ...
    def accepts_file_extensions(self) -> List[str]:
        """ 
        A list of valid unique file type specifiers as defined here:
        https://developer.mozilla.org/en-US/docs/Web/HTML/Attributes/accept#unique_file_type_specifiers
        Can be a MIME type e.g. 'image/*' or specific extension e.g. '.xlsx', '.xls', ...
        """
        pass
    ...
    # TODO: Maybe - add accepts list of file extensions - could use in web app to pass
    #       into form and limit the accepts control.
