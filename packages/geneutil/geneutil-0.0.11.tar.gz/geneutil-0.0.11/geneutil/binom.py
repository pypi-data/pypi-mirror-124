...
class Analysis():
    ...
    def load_ref(self,library:str="",nmin:int=10):
        """
        ...
        if state["ref"]["database"]=="enrichr": # cf. MsigDB is given as ID by default
    ...
    def plot(self,display_num:int=5,thresh:float=0.05,**kwargs):
        """
        ...
        """
        self.__analyzer.plot(display_num=display_num,thresh=thresh,**kwargs)
