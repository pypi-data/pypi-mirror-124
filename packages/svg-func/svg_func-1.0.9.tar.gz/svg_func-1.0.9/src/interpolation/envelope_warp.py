...
def main(svgpath,sample_n=10,filetype='path',c_svg=None,arch_per=0.3,pos='up',fix='top', mode='arch',file_path = None):
    '''
...
if __name__ == "__main__":
    ...
    svg,xml = main(r"C:\Users\25790\Downloads\气.svg",file_path=None, filetype='path')
    # print(time.time()-st1)
