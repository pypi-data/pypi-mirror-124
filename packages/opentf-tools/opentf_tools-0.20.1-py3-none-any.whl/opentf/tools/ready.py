...
def are_ready_subscribers(init_services_list):
    ...
    try:
        ...
        if 'tm.generator.premium' in init_services_list:
            init_services_list.remove('tm.generator.premium')
            init_services_list.add('tm.generator')
        if 'tm.generator.community' in init_services_list:
            init_services_list.remove('tm.generator.community')
            init_services_list.add('tm.generator')
        if 'tm.generator.premium' in subscribers_list:
            subscribers_list.remove('tm.generator.premium')
            subscribers_list.add('tm.generator')
        if 'tm.generator.community' in subscribers_list:
            subscribers_list.remove('tm.generator.community')
            subscribers_list.add('tm.generator')
