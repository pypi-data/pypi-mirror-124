# Generated by Django 3.2.4 on 2021-06-25 22:57
...
class Migration(migrations.Migration):
    dependencies = [
        ...
        ('user_ext', '0074_remove_persons_region'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', isc_common.fields.related.ForeignKeyProtect(on_delete=django.db.models.deletion.PROTECT, related_name='Users_hidden_user', to=settings.AUTH_USER_MODEL)),
                ('user_hidden', isc_common.fields.related.ForeignKeyProtect(on_delete=django.db.models.deletion.PROTECT, related_name='Users_hidden_user_user_hidden', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'verbose_name': 'Кросс таблица',
                'unique_together': {('user', 'user_hidden')},
            },
        ),
    ]
