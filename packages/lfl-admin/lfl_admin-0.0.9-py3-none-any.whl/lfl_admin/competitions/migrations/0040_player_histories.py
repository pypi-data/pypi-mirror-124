...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('competitions', '0039_players_change_history'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('formation', models.SmallIntegerField()),
                ('props', bitfield.models.BitField((('game_started', 'game_started'), ('substituted', 'substituted'), ('keeper', 'keeper')), db_index=True, default=0)),
