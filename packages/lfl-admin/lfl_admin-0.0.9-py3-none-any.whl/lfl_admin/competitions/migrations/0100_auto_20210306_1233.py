# Generated by Django 3.1.7 on 2021-03-06 12:33
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('competitions', '0099_referee_category_old_id'),
    ]

    operations = [
        migrations.CreateModel(
            name='Protocol_type_types',
            fields=[
        ...
        migrations.AddField(
            model_name='tournaments',
            name='protocol_type',
            field=isc_common.fields.related.ForeignKeyProtect(default=None, on_delete=django.db.models.deletion.PROTECT, to='competitions.protocol_type_types'),
        ),
    ]
