...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('common', '0015_posts'),
        ('competitions', '0008_club_admins_club_admins_e_mails_club_admins_phones'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('logo', isc_common.fields.related.ForeignKeyProtect(on_delete=django.db.models.deletion.PROTECT, to='common.images')),
            ],
            options={
