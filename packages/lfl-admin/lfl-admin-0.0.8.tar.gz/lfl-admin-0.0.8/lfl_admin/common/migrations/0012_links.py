...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('common', '0011_auto_20210218_0437'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', isc_common.fields.related.ForeignKeyProtect(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='common.links')),
            ],
            options={
                'verbose_name': 'Якоря',
            },
