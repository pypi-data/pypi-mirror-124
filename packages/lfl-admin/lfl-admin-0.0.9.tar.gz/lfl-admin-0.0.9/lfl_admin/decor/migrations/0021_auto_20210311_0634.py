...
class Migration(migrations.Migration):
    dependencies = [
        ('decor', '0020_news_start_block_tournament'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='news',
            name='type',
            field=isc_common.fields.related.ForeignKeyProtect(default=None, on_delete=django.db.models.deletion.PROTECT, to='decor.news_type'),
        ),
    ]
