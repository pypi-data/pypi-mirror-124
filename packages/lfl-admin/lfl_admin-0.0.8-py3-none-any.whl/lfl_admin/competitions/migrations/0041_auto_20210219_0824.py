# Generated by Django 3.1.6 on 2021-02-19 08:24
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('competitions', '0040_player_histories'),
    ]

    operations = [
        migrations.AlterModelOptions(
            name='player_histories',
            options={'verbose_name': 'Данные об участии игрока в конкретном матче'},
        ),
        migrations.CreateModel(
            name='Player_tournament_cards_limit',
            fields=[
