...
if sys.platform == 'win32':
    ...
    excludes = {'ADVAPI.DLL', 'ADVAPI32.DLL', 'COMCTL32.DLL', 'COMDLG32.DLL', 'CRTDLL.DLL', 'CRYPT32.DLL',
                'DCIMAN32.DLL', 'DDRAW.DLL', 'GDI32.DLL', 'GLU32.DLL', 'GLUB32.DLL', 'IMM32.DLL', 'KERNEL32.DLL',
                'KERNELBASE.DLL', 'MFC42.DLL', 'MPR.DLL', 'MSVCRT.DLL', 'MSWSOCK.DLL', 'NTDLL.DLL', 'NETAPI32.DLL',
                'ODBC32.DLL', 'OLE32.DLL', 'OLEAUT32.DLL', 'OPENGL32.DLL', 'RPCRT4.DLL', 'SHELL32.DLL', 'SHLWAPI.DLL',
                'USER32.DLL', 'VERSION.DLL', 'WINMM.DLL', 'WINSPOOL.DRV', 'WS2HELP.DLL', 'WS2_32.DLL', 'WSOCK32.DLL',
                'MSVCR90.DLL', 'POWRPROF.DLL', 'SHFOLDER.DLL', 'QUERY.DLL'}
