...
from hestia_earth.schema import SCHEMA_VERSION, NodeType, TermTermType, PRODUCT_TERM
...
def _get_time_ranges(earliest_year: str, period_length: int = 10):
    """
...
def get_time_ranges(node_type: str, country_name: str, product_name: str):
    earliest_year = _earliest_date(node_type, product_name, country_name)
    return _get_time_ranges(earliest_year) if earliest_year else []
