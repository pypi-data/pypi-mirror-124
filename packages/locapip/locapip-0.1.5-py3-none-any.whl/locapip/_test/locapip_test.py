...
async def py_request(cpp_request):
    request_message = Parse(cpp_request(''), pb.Text())
...
async def py_response(response_message, cpp_response):
...
locapip.service['locapip_test'] = {
    'unary_unary': locapip.unary_unary,
    'unary_stream': locapip.unary_stream,
    'stream_unary': locapip.stream_unary,
    'stream_stream': locapip.stream_stream,
}

locapip.py_request['locapip_test'] = {
    'unary_unary': pb.Text,
