...
from iatiflattener.lib.variables import OUTPUT_HEADERS, headers_with_langs, dtypes_with_langs, group_by_headers_with_langs

CSV_HEADERS = headers_with_langs(['en'])
_DTYPES = dtypes_with_langs(['en'])
GROUP_BY_HEADERS = group_by_headers_with_langs(['en'])
