...
class Doctor:
    ...
    def latest_cli_version(self) -> VersionInfo:
        # TODO: implement this once the package is published
        return self.current_cli_version()

    @lru_cache(1)
    def current_cli_version(self) -> VersionInfo:
        return VersionInfo.parse(self.project.leapcli_package_info() \
                                     ['tool']['poetry']['version'])
    ...
    def check_project_exist(self):
        try:
            ...
            print(f'''Did no find project named {self.project.project}. Please create new project using the web UI or 
    ...
    def check_dataset_exist(self):
        try:
            ...
            print(f'''Did no find dataset named {self.project.dataset}. Please create new dataset using the web UI or 
