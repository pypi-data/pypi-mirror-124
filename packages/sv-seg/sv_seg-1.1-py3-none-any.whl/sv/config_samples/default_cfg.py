...
model_name = 'res18_fpn'
dataset_name = 'WHU_Overlapped'  # Vaihingen
...
_C.DATASET.ROOT = '/home/jyw/My_DatasetPatches/BE'  # dataset root dir
...
_C.DATASET.TEST_WHOLE_LABEL = os.path.join(_C.DATASET.ROOT, _C.DATASET.NAME, 'whole_test_img_label', 'image')
_C.DATASET.TEST_WHOLE_IMAGE = os.path.join(_C.DATASET.ROOT, _C.DATASET.NAME, 'whole_test_img_label', 'label')
...
_C.TRAIN.LR.STEP_SIZE = 20
_C.TRAIN.LR.WARMUP_EPOCH = 5  # period of warmup
