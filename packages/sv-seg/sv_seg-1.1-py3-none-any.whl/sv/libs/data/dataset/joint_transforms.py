...
class RandomScale(object):
    def __init__(self, cfg):
        self.p = cfg.TRAIN.AUG.MS_P
        self.scale_list = cfg.TRAIN.AUG.SCALE_LIST
...
class RandomCrop(object):
    def __init__(self, cfg, mean):
        self.crop_size = cfg.TRAIN.AUG.CROP_SIZE,
        self.mean = None,
        self.center_crop = cfg.TRAIN.AUG.CENTER_CROP,
...
class RandomRotation(object):
    def __init__(self, cfg):
        self.angle = cfg.TRAIN.AUG.ROTATION_ANGLE
        self.p = cfg.TRAIN.AUG.ROTATION_P
...
class RandomColorJitter(object):
    def __init__(self, cfg):
        brightness_factor = cfg.TRAIN.AUG.BRIGHTNESS_FACTOR,
        contrast_factor = cfg.TRAIN.AUG.CONTRAST_FACTOR,
        hue_factor = cfg.TRAIN.AUG.HUE_FACTOR,
        saturation_factor = cfg.TRAIN.AUG.SATURATION_FACTOR,
        p = cfg.TRAIN.AUG.C0LOR_JITTER_P
...
class RandomGaussianBlur(object):
    def __init__(self, cfg):
        self.radius = cfg.TRAIN.AUG.GAUSSIAN_BLUR_RADIUS
        self.p = cfg.TRAIN.AUG.GAUSSIAN_BLUR_P
...
class RandomGaussianNoise(object):
    def __init__(self, cfg):
        self.mean = cfg.TRAIN.AUG.GAUSSIAN_NOISE_MEAN
        self.var = cfg.TRAIN.AUG.GAUSSIAN_NOISE_VAR
        self.p = cfg.TRAIN.AUG.GAUSSIAN_NOISE_P
