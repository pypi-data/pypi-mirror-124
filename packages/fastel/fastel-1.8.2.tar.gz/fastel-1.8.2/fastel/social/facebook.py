...
class FacebookLogin:
    def __init__(self, data: SocialModel) -> None:
        ...
        self.FACEBOOK_AUTH_DIALOG = f"https://www.facebook.com/v9.0/dialog/oauth?client_id={self.project_client_id}&redirect_uri={self.CALLBACK_URL}&scope=email,public_profile"
        self.FACEBOOK_URL = f"https://graph.facebook.com"
