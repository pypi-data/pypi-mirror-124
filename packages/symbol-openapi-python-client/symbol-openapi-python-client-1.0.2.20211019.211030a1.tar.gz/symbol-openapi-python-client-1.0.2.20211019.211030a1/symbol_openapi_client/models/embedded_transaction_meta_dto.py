...
class EmbeddedTransactionMetaDTO(object):
    ...
    def __init__(self, height=None, aggregate_hash=None, aggregate_id=None, index=None, timestamp=None, fee_multiplier=None, local_vars_configuration=None):  # noqa: E501
    ...
    @property
    def timestamp(self):
        """Gets the timestamp of this EmbeddedTransactionMetaDTO.  # noqa: E501

        Number of milliseconds elapsed since the creation of the nemesis block. This value can be converted to epoch time by adding the network's 'epochAdjustment'.  # noqa: E501

        :return: The timestamp of this EmbeddedTransactionMetaDTO.  # noqa: E501
        :rtype: str
        """
    ...
    def timestamp(self, timestamp):
        """Sets the timestamp of this EmbeddedTransactionMetaDTO.

        Number of milliseconds elapsed since the creation of the nemesis block. This value can be converted to epoch time by adding the network's 'epochAdjustment'.  # noqa: E501

        :param timestamp: The timestamp of this EmbeddedTransactionMetaDTO.  # noqa: E501
        :type: str
        """
    ...
    def fee_multiplier(self):
        """Gets the fee_multiplier of this EmbeddedTransactionMetaDTO.  # noqa: E501

        Fee multiplier applied to transactions contained in block.  # noqa: E501

        :return: The fee_multiplier of this EmbeddedTransactionMetaDTO.  # noqa: E501
        :rtype: int
        """
    ...
    def fee_multiplier(self, fee_multiplier):
        """Sets the fee_multiplier of this EmbeddedTransactionMetaDTO.

        Fee multiplier applied to transactions contained in block.  # noqa: E501

        :param fee_multiplier: The fee_multiplier of this EmbeddedTransactionMetaDTO.  # noqa: E501
        :type: int
        """
