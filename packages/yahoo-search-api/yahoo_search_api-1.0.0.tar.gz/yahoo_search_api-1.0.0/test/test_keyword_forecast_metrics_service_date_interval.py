...
from yahoo_search_api.models.keyword_forecast_metrics_service_date_interval import KeywordForecastMetricsServiceDateInterval  # noqa: E501
from yahoo_search_api.rest import ApiException

class TestKeywordForecastMetricsServiceDateInterval(unittest.TestCase):
    """KeywordForecastMetricsServiceDateInterval unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test KeywordForecastMetricsServiceDateInterval
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = yahoo_search_api.models.keyword_forecast_metrics_service_date_interval.KeywordForecastMetricsServiceDateInterval()  # noqa: E501
        if include_optional :
            return KeywordForecastMetricsServiceDateInterval(
            )
        else :
            return KeywordForecastMetricsServiceDateInterval(
        )

    def testKeywordForecastMetricsServiceDateInterval(self):
        """Test KeywordForecastMetricsServiceDateInterval"""
