...
from yahoo_search_api.models.ad_group_criterion_service_bidding_keyword_cpc_range import AdGroupCriterionServiceBiddingKeywordCpcRange  # noqa: E501
from yahoo_search_api.rest import ApiException

class TestAdGroupCriterionServiceBiddingKeywordCpcRange(unittest.TestCase):
    """AdGroupCriterionServiceBiddingKeywordCpcRange unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test AdGroupCriterionServiceBiddingKeywordCpcRange
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = yahoo_search_api.models.ad_group_criterion_service_bidding_keyword_cpc_range.AdGroupCriterionServiceBiddingKeywordCpcRange()  # noqa: E501
        if include_optional :
            return AdGroupCriterionServiceBiddingKeywordCpcRange(
                min = 56, 
                max = 56
            )
        else :
    ...
    def testAdGroupCriterionServiceBiddingKeywordCpcRange(self):
        """Test AdGroupCriterionServiceBiddingKeywordCpcRange"""
