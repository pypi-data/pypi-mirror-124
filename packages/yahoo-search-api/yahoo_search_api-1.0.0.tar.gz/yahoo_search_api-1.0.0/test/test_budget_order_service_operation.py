...
from yahoo_search_api.models.budget_order_service_operation import BudgetOrderServiceOperation  # noqa: E501
...
class TestBudgetOrderServiceOperation(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_search_api.models.budget_order_service_operation.BudgetOrderServiceOperation()  # noqa: E501
        if include_optional :
            return BudgetOrderServiceOperation(
                account_id = 56, 
                operand = [
                    yahoo_search_api.models.budget_order.BudgetOrder(
                        account_id = 56, 
                        account_type = 'PREPAY', 
                        amount = 56, 
