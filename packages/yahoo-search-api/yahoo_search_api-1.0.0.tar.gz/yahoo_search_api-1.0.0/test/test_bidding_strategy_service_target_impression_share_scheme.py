...
from yahoo_search_api.models.bidding_strategy_service_target_impression_share_scheme import BiddingStrategyServiceTargetImpressionShareScheme  # noqa: E501
from yahoo_search_api.rest import ApiException

class TestBiddingStrategyServiceTargetImpressionShareScheme(unittest.TestCase):
    """BiddingStrategyServiceTargetImpressionShareScheme unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test BiddingStrategyServiceTargetImpressionShareScheme
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = yahoo_search_api.models.bidding_strategy_service_target_impression_share_scheme.BiddingStrategyServiceTargetImpressionShareScheme()  # noqa: E501
        if include_optional :
            return BiddingStrategyServiceTargetImpressionShareScheme(
    ...
    def testBiddingStrategyServiceTargetImpressionShareScheme(self):
        """Test BiddingStrategyServiceTargetImpressionShareScheme"""
