...
from yahoo_search_api.models.page_feed_item_service_upload_response import PageFeedItemServiceUploadResponse  # noqa: E501
...
class TestPageFeedItemServiceUploadResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_search_api.models.page_feed_item_service_upload_response.PageFeedItemServiceUploadResponse()  # noqa: E501
        if include_optional :
            return PageFeedItemServiceUploadResponse(
                ...
                rid = '0', 
                rval = yahoo_search_api.models.page_feed_item_service_upload_return_value.PageFeedItemServiceUploadReturnValue(
                    values = [
                        yahoo_search_api.models.page_feed_item_service_upload_value.PageFeedItemServiceUploadValue(
                            errors = [
                                yahoo_search_api.models.error.Error(
                                    code = '0', 
                                    message = '0', 
