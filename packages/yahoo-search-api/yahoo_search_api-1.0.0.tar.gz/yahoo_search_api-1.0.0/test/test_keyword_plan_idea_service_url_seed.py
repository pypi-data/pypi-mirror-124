...
from yahoo_search_api.models.keyword_plan_idea_service_url_seed import KeywordPlanIdeaServiceUrlSeed  # noqa: E501
from yahoo_search_api.rest import ApiException

class TestKeywordPlanIdeaServiceUrlSeed(unittest.TestCase):
    """KeywordPlanIdeaServiceUrlSeed unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test KeywordPlanIdeaServiceUrlSeed
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = yahoo_search_api.models.keyword_plan_idea_service_url_seed.KeywordPlanIdeaServiceUrlSeed()  # noqa: E501
        if include_optional :
            return KeywordPlanIdeaServiceUrlSeed(
                url = '0'
            )
        else :
            return KeywordPlanIdeaServiceUrlSeed(
    ...
    def testKeywordPlanIdeaServiceUrlSeed(self):
        """Test KeywordPlanIdeaServiceUrlSeed"""
