...
from yahoo_search_api.models.account_shared_service_operation import AccountSharedServiceOperation  # noqa: E501
...
class TestAccountSharedServiceOperation(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_search_api.models.account_shared_service_operation.AccountSharedServiceOperation()  # noqa: E501
        if include_optional :
            return AccountSharedServiceOperation(
                account_id = 56, 
                operand = [
                    yahoo_search_api.models.account_shared.AccountShared(
                        account_id = 56, 
                        member_count = 56, 
                        name = '0', 
                        reference_count = 56, 
