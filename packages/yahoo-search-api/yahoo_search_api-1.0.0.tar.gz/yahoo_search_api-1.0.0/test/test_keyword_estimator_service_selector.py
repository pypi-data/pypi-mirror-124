...
from yahoo_search_api.models.keyword_estimator_service_selector import KeywordEstimatorServiceSelector  # noqa: E501
...
class TestKeywordEstimatorServiceSelector(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_search_api.models.keyword_estimator_service_selector.KeywordEstimatorServiceSelector()  # noqa: E501
        if include_optional :
            return KeywordEstimatorServiceSelector(
                account_id = 56, 
                campaign_estimate_request = yahoo_search_api.models.keyword_estimator_service_campaign_estimate_request.KeywordEstimatorServiceCampaignEstimateRequest(
