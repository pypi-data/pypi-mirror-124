...
from yahoo_search_api.models.bidding_strategy_service_target_impression_share_location import BiddingStrategyServiceTargetImpressionShareLocation  # noqa: E501
from yahoo_search_api.rest import ApiException

class TestBiddingStrategyServiceTargetImpressionShareLocation(unittest.TestCase):
    """BiddingStrategyServiceTargetImpressionShareLocation unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test BiddingStrategyServiceTargetImpressionShareLocation
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = yahoo_search_api.models.bidding_strategy_service_target_impression_share_location.BiddingStrategyServiceTargetImpressionShareLocation()  # noqa: E501
        if include_optional :
            return BiddingStrategyServiceTargetImpressionShareLocation(
            )
        else :
            return BiddingStrategyServiceTargetImpressionShareLocation(
        )

    def testBiddingStrategyServiceTargetImpressionShareLocation(self):
        """Test BiddingStrategyServiceTargetImpressionShareLocation"""
