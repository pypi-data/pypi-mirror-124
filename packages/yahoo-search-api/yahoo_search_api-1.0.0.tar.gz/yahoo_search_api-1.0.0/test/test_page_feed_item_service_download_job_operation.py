...
from yahoo_search_api.models.page_feed_item_service_download_job_operation import PageFeedItemServiceDownloadJobOperation  # noqa: E501
...
class TestPageFeedItemServiceDownloadJobOperation(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_search_api.models.page_feed_item_service_download_job_operation.PageFeedItemServiceDownloadJobOperation()  # noqa: E501
        if include_optional :
            return PageFeedItemServiceDownloadJobOperation(
                account_id = 56, 
                operand = [
                    yahoo_search_api.models.page_feed_item_service_download_job.PageFeedItemServiceDownloadJob(
                        account_id = 56, 
                        bulk_encoding = 'SJIS', 
                        bulk_lang = 'JA', 
                        bulk_output = 'CSV', 
