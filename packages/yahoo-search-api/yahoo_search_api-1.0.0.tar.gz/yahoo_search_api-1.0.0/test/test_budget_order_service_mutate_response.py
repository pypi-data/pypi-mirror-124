...
from yahoo_search_api.models.budget_order_service_mutate_response import BudgetOrderServiceMutateResponse  # noqa: E501
...
class TestBudgetOrderServiceMutateResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_search_api.models.budget_order_service_mutate_response.BudgetOrderServiceMutateResponse()  # noqa: E501
        if include_optional :
            return BudgetOrderServiceMutateResponse(
                ...
                rid = '0', 
                rval = yahoo_search_api.models.budget_order_service_return_value.BudgetOrderServiceReturnValue(
                    values = [
                        yahoo_search_api.models.budget_order_service_value.BudgetOrderServiceValue(
                            budget_order = yahoo_search_api.models.budget_order.BudgetOrder(
                                account_id = 56, 
                                account_type = 'PREPAY', 
                                amount = 56, 
