...
from yahoo_search_api.models.campaign_shared_set_service_operation import CampaignSharedSetServiceOperation  # noqa: E501
...
class TestCampaignSharedSetServiceOperation(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_search_api.models.campaign_shared_set_service_operation.CampaignSharedSetServiceOperation()  # noqa: E501
        if include_optional :
            return CampaignSharedSetServiceOperation(
                account_id = 56, 
                operand = [
                    yahoo_search_api.models.campaign_shared_set.CampaignSharedSet(
                        account_id = 56, 
                        campaign_id = 56, 
                        campaign_name = '0', 
                        shared_list_id = 56, 
