...
from yahoo_search_api.models.keyword_plan_idea_service_keyword_seed import KeywordPlanIdeaServiceKeywordSeed  # noqa: E501
from yahoo_search_api.rest import ApiException

class TestKeywordPlanIdeaServiceKeywordSeed(unittest.TestCase):
    """KeywordPlanIdeaServiceKeywordSeed unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test KeywordPlanIdeaServiceKeywordSeed
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = yahoo_search_api.models.keyword_plan_idea_service_keyword_seed.KeywordPlanIdeaServiceKeywordSeed()  # noqa: E501
        if include_optional :
            return KeywordPlanIdeaServiceKeywordSeed(
                keywords = [
                    '0'
                    ]
            )
    ...
    def testKeywordPlanIdeaServiceKeywordSeed(self):
        """Test KeywordPlanIdeaServiceKeywordSeed"""
