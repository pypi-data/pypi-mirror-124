...
from yahoo_search_api.models.shared_criterion_service_operation import SharedCriterionServiceOperation  # noqa: E501
...
class TestSharedCriterionServiceOperation(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_search_api.models.shared_criterion_service_operation.SharedCriterionServiceOperation()  # noqa: E501
        if include_optional :
            return SharedCriterionServiceOperation(
                account_id = 56, 
                operand = [
                    yahoo_search_api.models.shared_criterion.SharedCriterion(
                        account_id = 56, 
                        criterion_id = 56, 
