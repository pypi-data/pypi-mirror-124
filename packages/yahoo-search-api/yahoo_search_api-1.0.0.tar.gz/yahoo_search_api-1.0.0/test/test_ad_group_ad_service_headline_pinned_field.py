...
from yahoo_search_api.models.ad_group_ad_service_headline_pinned_field import AdGroupAdServiceHeadlinePinnedField  # noqa: E501
from yahoo_search_api.rest import ApiException

class TestAdGroupAdServiceHeadlinePinnedField(unittest.TestCase):
    """AdGroupAdServiceHeadlinePinnedField unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test AdGroupAdServiceHeadlinePinnedField
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = yahoo_search_api.models.ad_group_ad_service_headline_pinned_field.AdGroupAdServiceHeadlinePinnedField()  # noqa: E501
        if include_optional :
            return AdGroupAdServiceHeadlinePinnedField(
            )
        else :
            return AdGroupAdServiceHeadlinePinnedField(
        )

    def testAdGroupAdServiceHeadlinePinnedField(self):
        """Test AdGroupAdServiceHeadlinePinnedField"""
