...
from yahoo_search_api.models.campaign_feed_service_operation import CampaignFeedServiceOperation  # noqa: E501
...
class TestCampaignFeedServiceOperation(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_search_api.models.campaign_feed_service_operation.CampaignFeedServiceOperation()  # noqa: E501
        if include_optional :
            return CampaignFeedServiceOperation(
                account_id = 56, 
                operand = [
                    yahoo_search_api.models.campaign_feed_service_list.CampaignFeedServiceList(
                        account_id = 56, 
                        campaign_feed = [
