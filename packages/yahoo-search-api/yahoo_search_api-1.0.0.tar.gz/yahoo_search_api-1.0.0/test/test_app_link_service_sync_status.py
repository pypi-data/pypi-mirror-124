...
from yahoo_search_api.models.app_link_service_sync_status import AppLinkServiceSyncStatus  # noqa: E501
from yahoo_search_api.rest import ApiException

class TestAppLinkServiceSyncStatus(unittest.TestCase):
    """AppLinkServiceSyncStatus unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test AppLinkServiceSyncStatus
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = yahoo_search_api.models.app_link_service_sync_status.AppLinkServiceSyncStatus()  # noqa: E501
        if include_optional :
            return AppLinkServiceSyncStatus(
            )
        else :
            return AppLinkServiceSyncStatus(
        )

    def testAppLinkServiceSyncStatus(self):
        """Test AppLinkServiceSyncStatus"""
