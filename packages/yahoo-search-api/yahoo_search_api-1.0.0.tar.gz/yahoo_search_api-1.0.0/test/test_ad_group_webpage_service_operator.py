...
from yahoo_search_api.models.ad_group_webpage_service_operator import AdGroupWebpageServiceOperator  # noqa: E501
from yahoo_search_api.rest import ApiException

class TestAdGroupWebpageServiceOperator(unittest.TestCase):
    """AdGroupWebpageServiceOperator unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test AdGroupWebpageServiceOperator
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = yahoo_search_api.models.ad_group_webpage_service_operator.AdGroupWebpageServiceOperator()  # noqa: E501
        if include_optional :
            return AdGroupWebpageServiceOperator(
            )
        else :
            return AdGroupWebpageServiceOperator(
        )

    def testAdGroupWebpageServiceOperator(self):
        """Test AdGroupWebpageServiceOperator"""
