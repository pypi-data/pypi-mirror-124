...
from yahoo_search_api.models.campaign_service_selector import CampaignServiceSelector  # noqa: E501
...
class TestCampaignServiceSelector(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_search_api.models.campaign_service_selector.CampaignServiceSelector()  # noqa: E501
        if include_optional :
            return CampaignServiceSelector(
                ...
                created_date_range = yahoo_search_api.models.campaign_service_created_date_range.CampaignServiceCreatedDateRange(
                    start_date = '0', 
                    end_date = '0', ), 
                budget_amount_range = yahoo_search_api.models.campaign_service_budget_amount_range.CampaignServiceBudgetAmountRange(
                    min = 56, 
                    max = 56, )
            )
        else :
