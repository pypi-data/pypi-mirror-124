...
from yahoo_search_api.models.keyword_plan_idea_service_site_seed import KeywordPlanIdeaServiceSiteSeed  # noqa: E501
from yahoo_search_api.rest import ApiException

class TestKeywordPlanIdeaServiceSiteSeed(unittest.TestCase):
    """KeywordPlanIdeaServiceSiteSeed unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test KeywordPlanIdeaServiceSiteSeed
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = yahoo_search_api.models.keyword_plan_idea_service_site_seed.KeywordPlanIdeaServiceSiteSeed()  # noqa: E501
        if include_optional :
            return KeywordPlanIdeaServiceSiteSeed(
                site = '0'
            )
        else :
            return KeywordPlanIdeaServiceSiteSeed(
    ...
    def testKeywordPlanIdeaServiceSiteSeed(self):
        """Test KeywordPlanIdeaServiceSiteSeed"""
