...
from yahoo_search_api.models.ad_group_ad_service_description_pinned_field import AdGroupAdServiceDescriptionPinnedField  # noqa: E501
from yahoo_search_api.rest import ApiException

class TestAdGroupAdServiceDescriptionPinnedField(unittest.TestCase):
    """AdGroupAdServiceDescriptionPinnedField unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test AdGroupAdServiceDescriptionPinnedField
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = yahoo_search_api.models.ad_group_ad_service_description_pinned_field.AdGroupAdServiceDescriptionPinnedField()  # noqa: E501
        if include_optional :
            return AdGroupAdServiceDescriptionPinnedField(
            )
        else :
            return AdGroupAdServiceDescriptionPinnedField(
        )

    def testAdGroupAdServiceDescriptionPinnedField(self):
        """Test AdGroupAdServiceDescriptionPinnedField"""
