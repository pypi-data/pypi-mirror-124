...
from yahoo_search_api.models.ad_group_service_bidding_keyword_cpc_range import AdGroupServiceBiddingKeywordCpcRange  # noqa: E501
from yahoo_search_api.rest import ApiException

class TestAdGroupServiceBiddingKeywordCpcRange(unittest.TestCase):
    """AdGroupServiceBiddingKeywordCpcRange unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test AdGroupServiceBiddingKeywordCpcRange
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = yahoo_search_api.models.ad_group_service_bidding_keyword_cpc_range.AdGroupServiceBiddingKeywordCpcRange()  # noqa: E501
        if include_optional :
            return AdGroupServiceBiddingKeywordCpcRange(
                min = 56, 
                max = 56
            )
        else :
    ...
    def testAdGroupServiceBiddingKeywordCpcRange(self):
        """Test AdGroupServiceBiddingKeywordCpcRange"""
