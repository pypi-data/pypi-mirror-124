...
from yahoo_search_api.models.campaign_service_maximize_conversion_value_bidding_scheme import CampaignServiceMaximizeConversionValueBiddingScheme  # noqa: E501
from yahoo_search_api.rest import ApiException

class TestCampaignServiceMaximizeConversionValueBiddingScheme(unittest.TestCase):
    """CampaignServiceMaximizeConversionValueBiddingScheme unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test CampaignServiceMaximizeConversionValueBiddingScheme
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = yahoo_search_api.models.campaign_service_maximize_conversion_value_bidding_scheme.CampaignServiceMaximizeConversionValueBiddingScheme()  # noqa: E501
        if include_optional :
            return CampaignServiceMaximizeConversionValueBiddingScheme(
                target_roas = 1.337
            )
        else :
            return CampaignServiceMaximizeConversionValueBiddingScheme(
    ...
    def testCampaignServiceMaximizeConversionValueBiddingScheme(self):
        """Test CampaignServiceMaximizeConversionValueBiddingScheme"""
