...
from yahoo_search_api.models.feed_item_service_set_trademark_status_operation import FeedItemServiceSetTrademarkStatusOperation  # noqa: E501
...
class TestFeedItemServiceSetTrademarkStatusOperation(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_search_api.models.feed_item_service_set_trademark_status_operation.FeedItemServiceSetTrademarkStatusOperation()  # noqa: E501
        if include_optional :
            return FeedItemServiceSetTrademarkStatusOperation(
                account_id = 56, 
                operand = [
                    yahoo_search_api.models.feed_item_service_set_trademark_status.FeedItemServiceSetTrademarkStatus(
                        feed_item_id = 56, )
                    ], 
