...
from yahoo_search_api.models.campaign_service_das_use_urls_type import CampaignServiceDasUseUrlsType  # noqa: E501
from yahoo_search_api.rest import ApiException

class TestCampaignServiceDasUseUrlsType(unittest.TestCase):
    """CampaignServiceDasUseUrlsType unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test CampaignServiceDasUseUrlsType
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = yahoo_search_api.models.campaign_service_das_use_urls_type.CampaignServiceDasUseUrlsType()  # noqa: E501
        if include_optional :
            return CampaignServiceDasUseUrlsType(
            )
        else :
            return CampaignServiceDasUseUrlsType(
        )

    def testCampaignServiceDasUseUrlsType(self):
        """Test CampaignServiceDasUseUrlsType"""
