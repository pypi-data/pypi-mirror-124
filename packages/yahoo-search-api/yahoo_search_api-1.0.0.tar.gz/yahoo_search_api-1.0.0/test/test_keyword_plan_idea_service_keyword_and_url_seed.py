...
from yahoo_search_api.models.keyword_plan_idea_service_keyword_and_url_seed import KeywordPlanIdeaServiceKeywordAndUrlSeed  # noqa: E501
from yahoo_search_api.rest import ApiException

class TestKeywordPlanIdeaServiceKeywordAndUrlSeed(unittest.TestCase):
    """KeywordPlanIdeaServiceKeywordAndUrlSeed unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test KeywordPlanIdeaServiceKeywordAndUrlSeed
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = yahoo_search_api.models.keyword_plan_idea_service_keyword_and_url_seed.KeywordPlanIdeaServiceKeywordAndUrlSeed()  # noqa: E501
        if include_optional :
            return KeywordPlanIdeaServiceKeywordAndUrlSeed(
                keywords = [
                    '0'
                    ], 
                url = '0'
    ...
    def testKeywordPlanIdeaServiceKeywordAndUrlSeed(self):
        """Test KeywordPlanIdeaServiceKeywordAndUrlSeed"""
