...
from yahoo_search_api.models.balance_service_get_response import BalanceServiceGetResponse  # noqa: E501
...
class TestBalanceServiceGetResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_search_api.models.balance_service_get_response.BalanceServiceGetResponse()  # noqa: E501
        if include_optional :
            return BalanceServiceGetResponse(
                ...
                rid = '0', 
                rval = yahoo_search_api.models.balance_service_page.BalanceServicePage(
                    total_num_entries = 56, 
                    values = [
                        yahoo_search_api.models.balance_service_value.BalanceServiceValue(
