...
from yahoo_search_api.models.keyword_forecast_metrics_service_keyword_plan_network import KeywordForecastMetricsServiceKeywordPlanNetwork  # noqa: E501
from yahoo_search_api.rest import ApiException

class TestKeywordForecastMetricsServiceKeywordPlanNetwork(unittest.TestCase):
    """KeywordForecastMetricsServiceKeywordPlanNetwork unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test KeywordForecastMetricsServiceKeywordPlanNetwork
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = yahoo_search_api.models.keyword_forecast_metrics_service_keyword_plan_network.KeywordForecastMetricsServiceKeywordPlanNetwork()  # noqa: E501
        if include_optional :
            return KeywordForecastMetricsServiceKeywordPlanNetwork(
            )
        else :
            return KeywordForecastMetricsServiceKeywordPlanNetwork(
        )

    def testKeywordForecastMetricsServiceKeywordPlanNetwork(self):
        """Test KeywordForecastMetricsServiceKeywordPlanNetwork"""
