...
from yahoo_search_api.models.retargeting_list_service_operation import RetargetingListServiceOperation  # noqa: E501
...
class TestRetargetingListServiceOperation(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_search_api.models.retargeting_list_service_operation.RetargetingListServiceOperation()  # noqa: E501
        if include_optional :
            return RetargetingListServiceOperation(
                account_id = 56, 
                operand = [
                    yahoo_search_api.models.retargeting_list_service_targeting_list.RetargetingListServiceTargetingList(
                        account_id = 56, 
