...
from yahoo_search_api.models.account_tracking_url_service_page import AccountTrackingUrlServicePage  # noqa: E501
...
class TestAccountTrackingUrlServicePage(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_search_api.models.account_tracking_url_service_page.AccountTrackingUrlServicePage()  # noqa: E501
        if include_optional :
            return AccountTrackingUrlServicePage(
                total_num_entries = 56, 
                values = [
                    yahoo_search_api.models.account_tracking_url_service_value.AccountTrackingUrlServiceValue(
                        account_tracking_url = yahoo_search_api.models.account_tracking_url.AccountTrackingUrl(
                            account_id = 56, 
                            account_name = '0', 
