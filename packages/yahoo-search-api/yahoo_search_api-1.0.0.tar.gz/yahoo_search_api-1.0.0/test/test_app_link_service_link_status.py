...
from yahoo_search_api.models.app_link_service_link_status import AppLinkServiceLinkStatus  # noqa: E501
from yahoo_search_api.rest import ApiException

class TestAppLinkServiceLinkStatus(unittest.TestCase):
    """AppLinkServiceLinkStatus unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test AppLinkServiceLinkStatus
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = yahoo_search_api.models.app_link_service_link_status.AppLinkServiceLinkStatus()  # noqa: E501
        if include_optional :
            return AppLinkServiceLinkStatus(
            )
        else :
            return AppLinkServiceLinkStatus(
        )

    def testAppLinkServiceLinkStatus(self):
        """Test AppLinkServiceLinkStatus"""
