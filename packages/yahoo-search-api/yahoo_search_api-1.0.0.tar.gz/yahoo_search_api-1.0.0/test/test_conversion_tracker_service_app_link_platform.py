...
from yahoo_search_api.models.conversion_tracker_service_app_link_platform import ConversionTrackerServiceAppLinkPlatform  # noqa: E501
from yahoo_search_api.rest import ApiException

class TestConversionTrackerServiceAppLinkPlatform(unittest.TestCase):
    """ConversionTrackerServiceAppLinkPlatform unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test ConversionTrackerServiceAppLinkPlatform
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = yahoo_search_api.models.conversion_tracker_service_app_link_platform.ConversionTrackerServiceAppLinkPlatform()  # noqa: E501
        if include_optional :
            return ConversionTrackerServiceAppLinkPlatform(
            )
        else :
            return ConversionTrackerServiceAppLinkPlatform(
        )

    def testConversionTrackerServiceAppLinkPlatform(self):
        """Test ConversionTrackerServiceAppLinkPlatform"""
