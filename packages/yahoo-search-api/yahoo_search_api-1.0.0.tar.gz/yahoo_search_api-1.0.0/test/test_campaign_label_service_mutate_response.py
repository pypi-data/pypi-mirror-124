...
from yahoo_search_api.models.campaign_label_service_mutate_response import CampaignLabelServiceMutateResponse  # noqa: E501
...
class TestCampaignLabelServiceMutateResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_search_api.models.campaign_label_service_mutate_response.CampaignLabelServiceMutateResponse()  # noqa: E501
        if include_optional :
            return CampaignLabelServiceMutateResponse(
                ...
                rid = '0', 
                rval = yahoo_search_api.models.campaign_label_service_return_value.CampaignLabelServiceReturnValue(
                    values = [
                        yahoo_search_api.models.campaign_label_service_value.CampaignLabelServiceValue(
                            campaign_label = yahoo_search_api.models.campaign_label.CampaignLabel(
                                account_id = 56, 
                                campaign_id = 56, 
                                label_id = 56, ), 
                            errors = [
