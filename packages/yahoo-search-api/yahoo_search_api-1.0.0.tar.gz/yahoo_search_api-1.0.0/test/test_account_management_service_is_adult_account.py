...
from yahoo_search_api.models.account_management_service_is_adult_account import AccountManagementServiceIsAdultAccount  # noqa: E501
from yahoo_search_api.rest import ApiException

class TestAccountManagementServiceIsAdultAccount(unittest.TestCase):
    """AccountManagementServiceIsAdultAccount unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test AccountManagementServiceIsAdultAccount
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = yahoo_search_api.models.account_management_service_is_adult_account.AccountManagementServiceIsAdultAccount()  # noqa: E501
        if include_optional :
            return AccountManagementServiceIsAdultAccount(
            )
        else :
            return AccountManagementServiceIsAdultAccount(
        )

    def testAccountManagementServiceIsAdultAccount(self):
        """Test AccountManagementServiceIsAdultAccount"""
