...
from yahoo_search_api.models.conversion_tracker_service_app_event_type_selector import ConversionTrackerServiceAppEventTypeSelector  # noqa: E501
from yahoo_search_api.rest import ApiException

class TestConversionTrackerServiceAppEventTypeSelector(unittest.TestCase):
    """ConversionTrackerServiceAppEventTypeSelector unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test ConversionTrackerServiceAppEventTypeSelector
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = yahoo_search_api.models.conversion_tracker_service_app_event_type_selector.ConversionTrackerServiceAppEventTypeSelector()  # noqa: E501
        if include_optional :
            return ConversionTrackerServiceAppEventTypeSelector(
                account_id = 56, 
                number_results = 1, 
                start_index = 1
            )
    ...
    def testConversionTrackerServiceAppEventTypeSelector(self):
        """Test ConversionTrackerServiceAppEventTypeSelector"""
