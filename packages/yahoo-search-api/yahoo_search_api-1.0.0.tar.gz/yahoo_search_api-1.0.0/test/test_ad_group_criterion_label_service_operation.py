...
from yahoo_search_api.models.ad_group_criterion_label_service_operation import AdGroupCriterionLabelServiceOperation  # noqa: E501
...
class TestAdGroupCriterionLabelServiceOperation(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_search_api.models.ad_group_criterion_label_service_operation.AdGroupCriterionLabelServiceOperation()  # noqa: E501
        if include_optional :
            return AdGroupCriterionLabelServiceOperation(
                account_id = 56, 
                operand = [
                    yahoo_search_api.models.ad_group_criterion_label.AdGroupCriterionLabel(
                        account_id = 56, 
                        ad_group_id = 56, 
                        campaign_id = 56, 
                        criterion_id = 56, 
