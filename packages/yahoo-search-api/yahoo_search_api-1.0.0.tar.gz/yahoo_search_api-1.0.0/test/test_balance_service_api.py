...
from yahoo_search_api.api.balance_service_api import BalanceServiceApi  # noqa: E501
...
class TestBalanceServiceApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = yahoo_search_api.api.balance_service_api.BalanceServiceApi()  # noqa: E501
