...
from yahoo_search_api.models.ad_group_ad_service_text_asset_approval_status import AdGroupAdServiceTextAssetApprovalStatus  # noqa: E501
from yahoo_search_api.rest import ApiException

class TestAdGroupAdServiceTextAssetApprovalStatus(unittest.TestCase):
    """AdGroupAdServiceTextAssetApprovalStatus unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test AdGroupAdServiceTextAssetApprovalStatus
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = yahoo_search_api.models.ad_group_ad_service_text_asset_approval_status.AdGroupAdServiceTextAssetApprovalStatus()  # noqa: E501
        if include_optional :
            return AdGroupAdServiceTextAssetApprovalStatus(
            )
        else :
            return AdGroupAdServiceTextAssetApprovalStatus(
        )

    def testAdGroupAdServiceTextAssetApprovalStatus(self):
        """Test AdGroupAdServiceTextAssetApprovalStatus"""
