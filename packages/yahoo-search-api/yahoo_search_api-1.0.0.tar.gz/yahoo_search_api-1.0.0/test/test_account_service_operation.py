...
from yahoo_search_api.models.account_service_operation import AccountServiceOperation  # noqa: E501
...
class TestAccountServiceOperation(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_search_api.models.account_service_operation.AccountServiceOperation()  # noqa: E501
        if include_optional :
            return AccountServiceOperation(
                account_id = 56, 
                operand = [
                    yahoo_search_api.models.account.Account(
                        account_id = 56, 
                        account_name = '0', 
