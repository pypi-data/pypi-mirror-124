...
from yahoo_search_api.models.ad_group_webpage_service_operation import AdGroupWebpageServiceOperation  # noqa: E501
...
class TestAdGroupWebpageServiceOperation(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_search_api.models.ad_group_webpage_service_operation.AdGroupWebpageServiceOperation()  # noqa: E501
        if include_optional :
            return AdGroupWebpageServiceOperation(
                account_id = 56, 
                operand = [
                    yahoo_search_api.models.ad_group_webpage.AdGroupWebpage(
                        account_id = 56, 
                        ad_group_id = 56, 
