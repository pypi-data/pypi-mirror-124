...
from yahoo_search_api.models.ad_group_service_selector import AdGroupServiceSelector  # noqa: E501
...
class TestAdGroupServiceSelector(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_search_api.models.ad_group_service_selector.AdGroupServiceSelector()  # noqa: E501
        if include_optional :
            return AdGroupServiceSelector(
                ...
                created_date_range = yahoo_search_api.models.ad_group_service_created_date_range.AdGroupServiceCreatedDateRange(
                    start_date = '0', 
                    end_date = '0', ), 
                bidding_keyword_cpc_range = yahoo_search_api.models.ad_group_service_bidding_keyword_cpc_range.AdGroupServiceBiddingKeywordCpcRange(
                    min = 56, 
                    max = 56, )
            )
        else :
