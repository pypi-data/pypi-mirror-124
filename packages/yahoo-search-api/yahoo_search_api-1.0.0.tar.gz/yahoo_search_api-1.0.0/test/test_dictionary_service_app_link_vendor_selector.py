...
from yahoo_search_api.models.dictionary_service_app_link_vendor_selector import DictionaryServiceAppLinkVendorSelector  # noqa: E501
from yahoo_search_api.rest import ApiException

class TestDictionaryServiceAppLinkVendorSelector(unittest.TestCase):
    """DictionaryServiceAppLinkVendorSelector unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test DictionaryServiceAppLinkVendorSelector
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = yahoo_search_api.models.dictionary_service_app_link_vendor_selector.DictionaryServiceAppLinkVendorSelector()  # noqa: E501
        if include_optional :
            return DictionaryServiceAppLinkVendorSelector(
                start_index = 1, 
                number_results = 1
            )
        else :
    ...
    def testDictionaryServiceAppLinkVendorSelector(self):
        """Test DictionaryServiceAppLinkVendorSelector"""
