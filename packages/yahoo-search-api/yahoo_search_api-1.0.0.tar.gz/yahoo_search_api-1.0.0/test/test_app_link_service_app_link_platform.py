...
from yahoo_search_api.models.app_link_service_app_link_platform import AppLinkServiceAppLinkPlatform  # noqa: E501
from yahoo_search_api.rest import ApiException

class TestAppLinkServiceAppLinkPlatform(unittest.TestCase):
    """AppLinkServiceAppLinkPlatform unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test AppLinkServiceAppLinkPlatform
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = yahoo_search_api.models.app_link_service_app_link_platform.AppLinkServiceAppLinkPlatform()  # noqa: E501
        if include_optional :
            return AppLinkServiceAppLinkPlatform(
            )
        else :
            return AppLinkServiceAppLinkPlatform(
        )

    def testAppLinkServiceAppLinkPlatform(self):
        """Test AppLinkServiceAppLinkPlatform"""
