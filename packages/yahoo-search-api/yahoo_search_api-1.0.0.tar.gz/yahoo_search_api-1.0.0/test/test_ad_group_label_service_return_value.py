...
from yahoo_search_api.models.ad_group_label_service_return_value import AdGroupLabelServiceReturnValue  # noqa: E501
...
class TestAdGroupLabelServiceReturnValue(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_search_api.models.ad_group_label_service_return_value.AdGroupLabelServiceReturnValue()  # noqa: E501
        if include_optional :
            return AdGroupLabelServiceReturnValue(
                values = [
                    yahoo_search_api.models.ad_group_label_service_value.AdGroupLabelServiceValue(
                        ad_group_label = yahoo_search_api.models.ad_group_label.AdGroupLabel(
                            account_id = 56, 
                            ad_group_id = 56, 
                            campaign_id = 56, 
                            label_id = 56, ), 
