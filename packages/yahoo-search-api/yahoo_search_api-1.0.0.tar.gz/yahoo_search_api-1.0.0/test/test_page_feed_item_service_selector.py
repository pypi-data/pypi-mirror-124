...
from yahoo_search_api.models.page_feed_item_service_selector import PageFeedItemServiceSelector  # noqa: E501
...
class TestPageFeedItemServiceSelector(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_search_api.models.page_feed_item_service_selector.PageFeedItemServiceSelector()  # noqa: E501
        if include_optional :
            return PageFeedItemServiceSelector(
                ...
                page_feed_url = [
                    yahoo_search_api.models.page_feed_item_service_page_feed_url.PageFeedItemServicePageFeedUrl(
                        match_type = 'EXACT', 
                        text = '0', )
                    ], 
                start_index = 1
