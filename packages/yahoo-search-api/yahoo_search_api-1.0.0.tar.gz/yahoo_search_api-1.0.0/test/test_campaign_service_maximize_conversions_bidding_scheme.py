...
from yahoo_search_api.models.campaign_service_maximize_conversions_bidding_scheme import CampaignServiceMaximizeConversionsBiddingScheme  # noqa: E501
from yahoo_search_api.rest import ApiException

class TestCampaignServiceMaximizeConversionsBiddingScheme(unittest.TestCase):
    """CampaignServiceMaximizeConversionsBiddingScheme unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test CampaignServiceMaximizeConversionsBiddingScheme
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = yahoo_search_api.models.campaign_service_maximize_conversions_bidding_scheme.CampaignServiceMaximizeConversionsBiddingScheme()  # noqa: E501
        if include_optional :
            return CampaignServiceMaximizeConversionsBiddingScheme(
                target_cpa = 56
            )
        else :
            return CampaignServiceMaximizeConversionsBiddingScheme(
    ...
    def testCampaignServiceMaximizeConversionsBiddingScheme(self):
        """Test CampaignServiceMaximizeConversionsBiddingScheme"""
