...
from yahoo_search_api.models.keyword_forecast_metrics_service_match_type import KeywordForecastMetricsServiceMatchType  # noqa: E501
from yahoo_search_api.rest import ApiException

class TestKeywordForecastMetricsServiceMatchType(unittest.TestCase):
    """KeywordForecastMetricsServiceMatchType unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test KeywordForecastMetricsServiceMatchType
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = yahoo_search_api.models.keyword_forecast_metrics_service_match_type.KeywordForecastMetricsServiceMatchType()  # noqa: E501
        if include_optional :
            return KeywordForecastMetricsServiceMatchType(
            )
        else :
            return KeywordForecastMetricsServiceMatchType(
        )

    def testKeywordForecastMetricsServiceMatchType(self):
        """Test KeywordForecastMetricsServiceMatchType"""
