...
from yahoo_search_api.models.ad_group_ad_label_service_operation import AdGroupAdLabelServiceOperation  # noqa: E501
...
class TestAdGroupAdLabelServiceOperation(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_search_api.models.ad_group_ad_label_service_operation.AdGroupAdLabelServiceOperation()  # noqa: E501
        if include_optional :
            return AdGroupAdLabelServiceOperation(
                account_id = 56, 
                operand = [
                    yahoo_search_api.models.ad_group_ad_label.AdGroupAdLabel(
                        account_id = 56, 
                        ad_group_id = 56, 
                        ad_id = 56, 
                        campaign_id = 56, 
