...
from yahoo_search_api.models.keyword_plan_idea_service_seed_type import KeywordPlanIdeaServiceSeedType  # noqa: E501
from yahoo_search_api.rest import ApiException

class TestKeywordPlanIdeaServiceSeedType(unittest.TestCase):
    """KeywordPlanIdeaServiceSeedType unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test KeywordPlanIdeaServiceSeedType
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = yahoo_search_api.models.keyword_plan_idea_service_seed_type.KeywordPlanIdeaServiceSeedType()  # noqa: E501
        if include_optional :
            return KeywordPlanIdeaServiceSeedType(
            )
        else :
            return KeywordPlanIdeaServiceSeedType(
        )

    def testKeywordPlanIdeaServiceSeedType(self):
        """Test KeywordPlanIdeaServiceSeedType"""
