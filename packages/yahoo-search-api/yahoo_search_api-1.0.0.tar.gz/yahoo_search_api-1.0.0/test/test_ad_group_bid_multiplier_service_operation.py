...
from yahoo_search_api.models.ad_group_bid_multiplier_service_operation import AdGroupBidMultiplierServiceOperation  # noqa: E501
...
class TestAdGroupBidMultiplierServiceOperation(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_search_api.models.ad_group_bid_multiplier_service_operation.AdGroupBidMultiplierServiceOperation()  # noqa: E501
        if include_optional :
            return AdGroupBidMultiplierServiceOperation(
                account_id = 56, 
                operand = [
                    yahoo_search_api.models.ad_group_bid_multiplier.AdGroupBidMultiplier(
                        account_id = 56, 
                        ad_group_id = 56, 
