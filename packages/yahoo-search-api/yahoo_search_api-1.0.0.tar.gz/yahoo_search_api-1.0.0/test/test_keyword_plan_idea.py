...
from yahoo_search_api.models.keyword_plan_idea import KeywordPlanIdea  # noqa: E501
from yahoo_search_api.rest import ApiException

class TestKeywordPlanIdea(unittest.TestCase):
    """KeywordPlanIdea unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test KeywordPlanIdea
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = yahoo_search_api.models.keyword_plan_idea.KeywordPlanIdea()  # noqa: E501
        if include_optional :
