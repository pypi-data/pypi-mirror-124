...
from yahoo_search_api.models.campaign_service_target_impression_share_location import CampaignServiceTargetImpressionShareLocation  # noqa: E501
from yahoo_search_api.rest import ApiException

class TestCampaignServiceTargetImpressionShareLocation(unittest.TestCase):
    """CampaignServiceTargetImpressionShareLocation unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test CampaignServiceTargetImpressionShareLocation
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = yahoo_search_api.models.campaign_service_target_impression_share_location.CampaignServiceTargetImpressionShareLocation()  # noqa: E501
        if include_optional :
            return CampaignServiceTargetImpressionShareLocation(
            )
        else :
            return CampaignServiceTargetImpressionShareLocation(
        )

    def testCampaignServiceTargetImpressionShareLocation(self):
        """Test CampaignServiceTargetImpressionShareLocation"""
