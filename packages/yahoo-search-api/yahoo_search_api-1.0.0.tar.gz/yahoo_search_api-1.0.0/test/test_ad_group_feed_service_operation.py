...
from yahoo_search_api.models.ad_group_feed_service_operation import AdGroupFeedServiceOperation  # noqa: E501
...
class TestAdGroupFeedServiceOperation(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_search_api.models.ad_group_feed_service_operation.AdGroupFeedServiceOperation()  # noqa: E501
        if include_optional :
            return AdGroupFeedServiceOperation(
                account_id = 56, 
                operand = [
                    yahoo_search_api.models.ad_group_feed_service_list.AdGroupFeedServiceList(
                        account_id = 56, 
                        ad_group_feed = [
