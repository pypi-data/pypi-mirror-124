...
from yahoo_search_api.models.account_tracking_url_service_operation import AccountTrackingUrlServiceOperation  # noqa: E501
...
class TestAccountTrackingUrlServiceOperation(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_search_api.models.account_tracking_url_service_operation.AccountTrackingUrlServiceOperation()  # noqa: E501
        if include_optional :
            return AccountTrackingUrlServiceOperation(
                account_id = 56, 
                operand = [
                    yahoo_search_api.models.account_tracking_url.AccountTrackingUrl(
                        account_id = 56, 
                        account_name = '0', 
