...
from yahoo_search_api.models.ad_group_ad_service_operation import AdGroupAdServiceOperation  # noqa: E501
...
class TestAdGroupAdServiceOperation(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_search_api.models.ad_group_ad_service_operation.AdGroupAdServiceOperation()  # noqa: E501
        if include_optional :
            return AdGroupAdServiceOperation(
                account_id = 56, 
                operand = [
                    yahoo_search_api.models.ad_group_ad.AdGroupAd(
                        account_id = 56, 
