...
from yahoo_search_api.models.campaign_webpage_service_webpage_operator import CampaignWebpageServiceWebpageOperator  # noqa: E501
from yahoo_search_api.rest import ApiException

class TestCampaignWebpageServiceWebpageOperator(unittest.TestCase):
    """CampaignWebpageServiceWebpageOperator unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test CampaignWebpageServiceWebpageOperator
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = yahoo_search_api.models.campaign_webpage_service_webpage_operator.CampaignWebpageServiceWebpageOperator()  # noqa: E501
        if include_optional :
            return CampaignWebpageServiceWebpageOperator(
            )
        else :
            return CampaignWebpageServiceWebpageOperator(
        )

    def testCampaignWebpageServiceWebpageOperator(self):
        """Test CampaignWebpageServiceWebpageOperator"""
