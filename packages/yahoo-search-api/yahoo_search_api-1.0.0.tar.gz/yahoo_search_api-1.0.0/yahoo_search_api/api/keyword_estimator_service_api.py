...
class KeywordEstimatorServiceApi(object):
    ...
    def keyword_estimator_service_get_post(self, **kwargs):  # noqa: E501
        ...
        <div lang=\"ja\">獲得できるトラフィックの見積を取得します。<br> (deprecated) このAPIは将来のバージョンで削除予定です。このAPIの代わりにKeywordForecastMetricsServiceを使用してください。</div> <div lang=\"en\">Get traffic estimate.<br> (deprecated) This API is deprecated in the futere version. Use KeywordForecastMetricsService instead of this.</div>   # noqa: E501
