...
class ReportDefinitionServiceReportDateRangeType(object):
    ...
    allowable_values = [TODAY, YESTERDAY, LAST_7_DAYS, LAST_WEEK, LAST_14_DAYS, LAST_30_DAYS, LAST_BUSINESS_WEEK, THIS_MONTH, LAST_MONTH, ALL_TIME, CUSTOM_DATE, NO_RANGE, UNKNOWN]  # noqa: E501
