...
class ReportDefinitionServiceReportType(object):
    ...
    allowable_values = [ACCOUNT, CAMPAIGN, ADGROUP, AD, KEYWORDS, SEARCH_QUERY, GEO, FEED_ITEM, GEO_TARGET, SCHEDULE_TARGET, BID_STRATEGY, CAMPAIGN_TARGET_LIST, ADGROUP_TARGET_LIST, LANDING_PAGE_URL, KEYWORDLESS_QUERY, WEBPAGE_CRITERION, BID_MODIFIER, CAMPAIGN_ASSET, ADGROUP_ASSET, UNKNOWN]  # noqa: E501
