...
class AdGroupAdServiceAd(object):
    ...
    def __init__(self, ad_type=None, additional_advanced_mobile_urls=None, additional_advanced_urls=None, advanced_mobile_url=None, advanced_url=None, app_ad=None, custom_parameters=None, description1=None, device_preference=None, display_url=None, extended_text_ad=None, responsive_search_ad=None, headline1=None, text_ad2=None, dynamic_search_linked_ad=None, tracking_url=None, url=None, local_vars_configuration=None):  # noqa: E501
    ...
    def advanced_mobile_url(self):
        ...
        <div lang=\"ja\">スマートフォン向けURLです。<br> ADD時、このフィールドは省略可能となります。※adTypeがDYNAMIC_SEARCH_LINKED_ADの場合は無視されます。</div> <div lang=\"en\">Smartphone final URL.<br> This field is optional in ADD operation. *If adType is DYNAMIC_SEARCH_LINKED_AD, this field will be ignored.</div>   # noqa: E501
    ...
    def advanced_url(self):
        ...
        <div lang=\"ja\">最終リンク先URLです。<br> ADD時、このフィールドは必須となります。※adTypeがDYNAMIC_SEARCH_LINKED_ADの場合は無視されます。</div> <div lang=\"en\">Final URL.<br> This field is required in ADD operation. *If adType is DYNAMIC_SEARCH_LINKED_AD, this field will be ignored.</div>   # noqa: E501
    ...
    def description1(self):
        """Gets the description1 of this AdGroupAdServiceAd.  # noqa: E501

        <div lang=\"ja\">説明文です。<br> ADD時、このフィールドは必須となります。※adTypeがRESPONSIVE_SEARCH_ADの場合は無視されます。</div> <div lang=\"en\">Description of ad.<br> This field is required in ADD operation. *If adType is RESPONSIVE_SEARCH_AD, this field will be ignored.</div>   # noqa: E501

        :return: The description1 of this AdGroupAdServiceAd.  # noqa: E501
        :rtype: str
        """
    ...
    def description1(self, description1):
        """Sets the description1 of this AdGroupAdServiceAd.

        <div lang=\"ja\">説明文です。<br> ADD時、このフィールドは必須となります。※adTypeがRESPONSIVE_SEARCH_ADの場合は無視されます。</div> <div lang=\"en\">Description of ad.<br> This field is required in ADD operation. *If adType is RESPONSIVE_SEARCH_AD, this field will be ignored.</div>   # noqa: E501

        :param description1: The description1 of this AdGroupAdServiceAd.  # noqa: E501
        :type: str
        """
    ...
    @property
    def headline1(self):
        """Gets the headline1 of this AdGroupAdServiceAd.  # noqa: E501

        <div lang=\"ja\">タイトル文です。<br> ADD時、このフィールドは必須となります。※adTypeがDYNAMIC_SEARCH_LINKED_AD、またはRESPONSIVE_SEARCH_ADの場合は無視されます。</div> <div lang=\"en\">Title of ad.<br> This field is required in ADD operation. *If adType is DYNAMIC_SEARCH_LINKED_AD or RESPONSIVE_SEARCH_AD, this field will be ignored.</div>   # noqa: E501

        :return: The headline1 of this AdGroupAdServiceAd.  # noqa: E501
        :rtype: str
        """
        return self._headline1

    @headline1.setter
    def headline1(self, headline1):
        """Sets the headline1 of this AdGroupAdServiceAd.

        <div lang=\"ja\">タイトル文です。<br> ADD時、このフィールドは必須となります。※adTypeがDYNAMIC_SEARCH_LINKED_AD、またはRESPONSIVE_SEARCH_ADの場合は無視されます。</div> <div lang=\"en\">Title of ad.<br> This field is required in ADD operation. *If adType is DYNAMIC_SEARCH_LINKED_AD or RESPONSIVE_SEARCH_AD, this field will be ignored.</div>   # noqa: E501

        :param headline1: The headline1 of this AdGroupAdServiceAd.  # noqa: E501
        :type: str
        """

        self._headline1 = headline1
