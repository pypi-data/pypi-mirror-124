...
class BiddingStrategyServiceBiddingScheme(object):
    ...
    def __init__(self, target_cpa_bidding_scheme=None, target_roas_bidding_scheme=None, target_spend_bidding_scheme=None, target_impression_share_scheme=None, type=None, local_vars_configuration=None):  # noqa: E501
