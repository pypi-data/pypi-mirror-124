...
class CampaignServiceBiddingStrategyType(object):
    ...
    allowable_values = [MANUAL_CPC, TARGET_ROAS, TARGET_SPEND, TARGET_CPA, MAXIMIZE_CONVERSIONS, MAXIMIZE_CONVERSION_VALUE, TARGET_IMPRESSION_SHARE, UNKNOWN]  # noqa: E501
