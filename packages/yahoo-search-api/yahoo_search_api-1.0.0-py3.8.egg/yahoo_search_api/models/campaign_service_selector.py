...
class CampaignServiceSelector(object):
    ...
    def __init__(self, account_id=None, bidding_strategy_ids=None, campaign_ids=None, contains_label_id=None, label_ids=None, number_results=500, start_index=1, user_statuses=None, created_date_range=None, budget_amount_range=None, local_vars_configuration=None):  # noqa: E501
