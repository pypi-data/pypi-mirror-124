...
class AccountServiceIncludeManagerAccount(object):
    ...
    allowable_values = [ONLY_MANAGER, EXCLUDE_MANAGER, ALL, UNKNOWN]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """AccountServiceIncludeManagerAccount - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AccountServiceIncludeManagerAccount):
            return False
