...
class AccountManagement(object):
    ...
    def __init__(self, account_id=None, account_name=None, account_payment=None, agency_person_name=None, agency_prefecture_code=None, auth_type=None, auto_tagging_enabled=None, client=None, client_type=None, contact_biz_id=None, delivery_status=None, is_adult_account=None, is_test_account=None, status=None, local_vars_configuration=None):  # noqa: E501
