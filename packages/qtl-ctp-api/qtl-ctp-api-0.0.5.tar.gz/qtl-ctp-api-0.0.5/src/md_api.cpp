...
void MdApi::OnRtnDepthMarketData(CThostFtdcDepthMarketDataField *data) {
    ...
    queue_->dispatch([&]() {
        ...
        if (has_data) {
            ...
            py_data["LastPrice"] = rsp_data.LastPrice;
            py_data["PreSettlementPrice"] = rsp_data.PreSettlementPrice;
            py_data["PreClosePrice"] = rsp_data.PreClosePrice;
            py_data["PreOpenInterest"] = rsp_data.PreOpenInterest;
            py_data["OpenPrice"] = rsp_data.OpenPrice;
            py_data["HighestPrice"] = rsp_data.HighestPrice;
            py_data["LowestPrice"] = rsp_data.LowestPrice;
            py_data["Volume"] = rsp_data.Volume;
            py_data["Turnover"] = rsp_data.Turnover;
            py_data["OpenInterest"] = rsp_data.OpenInterest;
            py_data["ClosePrice"] = rsp_data.ClosePrice;
            py_data["SettlementPrice"] = rsp_data.SettlementPrice;
            py_data["UpperLimitPrice"] = rsp_data.UpperLimitPrice;
            py_data["LowerLimitPrice"] = rsp_data.LowerLimitPrice;
            ...
            py_data["BidPrice1"] = rsp_data.BidPrice1;
            py_data["BidVolume1"] = rsp_data.BidVolume1;
            py_data["AskPrice1"] = rsp_data.AskPrice1;
            py_data["AskVolume1"] = rsp_data.AskVolume1;
            py_data["BidPrice2"] = rsp_data.BidPrice2;
            py_data["BidVolume2"] = rsp_data.BidVolume2;
            py_data["AskPrice2"] = rsp_data.AskPrice2;
            py_data["AskVolume2"] = rsp_data.AskVolume2;
            py_data["BidPrice3"] = rsp_data.BidPrice3;
            py_data["BidVolume3"] = rsp_data.BidVolume3;
            py_data["AskPrice3"] = rsp_data.AskPrice3;
            py_data["AskVolume3"] = rsp_data.AskVolume3;
            py_data["BidPrice4"] = rsp_data.BidPrice4;
            py_data["BidVolume4"] = rsp_data.BidVolume4;
            py_data["AskPrice4"] = rsp_data.AskPrice4;
            py_data["AskVolume4"] = rsp_data.AskVolume4;
            py_data["BidPrice5"] = rsp_data.BidPrice5;
            py_data["BidVolume5"] = rsp_data.BidVolume5;
            py_data["AskPrice5"] = rsp_data.AskPrice5;
            py_data["AskVolume5"] = rsp_data.AskVolume5;
            py_data["AveragePrice"] = rsp_data.AveragePrice;
            py_data["ActionDay"] = gb2312_to_utf8(rsp_data.ActionDay);
            py_data["InstrumentID"] = gb2312_to_utf8(rsp_data.InstrumentID);
            py_data["ExchangeInstID"] = gb2312_to_utf8(rsp_data.ExchangeInstID);
            py_data["BandingUpperPrice"] = rsp_data.BandingUpperPrice;
            py_data["BandingLowerPrice"] = rsp_data.BandingLowerPrice;
        }
