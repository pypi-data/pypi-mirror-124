...
setuptools.setup(
    ...
    package_data={'example_csv_and_excel': ['example_csv_and_excel/Example_CSV_full.csv',
                                            'example_csv_and_excel/Example_CSV_quick.csv',
                                            'example_csv_and_excel/Example_Excel_full.xlsx',
                                            'example_csv_and_excel/Example_Excel_quick.xlsx']},
