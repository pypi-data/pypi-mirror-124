...
You can now import the custom library that you would to use for diagnosis. In this example we will use the Credit Scoring custom library. Please note that following command should be run in the folder which is cloned from this directory.
