...
function interleave -- interleaves iterables

    >>> list(interleave("abc", "d", "ef"))
    ['a', 'd', 'e', 'b', 'f', 'c']
    >>> list(interleave("abc", "defg"))
    ['a', 'd', 'b', 'e', 'c', 'f', 'g']
    >>> list(interleave("abc", "defg", "hi"))
    ['a', 'd', 'h', 'b', 'e', 'i', 'c', 'f', 'g']
    >>> list(interleave("abc"))
    ['a', 'b', 'c']
    >>> list(interleave())
...
from itertools import (
    chain, groupby,
    combinations, combinations_with_replacement, cycle, islice,
