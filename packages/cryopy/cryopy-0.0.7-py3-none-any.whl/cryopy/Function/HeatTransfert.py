...
#%% 
def ElectronThermalConductivity(Temperature,ParameterNormal,CriticalTemperature,ParameterSuperconductor):
    ...
    if Temperature <= CriticalTemperature:
        ...
        return HeatTransfert.ElectronNormalThermalConductivity(Temperature,Parameter)
