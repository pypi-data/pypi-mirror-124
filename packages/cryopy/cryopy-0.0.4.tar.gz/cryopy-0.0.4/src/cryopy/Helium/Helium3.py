...
def Mass():
    ...
    This function return the mass of a single atom of Helium 3
    ...
    [Mass]
    	The mass of a single atom of Helium 3 in [kg]
...
def EffectiveMass():
    ...
    ========== IMPROVEMENT ========== 
        ...
        - Effective Mass of Helium 3 can change with the concentration of Helium 3 on a Helium 3 / Helium 4 mixture
...
def MolarSpecificHeat(Temperature,Pressure):
    ...
    This function can return the molar specific heat of Helium 3

    ========== VALIDITY ==========
    
    0 mK < Temperature < 1.8 K
    Pressure = 0 Pa
    ...
    [MolarSpecificHeat]
        The molar specific heat of Helium 3 in [J].[K]**(-1).[mol]**(-1)
...
def InternalEnergy(Temperature,Pressure):
    ...
    return EntalpieMolaire(Temperature,Pressure)
