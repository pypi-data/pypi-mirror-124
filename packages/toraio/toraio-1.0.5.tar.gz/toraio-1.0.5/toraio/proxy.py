...
class Proxy:
    ...
    def __init__(self, host='127.0.0.1', port=8888, proxy_host='httpbin.org', proxy_port=80):
        self.host = host
        self.port = port
    ...
    async def handle_client(self, local_reader:asyncio.StreamReader, local_writer:asyncio.StreamWriter):
        try:
