...
def maxstrnorm(strin: str) -> str:
    ...
    -   uppercases whole string
    -   splits by spaces into the list
    -   removes duplicated elements through creating set
    -   joins to string with spaces

    :param strin: given raw string
    :return: string normalized
    """
    _norm_list = strnorm(strin)
    _norm_set = set(_norm_list)
    return chr(0x0020).join(list(_norm_set))
