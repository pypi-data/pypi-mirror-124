...
from nbplusplus.extra_builtins import EMIT_EVENT, TRACING_ENABLED, make_loop_iter_flag_name
from nbplusplus.singletons import nbpp  # FIXME: get rid of this
from nbplusplus.tracing.trace_events import TraceEvent
from nbplusplus.utils import fast

if TYPE_CHECKING:
    from typing import Dict, List, Optional, Set, Union
    from nbplusplus.types import CellId
...
class StatementInserter(ast.NodeTransformer):
    ...
    def _handle_loop_body(self, node: Union[ast.For, ast.While], new_field: List[ast.AST]) -> List[ast.AST]:
        ...
        nbpp().loop_iter_flag_names.add(looped_once_flag)
