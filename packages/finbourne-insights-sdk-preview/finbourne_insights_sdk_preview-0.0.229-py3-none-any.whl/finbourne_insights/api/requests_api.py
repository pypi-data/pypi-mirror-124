...
class RequestsApi(object):
    ...
    def get_request(self, id, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] GetRequest: Get the request content for a specific API request.  # noqa: E501
    ...
    def get_request_log(self, id, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] GetRequestLog: Get the log for a specific API request.  # noqa: E501
    ...
    def get_response(self, id, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] GetResponse: Get the response for a specific API request.  # noqa: E501
    ...
    def list_request_logs(self, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] ListRequestLogs: Get the logs for API requests.  # noqa: E501
