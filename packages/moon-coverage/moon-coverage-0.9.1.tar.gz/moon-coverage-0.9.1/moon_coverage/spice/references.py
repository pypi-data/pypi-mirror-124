...
from ..misc import cached_property, depreciated_renamed, warn
...
class SpiceInstrument(SpiceObserver, SpiceFieldOfView):
    ...
    def spacecraft(self):
        ...
        See `issue #12`_ to get more details.

        .. _`issue #12`: https://juigitlab.esac.esa.int/datalab/moon-coverage/-/issues/12
