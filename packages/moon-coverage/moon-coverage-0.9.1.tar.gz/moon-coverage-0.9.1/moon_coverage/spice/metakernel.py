...
class MetaKernel:
    ...
    **kwargs: dict, optional
    ...
    def __init__(self, mk, download=False, remote=None, **kwargs):
    ...
    def __iter__(self):
        ...
        :py:func:`spiceypy.furnsh` function.
    ...
    def remote(self, remote):
        ...
        self.__remote = remote if remote is not None else self.get_remote()
    ...
    def get_remote(self) -> str:
        ...
        if len(remotes) > 1:
            raise ValueError(f'Multiple remote URL found: {remotes}')
    ...
    def urls(self) -> list:
        ...
        """
        remote, n = self.remote, len(self.data.get('PATH_VALUES', []))
