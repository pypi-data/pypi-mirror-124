...
class UnitFormatter(Formatter):
    ...
    def __init__(self, unit='', sep=' ', scale=1, offset=0):
        self.unit = unit
        self.sep = sep
        self.scale = scale
        self.offset = offset
    ...
    def __call__(self, x, pos=None):
        ...
        s = f'{x * self.scale + self.offset:,g}{self.sep}{self.unit}'
...
m_pix_ticks = UnitFormatter('m/pix')
