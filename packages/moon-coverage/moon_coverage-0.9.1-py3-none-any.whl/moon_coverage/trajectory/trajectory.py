...
from ..events import EventsList, EventWindow
...
from ..spice.toolbox import (
    attitude, boresight_pt, groundtrack_velocity,
...
class Trajectory:  # pylint: disable=too-many-public-methods
    ...
    def ets(self, ets):
        ...
        if isinstance(self.exclude, (EventWindow, EventsList)):
    ...
    def ets_target_center(self):
        ...
        The light time correction is only apply if :py:attr:`abcorr` in not ``NONE``.
