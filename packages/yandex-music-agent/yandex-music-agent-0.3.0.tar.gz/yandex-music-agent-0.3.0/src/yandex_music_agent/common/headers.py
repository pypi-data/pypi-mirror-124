...
class Headers:
    ...
    def build(self, page: str, values: dict = None, cross_site: bool = False) -> dict:
        ...
        result.update({
            hdrs.ACCEPT: "application/json; q=1.0, text/*; q=0.8, */*; q=0.1",
            hdrs.ACCEPT_ENCODING: "gzip, deflate, br",
            hdrs.ACCEPT_LANGUAGE: "en-US,en;q=0.9,ru-RU;q=0.8,ru;q=0.7",
            hdrs.CONNECTION: "keep-alive",
            hdrs.ORIGIN: f"https://{self.host}",
        ...
        if not cross_site:
            result[hdrs.COOKIE] = self.cookie
            result[hdrs.HOST] = self.host
        return result
