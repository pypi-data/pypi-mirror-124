...
def main():
    ...
    if args.tool == 'dedup_basic':
        ...
        if args.m == None:
            ...
            raise ValueError
        # cmd = 'python ' + fpnf + ' -h'
        cmd = 'python ' + fpnf + ' -m ' + args.m + ' -ibam ' + args.ibam + ' -ed ' + str(args.ed) + ' -fthres ' + str(args.fthres) + ' -infv ' + str(args.infv) + ' -expv ' + str(args.expv) + ' -itern ' + str(args.itern) + ' -otsv ' + args.otsv + ' -issv ' + args.issv + ' -vb ' + args.vb
        # print(cmd)
        s = subprocess.Popen(cmd, shell=True)
        s.communicate()
    if args.tool == 'dedup_pos':
        ...
        if args.pt == None:
            ...
            raise ValueError
        # cmd = 'python ' + fpnf + ' -h'
        cmd = 'python ' + fpnf + ' -m ' + args.m + ' -ibam ' + args.ibam + ' -ed ' + str(args.ed) + ' -pt ' + str(args.pt) + ' -fthres ' + str(args.fthres) + ' -infv ' + str(args.infv) + ' -expv ' + str(args.expv) + ' -itern ' + str(args.itern) + ' -otsv ' + args.otsv + ' -issv ' + args.issv + ' -vb ' + args.vb
        # print(cmd)
        s = subprocess.Popen(cmd, shell=True)
        s.communicate()
    if args.tool == 'dedup_gene':
        ...
        if args.gist == None:
            ...
            raise ValueError
        # cmd = 'python ' + fpnf + ' -h'
        cmd = 'python ' + fpnf + ' -m ' + args.m + ' -ibam ' + args.ibam + ' -ed ' + str(args.ed) + ' -gt ' + str(args.gt) + ' -gist ' + str(args.gist) + ' -fthres ' + str(args.fthres) + ' -infv ' + str(args.infv) + ' -expv ' + str(args.expv) + ' -itern ' + str(args.itern) + ' -otsv ' + args.otsv + ' -issv ' + args.issv + ' -vb ' + args.vb
        # print(cmd)
        s = subprocess.Popen(cmd, shell=True)
        s.communicate()
