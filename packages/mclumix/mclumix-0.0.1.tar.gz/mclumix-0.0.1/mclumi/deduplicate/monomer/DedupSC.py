...
class dedupSC():
    ...
    def __init__(self, bam_fpn, ed_thres, method, gene_assigned_tag, gene_is_assigned_tag, mode='internal', mcl_fold_thres=None, inflat_val=2, exp_val=2, iter_num=100, is_sv=True, sv_fpn='./dedup.bam', verbose=False):
        """"""
        self.rannum = rannum()
        ...
        if mode == 'internal':
            ...
            self.parser.add_argument(
                ...
                default=100,
                type=int,
                help='iteration number for MCL at a range of (1, +inf)',
            )
            self.parser.add_argument(
            ...
            self.parser.add_argument(
                ...
                default=True,
                type=bool,
                help='to make sure if the deduplicated bam info writes to a bam file.',
            )
            self.parser.add_argument(
                "--output_tsv", "-otsv",
                metavar='output_tsv',
                ...
                required=True,
                type=str,
                help='output UMI-de-duplicated summary statistics to a tsv file.',
            )
            self.parser.add_argument(
                "--verbose", "-vb",
                metavar='verbose',
