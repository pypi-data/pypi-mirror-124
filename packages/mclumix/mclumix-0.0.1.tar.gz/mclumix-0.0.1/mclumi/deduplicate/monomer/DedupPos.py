...
class dedupPos():
    ...
    def __init__(self, bam_fpn, ed_thres, method, mode='external', pos_tag='PO', mcl_fold_thres=None, inflat_val=2, exp_val=2, iter_num=100, is_sv=True, sv_fpn='./dedup.bam', verbose=False):
        """"""
        self.rannum = rannum()
