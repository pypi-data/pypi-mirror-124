...
# Form implementation generated from reading ui file '/tmp/build-via-sdist-x9wc3brd/arc1_pyqt-2.0.0rc0/uis/pf.ui'
#
...
class Ui_PFParent(object):
    def setupUi(self, PFParent):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 590, 288))
