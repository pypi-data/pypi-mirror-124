...
# Form implementation generated from reading ui file '/tmp/build-via-sdist-x9wc3brd/arc1_pyqt-2.0.0rc0/uis/chronoamperometry.ui'
#
...
class Ui_ChronoAmpParent(object):
    def setupUi(self, ChronoAmpParent):
        ...
        ChronoAmpParent.resize(364, 249)
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 344, 160))
    ...
    def retranslateUi(self, ChronoAmpParent):
        ...
        self.label_2.setText(_translate("ChronoAmpParent", "Bias duration (ms)"))
        self.label_3.setText(_translate("ChronoAmpParent", "Number of reads"))
        self.pwEdit.setText(_translate("ChronoAmpParent", "100"))
