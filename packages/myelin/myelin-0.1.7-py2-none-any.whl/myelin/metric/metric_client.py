...
class MetricClient(object):
    ...
    def post_hpo_result(self, config_id, config, budget, loss_metric, loss, info_map):
        ...
        if self.mlflow_tracking_url is not None:
            self.mlflow_export(config, loss, loss_metric, self.MAX_RETRIES)
    ...
    def mlflow_export(self, config, loss, loss_metric, num_tries):
        try:
            ...
            if num_tries == 0:
                ...
                return self.mlflow_export(config, loss, loss_metric, num_tries - 1)
