...
# report
report_earning_url = "https://stock.xueqiu.com/stock/report/earningforecast.json?symbol={}"
...
realtime_depth = "https://stock.xueqiu.com/v5/stock/realtime/pankou.json?symbol={}"
