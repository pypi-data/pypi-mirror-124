...
handler = logging.FileHandler(f"/logs/ra-app-oddsportal-fixtures-{date_today}.log", mode='a')
...
handler = logging.FileHandler(f"/logs/ra-app-oddsportal-odds-{date_today}.log", mode='a')
handler.setFormatter(formatter)
