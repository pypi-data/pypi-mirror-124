...
def test__get_vm_size_and_cluster_name__should_prompt_to_specify_vm(
        prompt_mock, _get_default_vm_size_mock,
        _get_specific_vm_size_mock, backend_mock):
    """
...
@patch('energinetml.cli.cluster.create.click.prompt')
@pytest.mark.parametrize('prompt_value, vm_size, cluster_name', (
        ('cpu', DEFAULT_VM_CPU, 'CPU-Cluster'),
        ('gpu', DEFAULT_VM_GPU, 'GPU-Cluster'),
))
