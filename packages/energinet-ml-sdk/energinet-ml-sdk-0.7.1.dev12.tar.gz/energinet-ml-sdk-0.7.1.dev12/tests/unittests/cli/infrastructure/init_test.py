...
@patch('energinetml.cli.infrastructure.init.click.prompt')
def test__parse_input_resource_group__should_prompt_for_value_and_return_it(prompt_mock):  # noqa: E501
    """
    :param Mock prompt_mock:
    """
...
@patch('energinetml.cli.infrastructure.init.click.prompt')
def test__parse_input_service_connection__should_prompt_for_value_and_return_it(prompt_mock):  # noqa: E501
    """
    :param Mock prompt_mock:
    """
