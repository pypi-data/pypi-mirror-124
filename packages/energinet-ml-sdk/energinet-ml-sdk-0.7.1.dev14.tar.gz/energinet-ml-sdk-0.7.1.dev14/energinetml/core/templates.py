...
from energinetml.settings import DEVOPS_FOLDER_NAME
from energinetml.settings import GITIGNORE_NAME
...
class DataSciencePlatformTemplates(TemplateResolver):
    ...
    def resolve(
        self, project_root_path, project_name, service_connection, resource_group
    ):
        """
        :param str project_root_path:
