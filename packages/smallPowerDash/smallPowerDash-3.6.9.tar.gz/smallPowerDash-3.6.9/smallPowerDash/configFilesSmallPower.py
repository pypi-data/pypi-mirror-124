...
class SmallPowerMaster():
    def __init__(self):
        ...
        self.colorPalettes = pickle.load(open(self.confFolder+'palettes.pkl','rb'))
        self.colorshades = ['greens','blues','reds','magenta','oranges,cyans','yellows','blacks']
        ...
        for k1,g in enumerate(listCols):
            ...
            for d in fig.data:
                if d.name in names2change:
                    shade = np.random.randint(0,len(shades))
