...
class Get(Message):
    def __init__(self, symbol: bytes = b'', data_type: bytes = b'', end_timestamp: bytes = b''):
        super().__init__(MSG_GET)
        self.fields = [Field('symbol', 'string'), Field('data_type', 'string'), Field('end_timestamp', 'string')]
...
class Sub(Message):
    def __init__(self, symbol: bytes = b'', data_type: bytes = b''):
        super().__init__(MSG_SUB)
        self.fields = [Field('symbol', 'string'), Field('data_type', 'string')]
        self.set_field('symbol', symbol)
        self.set_field('data_type', data_type)
