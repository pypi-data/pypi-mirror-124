...
url_dict = {
    ...
    'get_categories': '/datasets/{sampleset_id}/categories',
...
class BASEClient(metaclass=Singleton):
    ...
    def get_categories(self, sampleset_id, feature_type):
        """
        Args:
        ...
        try:
            ...
            category_resp = requests.get(
                url=self.config.url + url_dict.get('get_categories').format(sampleset_id=sampleset_id),
                params=payload,
                headers={'apiKey': self.apiKey}).json()
