# python build stubs for package gosnmp_traps_python_go
...
mod = Module('_gosnmp_traps_python_go')
mod.add_include('"gosnmp_traps_python_go_go.h"')
...
mod.add_function('gosnmp_traps_python_go_RPCClose', None, [param('uint64_t', 'sessionID'), param('bool', 'goRun')])
mod.add_function('gosnmp_traps_python_go_RPCConnect', retval('char*'), [param('uint64_t', 'sessionID')])
mod.add_function('gosnmp_traps_python_go_RPCGetNoWait', retval('char*'), [param('uint64_t', 'sessionID')])
mod.add_function('gosnmp_traps_python_go_SetPyPy', None, [param('bool', 'goRun')])
mod.add_function('gosnmp_traps_python_go_GetPyPy', retval('bool'), [])
mod.add_function('gosnmp_traps_python_go_NewRPCSession', retval('uint64_t'), [param('char*', 'hostname'), param('int64_t', 'port'), param('int64_t', 'timeout'), param('char*', 'paramsJSON')])

mod.generate(open('gosnmp_traps_python_go.c', 'w'))
