/*
cgo stubs for package gosnmp_traps_python_go.
...
#cgo CFLAGS: -I/Users/edwardbeech/.venv/gosnmp-traps-python/include/python2.7
...
import (
	...
	"gosnmp_traps_python/gosnmp_traps_python_go"
)
...
// --- generated code for package: gosnmp_traps_python_go below: ---
...
//export gosnmp_traps_python_go_RPCClose
func gosnmp_traps_python_go_RPCClose(sessionID C.ulonglong, goRun C.char) {
	if boolPyToGo(goRun) {
		go gosnmp_traps_python_go.RPCClose(uint64(sessionID))
	} else {
		gosnmp_traps_python_go.RPCClose(uint64(sessionID))
	}
}

//export gosnmp_traps_python_go_RPCConnect
func gosnmp_traps_python_go_RPCConnect(sessionID C.ulonglong) *C.char {
	var __err error
	__err = gosnmp_traps_python_go.RPCConnect(uint64(sessionID))
...
//export gosnmp_traps_python_go_RPCGetNoWait
func gosnmp_traps_python_go_RPCGetNoWait(sessionID C.ulonglong) *C.char {
	cret, __err := gosnmp_traps_python_go.RPCGetNoWait(uint64(sessionID))
...
//export gosnmp_traps_python_go_SetPyPy
func gosnmp_traps_python_go_SetPyPy(goRun C.char) {
	if boolPyToGo(goRun) {
		go gosnmp_traps_python_go.SetPyPy()
	} else {
		gosnmp_traps_python_go.SetPyPy()
	}
}

//export gosnmp_traps_python_go_GetPyPy
func gosnmp_traps_python_go_GetPyPy() C.char {
	return boolGoToPy(gosnmp_traps_python_go.GetPyPy())

}

//export gosnmp_traps_python_go_NewRPCSession
func gosnmp_traps_python_go_NewRPCSession(hostname *C.char, port C.longlong, timeout C.longlong, paramsJSON *C.char) C.ulonglong {
	cret, __err := gosnmp_traps_python_go.NewRPCSession(C.GoString(hostname), int(port), int(timeout), C.GoString(paramsJSON))
