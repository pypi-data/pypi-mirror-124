...
[boto3.ApplicationAutoScaling 1.19.0](https://boto3.amazonaws.com/v1/documentation/api/1.19.0/reference/services/application-autoscaling.html#ApplicationAutoScaling)
