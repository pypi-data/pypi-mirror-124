...
def init_model(app):
    ...
    if app_config.get('FLASKZ_DATABASE_DEBUG_QUERIES') is True:
    ...
    db_slow_time = app_config.get('FLASKZ_DATABASE_SLOW_TIME', -1)  # set config['FLASKZ_DATABASE_SLOW_TIME'] to enable
    db_access_times = app_config.get('FLASKZ_DATABASE_ACCESS_TIMES', -1)  # set config['FLASKZ_DATABASE_ACCESS_TIMES'] to enable
