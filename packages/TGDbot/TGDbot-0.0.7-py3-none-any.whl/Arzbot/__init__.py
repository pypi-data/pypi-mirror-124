...
class PartyBot(commands.Bot):
    def __init__(self, device_id: str, account_id: str, secret: str, loop=asyncio.get_event_loop(), **kwargs) -> None:
        ...
        self.server = server
        self.welcome_message =  "Heye :)\n 1: Use Code '667' in the Item Shop (#EpicPartner)\n 2: My discord : discord.gg/ftn  \n 3: cousin discord (.gg/cousin) "
    ...
    async def status_change(self) -> None:
        ...
        await self.set_presence("🔥 {party_size}/16 Use Code '667' #EpicPartner🔥")
...
#///////////////////////////////////////////////////////////////////////////////////////////////////////////// PARTY/FRIENDS/ADMIN //////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    async def invitefriends(self):
        ...
        for ctz in self.friends:
            if not ctz.display_name != "メStepBroメ":
                if ctz.is_online():
