...
class Python(Field):
    ...
    view = cell = edit = Px('''
     ...
     css='''
      .python { background-color:|darkColor|; color:|brightColor|; padding:5px;
                font-family:monospace; height:40vh; overflow-y:auto }
      .prompt { display:inline; padding-right:10px }
      .python input[type=text] { padding:0; margin:0; border-bottom:none;
