            ...
            for entry in models:
                ...
                for tenant_name in cls._tenant_configs:
                    if model_name in cls._tenant_configs[tenant_name]:
                        if language in cls._tenant_configs[tenant_name][model_name][language]:
                            check_version = cls._tenant_configs[tenant_name][model_name][language]['version'] == version
                            check_client = cls._tenant_configs[tenant_name][model_name][language]['client'] == client
