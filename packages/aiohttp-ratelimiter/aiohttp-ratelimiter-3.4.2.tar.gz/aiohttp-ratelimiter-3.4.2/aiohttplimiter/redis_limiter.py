...
class RateLimitDecorator:
    ...
    def __init__(self, db: aredis.StrictRedis, keyfunc: Callable, ratelimit: str, exempt_ips: Optional[set] = None, error_handler: Optional[Union[Callable, Awaitable]] = None) -> None:
