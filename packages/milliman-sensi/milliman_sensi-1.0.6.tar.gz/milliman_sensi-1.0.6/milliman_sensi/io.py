            ...
            if sensi_dirs:
                ...
                for sensi in self.sensi_list.keys():
                    if sensi in sensi_dirs.keys():
                        sensi_dirs_to_process[sensi] = sensi_dirs[sensi]
                ...
                for sensi_name in sensi_dirs_to_process.keys():
                    ...
                    if os.path.exists(sensi_dirpath):
                        ...
                        if settings_json_sensi:
                            ...
                            processed_sensi_messages[sensi_name] = "Couldn't find settings.json"

                    else:
                        processed_sensi_messages[sensi_name] = "Sensi_dirpath doesn't exist"
