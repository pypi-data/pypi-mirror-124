...
def get_input_file_path(data, expression, env_dir):
    ...
    if filename:
        ...
        if not os.path.exists(file_path):
            raise SensiSyntaxError("The input file can't be found at {}".format(file_path))
    ...
    if input_path and syntax and settings_json:
        ...
        if seps:
            ...
            if os.path.exists(input_path):
                ...
                raise SensiSyntaxError("Couldn't find the input file at ", input_path)

        else:
            raise SensiSyntaxError("Couldn't find the seps from settings.json")

    else:
        raise SensiSyntaxError("Error in apply_syntax_to_file arguments:")
