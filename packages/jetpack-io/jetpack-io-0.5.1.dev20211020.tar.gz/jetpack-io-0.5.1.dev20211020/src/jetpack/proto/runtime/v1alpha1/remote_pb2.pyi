...
class RemoteJob(google.protobuf.message.Message):
    ...
    JETPACK_SDK_BIN_PATH_FIELD_NUMBER: builtins.int
    qualified_symbol: typing.Text = ...
    ...
    jetpack_sdk_bin_path: typing.Text = ...
    def __init__(self,
        *,
        qualified_symbol : typing.Text = ...,
        namespace : typing.Text = ...,
    ...
    def ClearField(self, field_name: typing_extensions.Literal[u"encoded_args",b"encoded_args",u"hostname",b"hostname",u"jetpack_sdk_bin_path",b"jetpack_sdk_bin_path",u"namespace",b"namespace",u"qualified_symbol",b"qualified_symbol"]) -> None: ...
