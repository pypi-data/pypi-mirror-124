...
class HandlerContainer(containers.DeclarativeContainer):
    ...
    az_webapp_config_manager = providers.Dependency()
    ...
    webapp_config_handler = providers.Factory(
        WebappConfigHandler,
        app_config=app_config,
        manager=az_webapp_config_manager
    )
    ...
    handler_facade = providers.Factory(
        ...
        webapp_config_handler=webapp_config_handler,
