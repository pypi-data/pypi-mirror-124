...
class HomePage1(object):
    ...
    def createPage_btn(self):
        ...
        btn_up = ttk.Button(self.btn_page, text='up', command=button_press.keyevent_up, style = 'Z.TButton').grid(row=1, column=2, pady=5, padx=5)
        btn_down= ttk.Button(self.btn_page, text='down', command=button_press.keyevent_down, style = 'Z.TButton').grid(row=3, column=2, pady=5, padx=5)
        btn_left = ttk.Button(self.btn_page, text='left', command=button_press.keyevent_left, style = 'Z.TButton').grid(row=2, column=1, pady=5, padx=5)
        btn_right = ttk.Button(self.btn_page, text='right', command=button_press.keyevent_right, style = 'Z.TButton').grid(row=2, column=3, pady=5, padx=5)
        btn_enter = ttk.Button(self.btn_page, text='Enter', command=button_press.keyevent_select, style = 'Z.TButton').grid(row=2, column=2, pady=5, padx=5)

        ttk.Button(self.btn_page, text='Back', command=button_press.keyevent_back, style = 'Z.TButton').grid(row=4, column=1, pady=5, padx=5)
        ttk.Button(self.btn_page, text='Home', command=button_press.keyevent_home, style = 'Z.TButton').grid(row=4, column=2, pady=5, padx=5)
        ttk.Button(self.btn_page, text='Menu', command=button_press.keyevent_menu, style = 'Z.TButton').grid(row=4, column=3, pady=5, padx=5)

        ttk.Button(self.btn_page, text='Play/Pause', command=button_press.keyevent_play, style = 'Z.TButton').grid(row=5, column=2, pady=5, padx=5)
        ttk.Button(self.btn_page, text='Vol +', command=button_press.keyevent_vol_up, style = 'Z.TButton').grid(row=5, column=1, pady=5, padx=5)
        ttk.Button(self.btn_page, text='Vol -', command=button_press.keyevent_vol_down, style = 'Z.TButton').grid(row=5, column=3, pady=5, padx=5)

        short_ble = ttk.Button(self.btn_page, text='Bluetooth', command=button_press.shortcut_bluetooth, style = 'W.TButton').grid(row=6, column=1, pady=5, padx=5)
        short_wifi = ttk.Button(self.btn_page, text='Wifi', command=button_press.shortcut_wifi, style = 'W.TButton').grid(row=6, column=2, pady=5, padx=5)
        short_mirror = ttk.Button(self.btn_page, text='Mirror', command=button_press.shortcut_mirror, style = 'W.TButton').grid(row=6, column=3, pady=5, padx=5)

        btn_reload = ttk.Button(self.btn_page, text='Reload', command=self.reload, style='Y.TButton').grid(row=7, column=1, pady=5, padx=5)
        btn_reboot = ttk.Button(self.btn_page, text='Reboot', command=button_press.keyevent_reboot, style='X.TButton').grid(row=7, column=2, pady=5, padx=5)
        btn_oobe = ttk.Button(self.btn_page, text='OOBE', command=button_press.keyevent_OOBE, style='X.TButton').grid(row=7, column=3, pady=5, padx=5)
        ...
        self.text_entry.grid(column=2, row=8, pady=5, padx=5)

        ttk.Button(self.btn_page, text="Input",  command=self.input_text, style='Z.TButton').grid(column=3, row=8, pady=5, padx=5)
