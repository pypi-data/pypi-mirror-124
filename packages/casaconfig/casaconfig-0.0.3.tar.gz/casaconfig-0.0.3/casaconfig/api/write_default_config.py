...
def write_default_config(name, **kwargs):
    ...
    ----------
    name : str
        output filename to write configuration to
    **kwargs
        modify the configuration option specified by keyword to value specified in variable (i.e. telemetry_enabled = True).
