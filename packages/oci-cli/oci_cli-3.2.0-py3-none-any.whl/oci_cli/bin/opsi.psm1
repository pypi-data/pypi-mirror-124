...
function GetOciCommandsToLongParams_opsi() {
    $ociCommandsToLongParams = @{
        ...
        'opsi database-insights list-database-configurations' = 'all compartment-id database-id database-type defined-tag-equals defined-tag-exists em-bridge-id freeform-tag-equals freeform-tag-exists from-json help host-name id limit page page-size sort-by sort-order'
        'opsi database-insights list-sql-plans' = 'all compartment-id database-id from-json help id page plan-hash sql-identifier'
        'opsi database-insights list-sql-searches' = 'all analysis-time-interval compartment-id defined-tag-equals defined-tag-exists freeform-tag-equals freeform-tag-exists from-json help page sql-identifier time-interval-end time-interval-start'
        'opsi database-insights list-sql-texts' = 'all compartment-id database-id defined-tag-equals defined-tag-exists freeform-tag-equals freeform-tag-exists from-json help id page sql-identifier'
        'opsi database-insights summarize-database-insight-resource-capacity-trend' = 'analysis-time-interval compartment-id database-id database-type defined-tag-equals defined-tag-exists freeform-tag-equals freeform-tag-exists from-json help host-name id is-database-instance-level-metrics page resource-metric sort-by sort-order tablespace-name time-interval-end time-interval-start utilization-level'
        'opsi database-insights summarize-database-insight-resource-forecast-trend' = 'analysis-time-interval compartment-id confidence database-id database-type defined-tag-equals defined-tag-exists forecast-days forecast-model freeform-tag-equals freeform-tag-exists from-json help host-name id is-database-instance-level-metrics page resource-metric statistic tablespace-name time-interval-end time-interval-start utilization-level'
        'opsi database-insights summarize-database-insight-resource-statistics' = 'analysis-time-interval compartment-id database-id database-type defined-tag-equals defined-tag-exists forecast-days freeform-tag-equals freeform-tag-exists from-json help host-name id insight-by is-database-instance-level-metrics limit page percentile resource-metric sort-by sort-order time-interval-end time-interval-start'
        'opsi database-insights summarize-database-insight-resource-usage' = 'analysis-time-interval compartment-id database-id database-type defined-tag-equals defined-tag-exists freeform-tag-equals freeform-tag-exists from-json help host-name id is-database-instance-level-metrics page percentile resource-metric time-interval-end time-interval-start'
        'opsi database-insights summarize-database-insight-resource-usage-trend' = 'analysis-time-interval compartment-id database-id database-type defined-tag-equals defined-tag-exists freeform-tag-equals freeform-tag-exists from-json help host-name id is-database-instance-level-metrics page resource-metric sort-by sort-order time-interval-end time-interval-start'
        'opsi database-insights summarize-database-insight-resource-utilization-insight' = 'analysis-time-interval compartment-id database-id database-type defined-tag-equals defined-tag-exists forecast-days freeform-tag-equals freeform-tag-exists from-json help host-name id is-database-instance-level-metrics page resource-metric time-interval-end time-interval-start'
        ...
        'opsi database-insights summarize-sql-insights' = 'analysis-time-interval compartment-id database-id database-time-pct-greater-than database-type defined-tag-equals defined-tag-exists freeform-tag-equals freeform-tag-exists from-json help host-name id page time-interval-end time-interval-start'
        ...
        'opsi database-insights summarize-sql-statistics' = 'analysis-time-interval category compartment-id database-id database-time-pct-greater-than database-type defined-tag-equals defined-tag-exists freeform-tag-equals freeform-tag-exists from-json help host-name id limit page sort-by sort-order sql-identifier time-interval-end time-interval-start'
        'opsi database-insights summarize-sql-statistics-time-series' = 'analysis-time-interval compartment-id database-id defined-tag-equals defined-tag-exists freeform-tag-equals freeform-tag-exists from-json help host-name id page sql-identifier time-interval-end time-interval-start'
        ...
        'opsi host-insights summarize-host-insight-resource-capacity-trend' = 'analysis-time-interval compartment-id defined-tag-equals defined-tag-exists freeform-tag-equals freeform-tag-exists from-json help id page platform-type resource-metric sort-by sort-order time-interval-end time-interval-start utilization-level'
        'opsi host-insights summarize-host-insight-resource-forecast-trend' = 'analysis-time-interval compartment-id confidence defined-tag-equals defined-tag-exists forecast-days forecast-model freeform-tag-equals freeform-tag-exists from-json help id page platform-type resource-metric statistic time-interval-end time-interval-start utilization-level'
        'opsi host-insights summarize-host-insight-resource-statistics' = 'analysis-time-interval compartment-id defined-tag-equals defined-tag-exists forecast-days freeform-tag-equals freeform-tag-exists from-json help id insight-by limit page percentile platform-type resource-metric sort-by sort-order time-interval-end time-interval-start'
        'opsi host-insights summarize-host-insight-resource-usage' = 'analysis-time-interval compartment-id defined-tag-equals defined-tag-exists freeform-tag-equals freeform-tag-exists from-json help id page percentile platform-type resource-metric time-interval-end time-interval-start'
        'opsi host-insights summarize-host-insight-resource-usage-trend' = 'analysis-time-interval compartment-id defined-tag-equals defined-tag-exists freeform-tag-equals freeform-tag-exists from-json help id page platform-type resource-metric sort-by sort-order time-interval-end time-interval-start'
        'opsi host-insights summarize-host-insight-resource-utilization-insight' = 'analysis-time-interval compartment-id defined-tag-equals defined-tag-exists forecast-days freeform-tag-equals freeform-tag-exists from-json help id page platform-type resource-metric time-interval-end time-interval-start'
