...
##################### 5356ec4324e22da87d019601c82d0c7f ##############################
...
class sdm:
    ...
    def sdmversion(self):
        """
        """
        return _str_dc(self._swigobj.sdmversion())
    ...
    def fromms(self, mspath='', datacolumn='DATA', archiveid='S0', rangeid='X1', subscanduration=float(24.0*3600.0), sbduration=float(2700.0), apcorrected=False, verbose=True, useversion='deprecated'):
        ...
        """
        return self._swigobj.fromms(_str_ec(mspath), _str_ec(datacolumn), _str_ec(archiveid), _str_ec(rangeid), subscanduration, sbduration, apcorrected, verbose, _str_ec(useversion))
