...
class sdm(_object):
    ...
    def sdmversion(self) -> "string":
        """
        sdmversion(self) -> string



        Summary:
            Returns SDM version number on which this tool operates

        --------------------------------------------------------------------------------

        """
        return _sdm.sdm_sdmversion(self)
    ...
    def fromms(self, *args, **kwargs) -> "bool":
        """
        fromms(self, _mspath, _datacolumn, _archiveid, _rangeid, _subscanduration, _sbduration, _apcorrected, _verbose, _useversion) -> bool
        ...
        Input Parameters:
            ...
            useversion                 DEPRECATED, will be eliminated in a future release. Selects the version of MS2asdm to be used (no longer relevant) 
    ...
    def toms(self, *args, **kwargs) -> "bool":
        ...
        Input Parameters:
            ...
            showversion               DEPRECATED, will be eliminated in a future reelase. Report the version of asdm2MS being used
            useversion                DEPRECATED, will be eliminated in a future release. Version of asdm2MS to be used (no longer relevant)
