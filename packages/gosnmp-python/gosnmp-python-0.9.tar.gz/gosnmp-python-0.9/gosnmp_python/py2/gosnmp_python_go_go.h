...
/* package gosnmp_python/gosnmp_python/py2 */
...
extern char gosnmp_python_go_GetPyPy();

extern char* gosnmp_python_go_RPCClose(long long unsigned int p0);

extern char* gosnmp_python_go_RPCGet(long long unsigned int p0, char* p1);

extern char* gosnmp_python_go_RPCGetNext(long long unsigned int p0, char* p1);

extern char* gosnmp_python_go_RPCSetIPAddress(long long unsigned int p0, char* p1, char* p2);

extern long long unsigned int gosnmp_python_go_NewRPCSessionV1(char* p0, long long int p1, char* p2, long long int p3, long long int p4);

extern long long unsigned int gosnmp_python_go_NewRPCSessionV2c(char* p0, long long int p1, char* p2, long long int p3, long long int p4);

extern long long unsigned int gosnmp_python_go_NewRPCSessionV3(char* p0, long long int p1, char* p2, char* p3, char* p4, char* p5, char* p6, char* p7, char* p8, long long int p9, long long int p10);

extern char* gosnmp_python_go_RPCConnect(long long unsigned int p0);

extern char* gosnmp_python_go_RPCSetInteger(long long unsigned int p0, char* p1, long long int p2);

extern char* gosnmp_python_go_RPCSetString(long long unsigned int p0, char* p1, char* p2);

extern void gosnmp_python_go_SetPyPy(char p0);
