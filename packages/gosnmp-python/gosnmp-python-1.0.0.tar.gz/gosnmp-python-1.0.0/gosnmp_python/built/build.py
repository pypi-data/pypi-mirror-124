...
mod.add_function('gosnmp_python_go_RPCWalk', retval('char*'), [param('uint64_t', 'sessionID'), param('char*', 'oid')])
...
mod.add_function('gosnmp_python_go_RPCGetBulk', retval('char*'), [param('uint64_t', 'sessionID'), param('char*', 'oids'), param('uint8_t', 'nonRepeaters'), param('uint8_t', 'maxRepetitions')])
...
mod.add_function('gosnmp_python_go_RPCWalkBulk', retval('char*'), [param('uint64_t', 'sessionID'), param('char*', 'oid')])
