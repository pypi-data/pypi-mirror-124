...
class UNet3d_MultiModal(nn.Module):
    def __init__(self, in_channels = 1, out_channels = 2, n_channels = 32, channel_bound = 320):
        ...
        self.resample_div2 = F.interpolate(scale_factor = 0.5, mode ='trilinear')
        self.resample_div4 = F.interpolate(scale_factor = 0.25, mode ='trilinear')
        self.resample_div8 = F.interpolate(scale_factor = 0.125, mode ='trilinear')
    ...
    def forward(self, CT, PET):
        ...
        spatial_attention_map_div2 = self.resample_div2(spatial_attention_map)
        spatial_attention_map_div4 = self.resample_div4(spatial_attention_map)
        spatial_attention_map_div8 = self.resample_div8(spatial_attention_map)
