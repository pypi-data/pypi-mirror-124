...
class Batch_Affine_3D(object):
    ...
    def __call__(self, images):
        ...
        for batch_index in range(bs):
            ...
            if not seg:
                print(images.shape, images[batch_index, :, transformed_coords[0], transformed_coords[1], transformed_coords[2]].shape)
                images[batch_index, :, :, :, :] = self.pad_image_seg(images[batch_index, :, transformed_coords[0], transformed_coords[1], transformed_coords[2]], patch_size)
