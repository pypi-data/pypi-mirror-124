...
setup(
    ...
    data_files=[
        (os.path.join
         (os.path.expanduser("~"),'robotathome/schema'),
         ['rh_schema_diagram/rh_schema_brief.pdf', 'rh_schema_diagram/rh_schema_full.pdf']
         ),
        (os.path.join
         (os.path.expanduser("~"),'robotathome/notebooks'),
