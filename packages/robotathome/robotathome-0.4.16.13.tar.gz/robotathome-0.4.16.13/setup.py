...
setup(
    ...
    # These files will be located at ~/<anaconda-dir>/envs/<env-name>/[schema|notebooks|...]
    data_files=[('robotathome/schema', ['rh_schema_diagram/rh_schema_brief.pdf']),
                ('robotathome/schema', ['rh_schema_diagram/rh_schema_full.pdf']),
                ('robotathome/notebooks', ['notebooks/10-Download-and-install.ipynb'])
                ],
