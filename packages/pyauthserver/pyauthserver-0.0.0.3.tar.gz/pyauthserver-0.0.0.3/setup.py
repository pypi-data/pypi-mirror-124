...
setuptools.setup(
    executable=True,
    name="pyauthserver",  # Replace with your own username
    version=version,
    author="Wang Pei",
    author_email="1535376447@qq.com",
    description="Authentication server implemented in python.",
    long_description=long_description,
    long_description_content_type="text/markdown",
    url="https://gitee.com/peiiii/pyauthserver",
    packages=packages,
    package_dir={'pyauthserver': 'pyauthserver'},
    install_requires=['sanic', 'sanic_cors', 'sqlalchemy', 'pymysql'],
    entry_points={
        'console_scripts': [
