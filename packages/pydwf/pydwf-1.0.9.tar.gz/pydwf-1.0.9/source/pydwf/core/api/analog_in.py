...
class AnalogIn(AbstractDwfDeviceSubApi):
    ...
    def triggerHoldOffSet(self, trigger_holdoff: float) -> None:
        ...
        Parameters:
            trigger_holdoff (float): The trigger holdoff setting, in seconds.
    ...
    def triggerTypeSet(self, trigger_type: DwfAnalogInTriggerType) -> None:
        ...
        Parameters:
            trigger_type (DwfAnalogInTriggerType): The trigger detector trigger-type to be configured.
    ...
    def triggerChannelSet(self, trigger_channel_index: int) -> None:
        ...
        Parameters:
            trigger_channel_index (int): The trigger detector channel to be selected.
    ...
    def triggerFilterSet(self, trigger_filter: DwfAnalogInFilter) -> None:
        ...
        Parameters:
            trigger_filter (DwfAnalogInFilter): The trigger detector channel filter to be selected.
    ...
    def triggerConditionSet(self, trigger_condition: DwfTriggerSlope) -> None:
        ...
        Parameters:
            trigger_condition (DwfTriggerSlope): The trigger detector condition (slope) to be configured.
    ...
    def triggerLengthSet(self, trigger_length: float) -> None:
        ...
        Parameters:
            trigger_length (float): The trigger detector length to be configured, in seconds.
    ...
    def triggerLengthGet(self) -> float:
        ...
        Returns:
            float: The currently configured trigger detector length, in seconds.
