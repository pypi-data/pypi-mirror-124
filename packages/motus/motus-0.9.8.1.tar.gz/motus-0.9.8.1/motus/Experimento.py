...
class Experimento:
    ...
    def genera_matriz_cuadriculada_con_regiones_preferidas(self):
        ...
        self.visitas_regiones_preferidas = matriz_cuadriculada_plana[self.regiones_de_interes]
        self.visitas_regiones_no_preferidas = np.delete(matriz_cuadriculada_plana, self.regiones_de_interes)
        ...
        arreglo_regiones_preferidas[self.regiones_de_interes] = resultado_visitas_regiones_preferidas
