...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'newrelic', '4.5.0-alpha.1634661674+b290756a'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource newrelic 4.5.0-alpha.1634661674+b290756a`
                """)
            else:
                raise
