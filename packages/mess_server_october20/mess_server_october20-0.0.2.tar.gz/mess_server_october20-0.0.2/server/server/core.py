...
import binascii
import os
# подготовка к сбору проекта:
# from server.common.descriptors import Port #, Addr
...
class MessageProcessor(threading.Thread):
    ...
    def autorize_user(self, message, sock):
        ...
        # Проверяем что пользователь зарегистрирован на сервере.
            ...
            hashs = hmac.new(self.database.get_hash(message[USER][ACCOUNT_NAME]), random_str, 'MD5')
            digest = hashs.digest()
