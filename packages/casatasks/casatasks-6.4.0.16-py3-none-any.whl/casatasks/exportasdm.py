...
class _exportasdm:
    ...
    def __call__( self, vis='', asdm='', datacolumn='data', archiveid='S0', rangeid='X1', subscanduration='24h', sbduration='2700s', apcorrected=False, verbose=True, showversion=False, useversion='deprecated' ):
        ...
        task_result = None
        try:
            task_result = _exportasdm_t( _pc.document['vis'], _pc.document['asdm'], _pc.document['datacolumn'], _pc.document['archiveid'], _pc.document['rangeid'], _pc.document['subscanduration'], _pc.document['sbduration'], _pc.document['apcorrected'], _pc.document['verbose'], _pc.document['showversion'], _pc.document['useversion'] )
