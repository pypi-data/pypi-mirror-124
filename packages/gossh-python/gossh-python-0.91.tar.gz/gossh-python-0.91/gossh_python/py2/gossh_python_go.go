/*
cgo stubs for package gossh_python_go.
...
#cgo CFLAGS: -I/Users/edwardbeech/.venv/gossh-python/include/python2.7
...
// --- generated code for package: gossh_python_go below: ---
...
//export gossh_python_go_RPCClose
func gossh_python_go_RPCClose(sessionID C.ulonglong) *C.char {
	var __err error
	__err = gossh_python_go.RPCClose(uint64(sessionID))
...
//export gossh_python_go_RPCConnect
func gossh_python_go_RPCConnect(sessionID C.ulonglong) *C.char {
	var __err error
	__err = gossh_python_go.RPCConnect(uint64(sessionID))
...
//export gossh_python_go_RPCGetShell
func gossh_python_go_RPCGetShell(sessionID C.ulonglong, terminal *C.char, height C.longlong, width C.longlong) *C.char {
	var __err error
	__err = gossh_python_go.RPCGetShell(uint64(sessionID), C.GoString(terminal), int(height), int(width))
...
//export gossh_python_go_RPCRead
func gossh_python_go_RPCRead(sessionID C.ulonglong, size C.longlong) *C.char {
	cret, __err := gossh_python_go.RPCRead(uint64(sessionID), int(size))
...
//export gossh_python_go_RPCWrite
func gossh_python_go_RPCWrite(sessionID C.ulonglong, data *C.char) *C.char {
	var __err error
	__err = gossh_python_go.RPCWrite(uint64(sessionID), C.GoString(data))
...
//export gossh_python_go_SetPyPy
func gossh_python_go_SetPyPy(goRun C.char) {
	if boolPyToGo(goRun) {
		go gossh_python_go.SetPyPy()
	} else {
		gossh_python_go.SetPyPy()
	}
}

//export gossh_python_go_GetPyPy
func gossh_python_go_GetPyPy() C.char {
	return boolGoToPy(gossh_python_go.GetPyPy())

}

//export gossh_python_go_NewRPCSession
func gossh_python_go_NewRPCSession(hostname *C.char, username *C.char, password *C.char, port C.longlong, timeout C.longlong) C.ulonglong {
	return C.ulonglong(gossh_python_go.NewRPCSession(C.GoString(hostname), C.GoString(username), C.GoString(password), int(port), int(timeout)))
