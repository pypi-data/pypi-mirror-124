# python build stubs for package gossh_python_go
...
mod = Module('_gossh_python_go')
mod.add_include('"gossh_python_go_go.h"')
...
mod.add_function('gossh_python_go_RPCWrite', retval('char*'), [param('uint64_t', 'sessionID'), param('char*', 'data')])
mod.add_function('gossh_python_go_NewRPCSession', retval('uint64_t'), [param('char*', 'hostname'), param('char*', 'username'), param('char*', 'password'), param('int64_t', 'port'), param('int64_t', 'timeout')])
mod.add_function('gossh_python_go_RPCClose', retval('char*'), [param('uint64_t', 'sessionID')])
mod.add_function('gossh_python_go_RPCConnect', retval('char*'), [param('uint64_t', 'sessionID')])
mod.add_function('gossh_python_go_RPCGetShell', retval('char*'), [param('uint64_t', 'sessionID'), param('char*', 'terminal'), param('int64_t', 'height'), param('int64_t', 'width')])
mod.add_function('gossh_python_go_RPCRead', retval('char*'), [param('uint64_t', 'sessionID'), param('int64_t', 'size')])

mod.generate(open('gossh_python_go.c', 'w'))
