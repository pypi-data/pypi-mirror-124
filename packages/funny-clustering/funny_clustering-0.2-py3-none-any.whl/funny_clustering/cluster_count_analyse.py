...
def GaussianMixture_analyse_cluster_count(dataset,  cluster_count=10, reg_covar=1e-5):
    ...
    for n in n_clusters:
        ...
        for _ in range(iterations):
            gmm=GMM(n, n_init=2, reg_covar=reg_covar).fit(embeddings)
    ...
    for n in n_clusters:
        ...
        for iteration in range(iterations):
            ...
            gmm_train = GMM(n, n_init=2,reg_covar=reg_covar).fit(train)
            gmm_test = GMM(n, n_init=2,reg_covar=reg_covar).fit(test)
