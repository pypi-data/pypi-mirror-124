...
class LocationResponse(object):
    ...
    def __init__(self, id=None, name=None, abbreviation=None, active=None, created=None, api_key=None, site_ids=None, settings=None, corporation=None, systems=None):  # noqa: E501
