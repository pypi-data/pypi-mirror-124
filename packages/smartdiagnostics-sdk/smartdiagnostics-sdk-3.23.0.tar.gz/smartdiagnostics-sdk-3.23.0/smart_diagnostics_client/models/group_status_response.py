...
class GroupStatusResponse(object):
    ...
    def __init__(self, name=None, id=None, alarm_count=None, warning_count=None, damage_score=None, alarm_severity=None, is_snoozed=None, is_paused=None, model_count=None, analytics_models=None, hierarchy=None):  # noqa: E501
