...
class HubResponse(object):
    ...
    def __init__(self, id=None, receiver=None, location=None, corporation=None, serial_number=None, name=None, power_type=None, firmware_version=None, hub_type=None, created=None, updated=None, packet_success_rate=None, wireless_efficiency=None, is_online=None, triggering_enabled=None, ports=None):  # noqa: E501
