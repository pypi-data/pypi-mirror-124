...
class AnalyticsApi(object):
    ...
    def get_analytics_logs(self, model_id, start_date, end_date, **kwargs):  # noqa: E501
        ...
        :param str filter: Filter statements to narrow results by properties. Filterable properties:  | Field name | Type | Operators | | ---------- | ---- | --------- | | `Message` | String | `eq, neq, like, in` |
    ...
    def get_analytics_models_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['location_ids', 'filter', 'page', 'page_limit', 'order_by', 'name_search']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
