...
class FilesApi(object):
    ...
    def get_corporation_files(self, corporation_id, **kwargs):  # noqa: E501
        ...
        :param str filter: Filter statements to narrow results by properties. Filterable properties:  | Field name | Type | Operators | | ---------- | ---- | --------- | | `FileType` | ContentType | `eq, neq, in` | | `IsRootFolder` | Boolean | `eq, neq` | | `LocationAbbreviation` | String | `eq, neq, like, in` | | `LocationId` | Guid | `eq, neq, in` | | `LocationName` | String | `eq, neq, like, in` | | `ParentFolderId` | Guid? | `eq, neq, in, lt, gt, leq, geq` | | `TagId` | Guid | `eq, neq, in` | | `TagName` | String | `eq, neq, like, in` |
