...
class TreeItemsApi(object):
    ...
    def get_tree_items(self, **kwargs):  # noqa: E501
        ...
        :param str filter: Filter statements to narrow results by properties. Filterable properties:  | Field name | Type | Operators | | ---------- | ---- | --------- | | `Abbreviation` | String | `eq, neq, like, in` | | `Active` | Boolean | `eq, neq` | | `AssetClassCode` | String | `eq, neq, like, in` | | `CategoryCode` | String | `eq, neq, like, in` | | `CategoryId` | Int32? | `eq, neq, in, lt, gt, leq, geq` | | `CategoryName` | String | `eq, neq, like, in` | | `ChildId` | Guid | `eq, neq, in` | | `ChildName` | String | `eq, neq, like, in` | | `ChildType` | GroupTypeCodes | `eq, neq, in` | | `CorporationAbbreviation` | String | `eq, neq, like, in` | | `CorporationId` | Guid | `eq, neq, in` | | `CorporationName` | String | `eq, neq, like, in` | | `Created` | DateTime | `eq, neq, in, lt, gt, leq, geq` | | `IsCollectorDependentSystem` | Boolean | `eq, neq` | | `IsPaused` | Boolean | `eq, neq` | | `LocationAbbreviation` | String | `eq, neq, like, in` | | `LocationId` | Guid | `eq, neq, in` | | `LocationName` | String | `eq, neq, like, in` | | `Name` | String | `eq, neq, like, in` | | `SizeCode` | String | `eq, neq, like, in` | | `SizeId` | Int32? | `eq, neq, in, lt, gt, leq, geq` | | `SizeName` | String | `eq, neq, like, in` | | `TreeItemType` | GroupTypeCodes | `eq, neq, in` | | `TypeCode` | String | `eq, neq, like, in` | | `TypeId` | Int32 | `eq, neq, in, lt, gt, leq, geq` | | `TypeName` | String | `eq, neq, like, in` |
        :param int page: Results page. 1-based (1 returns the first page, 0 is invalid).
        :param int page_limit: Number of items to return per page.
        :param str order_by: Allows sorting response items by multiple fields. Sortable properties: | Field name | Type | | ---------- | ---- | | `Abbreviation` | String | | `CategoryCode` | String | | `CategoryName` | String | | `CorporationName` | String | | `Created` | DateTime | | `LocationName` | String | | `Name` | String | | `SizeCode` | String | | `SizeName` | String | | `TypeCode` | String | | `TypeName` | String |
