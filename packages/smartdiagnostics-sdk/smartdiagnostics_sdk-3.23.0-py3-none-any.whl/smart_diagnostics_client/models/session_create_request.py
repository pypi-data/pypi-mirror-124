...
class SessionCreateRequest(object):
    ...
    def __init__(self, system_id=None, custom_filter_ids=None, indicator_types=None, measure_ofs=None, group_ids=None, selected_indicator_ids=None, selected_point=None, time_range=None):  # noqa: E501
