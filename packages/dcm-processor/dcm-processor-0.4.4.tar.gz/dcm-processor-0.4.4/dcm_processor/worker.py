...
def process_virtualenv(config):
  ...
  if not name is None:
    ...
    subprocess.run([binary, "-m", "pip", "install", "pymongo"] + "--trusted-host pypi.python.org --trusted-host pypi.org --trusted-host files.pythonhosted.org --default-timeout 100".split())
