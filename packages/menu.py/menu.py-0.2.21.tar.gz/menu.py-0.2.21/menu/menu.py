...
selection_delay = 0.001 # 0.22 seems best
...
class menu(object):
    ...
    def generate_selection(self, page_name, menu_items:list, menu_text:list = None, theme:str = None):
        ...
        while not k.is_pressed('enter'):
            if k.is_pressed('s'):
                try:
                    choice += 1
                    return self.generate_selection2(page_name, menu_items, menu_text, theme)
                except:
                    print('excepted'), sleep(30)
                    return
            elif k.is_pressed('w'):
                try:
                    choice -= 1
    ...
    def generate_selection2(self, page_name, menu_items:list, menu_text:list = None, theme:str = None):
