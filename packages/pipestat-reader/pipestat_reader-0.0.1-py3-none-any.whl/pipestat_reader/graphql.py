...
class PipestatReader(dict):
    def __init__(self, pipestat_managers: List[pipestat.PipestatManager]):
        ...
        for namespace, pipestat_manager in list(self.pipestat_managers_dict.items()):
        ...
        for namespace, pipestat_manager in list(self.pipestat_managers_dict.items()):
            ...
            if len(list(relationships.keys())):
    ...
    def query(self) -> type:
        ...
        for namespace in list(self.pipestat_managers_dict.keys()):
            attrs.update(
                {
