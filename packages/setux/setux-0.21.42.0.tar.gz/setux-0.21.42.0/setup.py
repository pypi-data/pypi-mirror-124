...
setup(
    ...
    python_requires='>3.6',
    install_requires = [
        'setux_core>=0.21.42.0',
        'setux_distros>=0.21.42.0',
        'setux_logger>=0.21.42.0',
        'setux_managers>=0.21.42.0',
        'setux_modules>=0.21.42.0',
        'setux_mappings>=0.21.42.0',
        'setux_targets>=0.21.42.0',
    ],
