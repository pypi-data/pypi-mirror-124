...
class AdGroupAd(object):
    ...
    def __init__(self, account_id=None, ad=None, ad_group_id=None, ad_group_name=None, ad_id=None, ad_name=None, ad_style=None, approval_status=None, campaign_id=None, campaign_name=None, disapproval_reason_codes=None, disapproval_reason_description=None, impression_beacon_urls=None, viewable_impression_beacon_urls=None, is_remove_impression_beacon_urls=None, is_remove_viewable_impression_beacon_urls=None, is_remove_third_party_tracking_script_url=None, labels=None, media_id=None, third_party_tracking_script_url=None, third_party_tracking_vendor=None, user_status=None, created_date=None, local_vars_configuration=None):  # noqa: E501
