...
class CampaignServiceCampaignBiddingStrategyType(object):
    ...
    allowable_values = [AUTO, MAXIMIZE_CONVERSIONS, MAXIMIZE_CLICKS, MAXIMIZE_VIEW, MAXIMIZE_VIEABLEIMPRESSIONS, MAX_VCPM, MAX_CPC, MAX_CPV, TARGET_CPA, NONE, UNKNOWN]  # noqa: E501
