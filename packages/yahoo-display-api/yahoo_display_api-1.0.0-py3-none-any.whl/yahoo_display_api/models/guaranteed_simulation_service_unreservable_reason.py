...
class GuaranteedSimulationServiceUnreservableReason(object):
    ...
    allowable_values = [NOT_ENOUGH_DELIVERY_TARGET, OUT_OF_STOCK, OVER_SOV_DAILY_LIMIT, OVER_SOV_WEEKLY_LIMIT, UNKNOWN]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """GuaranteedSimulationServiceUnreservableReason - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GuaranteedSimulationServiceUnreservableReason):
            return False
