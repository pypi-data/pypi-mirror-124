...
class AdGroupAdServiceTextAd(object):
    ...
    def __init__(self, custom_parameters=None, description=None, description2=None, display_url=None, display_url_level=None, final_url=None, smartphone_final_url=None, headline=None, is_remove_smartphone_final_url=None, is_remove_tracking_url=None, tracking_url=None, url=None, local_vars_configuration=None):  # noqa: E501
    ...
    def custom_parameters(self):
        """Gets the custom_parameters of this AdGroupAdServiceTextAd.  # noqa: E501


        :return: The custom_parameters of this AdGroupAdServiceTextAd.  # noqa: E501
    ...
    def custom_parameters(self, custom_parameters):
        """Sets the custom_parameters of this AdGroupAdServiceTextAd.


        :param custom_parameters: The custom_parameters of this AdGroupAdServiceTextAd.  # noqa: E501
    ...
    def display_url_level(self):
        """Gets the display_url_level of this AdGroupAdServiceTextAd.  # noqa: E501


        :return: The display_url_level of this AdGroupAdServiceTextAd.  # noqa: E501
    ...
    def display_url_level(self, display_url_level):
        """Sets the display_url_level of this AdGroupAdServiceTextAd.


        :param display_url_level: The display_url_level of this AdGroupAdServiceTextAd.  # noqa: E501
    ...
    @property
    def final_url(self):
        """Gets the final_url of this AdGroupAdServiceTextAd.  # noqa: E501
        ...
        :return: The final_url of this AdGroupAdServiceTextAd.  # noqa: E501
        :rtype: str
        """
    ...
    def final_url(self, final_url):
        """Sets the final_url of this AdGroupAdServiceTextAd.

        <div lang=\"ja\">最終リンク先URLです。<br> SET時、このフィールドは省略可能となります。<br> ADD時、finalUrlフィールドとurlフィールドは同時に設定することはできず、どちらか片方の設定が必須となります。<br> finalUrlフィールドを設定する場合、smartphoneFinalUrl、trackingUrl、customParametersは任意になります。<br> SET時にurlを指定する場合、このフィールドの値はクリアされます。<br> キャンペーン目的「アプリ訴求」の場合は、このフィールドには以下のURLのみ設定できます。<br> - iOSの場合：itunes.apple.com<br> - Androidの場合：play.google.com </div> <div lang=\"en\">Final URL.<br> This field is optional in SET operation.<br> In ADD operation, finalUrl field and url field cannot be set at the same time, and one of them must be set.<br> If you specify finalUrl, smartphoneFinalUrl, trackingUrl and customParameters will be optional.<br> If url is specified in SET operation, the value in this field will be cleared.<br> If campaignGoal is APP_PROMOTION, only the following URL can be set in this field.<br> - For iOS : itunes.apple.com<br> - For Android : play.google.com </div>   # noqa: E501

        :param final_url: The final_url of this AdGroupAdServiceTextAd.  # noqa: E501
        :type: str
        """
    ...
    def smartphone_final_url(self):
        """Gets the smartphone_final_url of this AdGroupAdServiceTextAd.  # noqa: E501
        ...
        :return: The smartphone_final_url of this AdGroupAdServiceTextAd.  # noqa: E501
        :rtype: str
        """
    ...
    def smartphone_final_url(self, smartphone_final_url):
        """Sets the smartphone_final_url of this AdGroupAdServiceTextAd.

        <div lang=\"ja\">スマートフォン向けURLです。<br> finalUrlを指定するときのみ、任意で指定できます。<br> キャンペーン目的「アプリ訴求」の場合は、ADD、SETのどちらも指定できません。<br> SET時にurlを指定する場合、このフィールドの値はクリアされます。 </div> <div lang=\"en\">Final URL (smartphone).<br> This field can be optionally specified only when specifying finalUrl.<br> Not allowed for ADD and SET when a campaign goal is \"app promotion\".<br> If url is specified in SET operation, the value in this field will be cleared. </div>   # noqa: E501

        :param smartphone_final_url: The smartphone_final_url of this AdGroupAdServiceTextAd.  # noqa: E501
        :type: str
        """
    ...
    def is_remove_smartphone_final_url(self):
        """Gets the is_remove_smartphone_final_url of this AdGroupAdServiceTextAd.  # noqa: E501


        :return: The is_remove_smartphone_final_url of this AdGroupAdServiceTextAd.  # noqa: E501
    ...
    def is_remove_smartphone_final_url(self, is_remove_smartphone_final_url):
        """Sets the is_remove_smartphone_final_url of this AdGroupAdServiceTextAd.


        :param is_remove_smartphone_final_url: The is_remove_smartphone_final_url of this AdGroupAdServiceTextAd.  # noqa: E501
    ...
    def is_remove_tracking_url(self):
        """Gets the is_remove_tracking_url of this AdGroupAdServiceTextAd.  # noqa: E501


        :return: The is_remove_tracking_url of this AdGroupAdServiceTextAd.  # noqa: E501
        :rtype: AdGroupAdServiceIsRemoveFlg
        """
    ...
    def is_remove_tracking_url(self, is_remove_tracking_url):
        """Sets the is_remove_tracking_url of this AdGroupAdServiceTextAd.


        :param is_remove_tracking_url: The is_remove_tracking_url of this AdGroupAdServiceTextAd.  # noqa: E501
        :type: AdGroupAdServiceIsRemoveFlg
        """
    ...
    def tracking_url(self):
        """Gets the tracking_url of this AdGroupAdServiceTextAd.  # noqa: E501
        ...
        :return: The tracking_url of this AdGroupAdServiceTextAd.  # noqa: E501
        :rtype: str
        """
    ...
    def tracking_url(self, tracking_url):
        """Sets the tracking_url of this AdGroupAdServiceTextAd.

        <div lang=\"ja\">トラッキングURLです。<br> ADD時、このフィールドは省略可能となります。<br> ※SET時、こちらが審査中の場合、編集はできません。<br> finalUrlを指定するときのみ、任意で指定できます。<br> SET時にurlを指定する場合、このフィールドの値はクリアされます。 </div> <div lang=\"en\">Tracking URL.<br> This field is optional in ADD operation.<br> *In SET operation, cannot update it when this field is in editorial review.<br> This field can be optionally specified only when specifying finalUrl.<br> If url is specified in SET operation, the value in this field will be cleared. </div>   # noqa: E501

        :param tracking_url: The tracking_url of this AdGroupAdServiceTextAd.  # noqa: E501
        :type: str
        """
