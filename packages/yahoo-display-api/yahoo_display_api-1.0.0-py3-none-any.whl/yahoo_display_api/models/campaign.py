...
class Campaign(object):
    ...
    def __init__(self, account_id=None, app_id=None, app_name=None, budget=None, campaign_bidding_strategy=None, campaign_goal=None, campaign_id=None, campaign_name=None, conversion_optimizer=None, custom_parameters=None, device_os_type=None, end_date=None, feed_id=None, is_remove_tracking_url=None, labels=None, serving_status=None, start_date=None, tracking_url=None, user_status=None, viewable_frequency_cap=None, campaign_delivery_type=None, created_date=None, vendor_name=None, conversion_tracker=None, local_vars_configuration=None):  # noqa: E501
