...
class GuaranteedPreviewServiceMaterialAd(object):
    ...
    def __init__(self, ad_id=None, local_vars_configuration=None):  # noqa: E501
        """GuaranteedPreviewServiceMaterialAd - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def ad_id(self):
        """Gets the ad_id of this GuaranteedPreviewServiceMaterialAd.  # noqa: E501

        <div lang=\"ja\"> 広告IDです。<br> このフィールドは、リクエストの場合は必須です。 </div> <div lang=\"en\"> Ad ID.<br> This field is required in requests. </div>   # noqa: E501

        :return: The ad_id of this GuaranteedPreviewServiceMaterialAd.  # noqa: E501
        :rtype: int
        """
        return self._ad_id
    ...
    def ad_id(self, ad_id):
        """Sets the ad_id of this GuaranteedPreviewServiceMaterialAd.

        <div lang=\"ja\"> 広告IDです。<br> このフィールドは、リクエストの場合は必須です。 </div> <div lang=\"en\"> Ad ID.<br> This field is required in requests. </div>   # noqa: E501

        :param ad_id: The ad_id of this GuaranteedPreviewServiceMaterialAd.  # noqa: E501
        :type: int
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GuaranteedPreviewServiceMaterialAd):
            return False
