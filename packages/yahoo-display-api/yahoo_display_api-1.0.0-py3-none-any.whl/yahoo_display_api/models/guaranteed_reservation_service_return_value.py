...
class GuaranteedReservationServiceReturnValue(object):
    ...
    """
    openapi_types = {
        'values': 'list[GuaranteedReservationServiceValue]'
    }
    ...
    def __init__(self, values=None, local_vars_configuration=None):  # noqa: E501
        """GuaranteedReservationServiceReturnValue - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def values(self):
        """Gets the values of this GuaranteedReservationServiceReturnValue.  # noqa: E501


        :return: The values of this GuaranteedReservationServiceReturnValue.  # noqa: E501
        :rtype: list[GuaranteedReservationServiceValue]
        """
        return self._values

    @values.setter
    def values(self, values):
        """Sets the values of this GuaranteedReservationServiceReturnValue.


        :param values: The values of this GuaranteedReservationServiceReturnValue.  # noqa: E501
        :type: list[GuaranteedReservationServiceValue]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GuaranteedReservationServiceReturnValue):
            return False
