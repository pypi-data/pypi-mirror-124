...
class StatsServiceTargetType(object):
    ...
    allowable_values = [AD_SCHEDULE_TARGET, GEO_TARGET, AGE_TARGET, GENDER_TARGET, SITE_CATEGORY, SITE_RETARGETING, SEARCH_TARGET, PLACEMENT_TARGET, DEVICE_TARGET, AUDIENCE_CATEGORY, PLACEMENT_CATEGORY_DETAIL_TARGET, CONTENTS_TARGET, UNKNOWN]  # noqa: E501
