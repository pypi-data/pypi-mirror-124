...
class GuaranteedInventoryServicePredictionResult(object):
    ...
    def __init__(self, lifetime_budget=None, reach=None, v_imps=None, vcpm=None, viewable_frequency=None, sov_rate=None, local_vars_configuration=None):  # noqa: E501
        """GuaranteedInventoryServicePredictionResult - a model defined in OpenAPI"""  # noqa: E501
    ...
    def lifetime_budget(self):
        """Gets the lifetime_budget of this GuaranteedInventoryServicePredictionResult.  # noqa: E501
        ...
        :return: The lifetime_budget of this GuaranteedInventoryServicePredictionResult.  # noqa: E501
        :rtype: int
        """
    ...
    def lifetime_budget(self, lifetime_budget):
        """Sets the lifetime_budget of this GuaranteedInventoryServicePredictionResult.

        <div lang=\"ja\"> 通期予算です。<br> ※この「通期予算」は、キャンペーンの全期間を通じて消費される予算を意味します。<br> このフィールドは、レスポンスの際に返却されますが、リクエストの際には無視されます。 </div> <div lang=\"en\"> Lifetime budget.<br> * \"lifetime budget\" means the total budget that is spent throughout the entire duration of the campaign.<br> Although this field will be returned in the response, it will be ignored on input. </div>   # noqa: E501

        :param lifetime_budget: The lifetime_budget of this GuaranteedInventoryServicePredictionResult.  # noqa: E501
        :type: int
        """
    ...
    @property
    def reach(self):
        """Gets the reach of this GuaranteedInventoryServicePredictionResult.  # noqa: E501
        ...
        :return: The reach of this GuaranteedInventoryServicePredictionResult.  # noqa: E501
        :rtype: int
        """
        return self._reach
    ...
    def reach(self, reach):
        """Sets the reach of this GuaranteedInventoryServicePredictionResult.

        <div lang=\"ja\"> リーチ数です。<br> このフィールドは、レスポンスの際に返却されますが、リクエストの際には無視されます。 </div> <div lang=\"en\"> Number of reaches.<br> Although this field will be returned in the response, it will be ignored on input. </div>   # noqa: E501

        :param reach: The reach of this GuaranteedInventoryServicePredictionResult.  # noqa: E501
        :type: int
        """
    ...
    @property
    def v_imps(self):
        """Gets the v_imps of this GuaranteedInventoryServicePredictionResult.  # noqa: E501
        ...
        :return: The v_imps of this GuaranteedInventoryServicePredictionResult.  # noqa: E501
        :rtype: int
        """
        return self._v_imps
    ...
    def v_imps(self, v_imps):
        """Sets the v_imps of this GuaranteedInventoryServicePredictionResult.

        <div lang=\"ja\"> ビューアブルインプレッションです。<br> このフィールドは、レスポンスの際に返却されますが、リクエストの際には無視されます。 </div> <div lang=\"en\"> Viewable impressions.<br> Although this field will be returned in the response, it will be ignored on input. </div>   # noqa: E501

        :param v_imps: The v_imps of this GuaranteedInventoryServicePredictionResult.  # noqa: E501
        :type: int
        """
    ...
    @property
    def vcpm(self):
        """Gets the vcpm of this GuaranteedInventoryServicePredictionResult.  # noqa: E501
        ...
        :return: The vcpm of this GuaranteedInventoryServicePredictionResult.  # noqa: E501
        :rtype: int
        """
        return self._vcpm
    ...
    @vcpm.setter
    def vcpm(self, vcpm):
        """Sets the vcpm of this GuaranteedInventoryServicePredictionResult.

        <div lang=\"ja\"> vCPMです。<br> このフィールドは、レスポンスの際に返却されますが、リクエストの際には無視されます。 </div> <div lang=\"en\"> VCPM.<br> Although this field will be returned in the response, it will be ignored on input. </div>   # noqa: E501

        :param vcpm: The vcpm of this GuaranteedInventoryServicePredictionResult.  # noqa: E501
        :type: int
        """
    ...
    def viewable_frequency(self):
        """Gets the viewable_frequency of this GuaranteedInventoryServicePredictionResult.  # noqa: E501
        ...
        :return: The viewable_frequency of this GuaranteedInventoryServicePredictionResult.  # noqa: E501
        :rtype: float
        """
    ...
    def viewable_frequency(self, viewable_frequency):
        """Sets the viewable_frequency of this GuaranteedInventoryServicePredictionResult.

        <div lang=\"ja\"> ビューアブルフリークエンシーです。<br> このフィールドは、レスポンスの際に返却されますが、リクエストの際には無視されます。 </div> <div lang=\"en\"> Viewable frequency.<br> Although this field will be returned in the response, it will be ignored on input. </div>   # noqa: E501

        :param viewable_frequency: The viewable_frequency of this GuaranteedInventoryServicePredictionResult.  # noqa: E501
        :type: float
        """
    ...
    @property
    def sov_rate(self):
        """Gets the sov_rate of this GuaranteedInventoryServicePredictionResult.  # noqa: E501
        ...
        :return: The sov_rate of this GuaranteedInventoryServicePredictionResult.  # noqa: E501
        :rtype: float
        """
    ...
    def sov_rate(self, sov_rate):
        """Sets the sov_rate of this GuaranteedInventoryServicePredictionResult.

        <div lang=\"ja\"> SOV（0.0%〜100.0%）です。<br> このフィールドは、レスポンスの際に返却されますが、リクエストの際には無視されます。 </div> <div lang=\"en\"> SOV (0.0% to 100.0%).<br> Although this field will be returned in the response, it will be ignored on input. </div>   # noqa: E501

        :param sov_rate: The sov_rate of this GuaranteedInventoryServicePredictionResult.  # noqa: E501
        :type: float
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GuaranteedInventoryServicePredictionResult):
            return False
