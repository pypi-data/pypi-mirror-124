...
class AdGroupAdServiceSelector(object):
    ...
    def __init__(self, account_id=None, ad_group_ids=None, ad_ids=None, approval_statuses=None, campaign_ids=None, contains_label_id_flg=None, label_ids=None, media_ids=None, number_results=500, start_index=1, user_statuses=None, created_date_range=None, local_vars_configuration=None):  # noqa: E501
