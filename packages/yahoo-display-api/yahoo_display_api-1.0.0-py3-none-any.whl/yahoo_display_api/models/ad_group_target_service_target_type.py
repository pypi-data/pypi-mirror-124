...
class AdGroupTargetServiceTargetType(object):
    ...
    allowable_values = [AD_SCHEDULE_TARGET, GEO_TARGET, AGE_TARGET, GENDER_TARGET, SITE_CATEGORY, SITE_RETARGETING, SEARCH_TARGET, PLACEMENT_TARGET, DEVICE_TARGET, APP_TARGET, OS_TARGET, OS_VERSION_TARGET, AUDIENCE_CATEGORY_TARGET, POSITION_TARGET, PLACEMENT_CATEGORY_TARGET, PLACEMENT_CATEGORY_DETAIL_TARGET, CONTENTS_TARGET, UNKNOWN]  # noqa: E501
