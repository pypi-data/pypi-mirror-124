...
class CampaignServiceSelector(object):
    ...
    def __init__(self, account_id=None, campaign_ids=None, contains_label_id_flg=None, feed_ids=None, label_ids=None, number_results=500, start_index=1, user_statuses=None, created_date_range=None, conversion_group_ids=None, conversion_tracker_ids=None, budget_amount_range=None, local_vars_configuration=None):  # noqa: E501
