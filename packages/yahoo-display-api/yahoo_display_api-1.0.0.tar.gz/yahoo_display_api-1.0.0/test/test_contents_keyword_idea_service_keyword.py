...
from yahoo_display_api.models.contents_keyword_idea_service_keyword import ContentsKeywordIdeaServiceKeyword  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestContentsKeywordIdeaServiceKeyword(unittest.TestCase):
    """ContentsKeywordIdeaServiceKeyword unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test ContentsKeywordIdeaServiceKeyword
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = yahoo_display_api.models.contents_keyword_idea_service_keyword.ContentsKeywordIdeaServiceKeyword()  # noqa: E501
        if include_optional :
            return ContentsKeywordIdeaServiceKeyword(
                keywords = [
                    '0'
                    ], 
                match_type = 'EXACT'
    ...
    def testContentsKeywordIdeaServiceKeyword(self):
        """Test ContentsKeywordIdeaServiceKeyword"""
