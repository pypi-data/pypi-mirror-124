...
from yahoo_display_api.models.guaranteed_inventory_service_inventory_detail_status import GuaranteedInventoryServiceInventoryDetailStatus  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestGuaranteedInventoryServiceInventoryDetailStatus(unittest.TestCase):
    """GuaranteedInventoryServiceInventoryDetailStatus unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test GuaranteedInventoryServiceInventoryDetailStatus
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = yahoo_display_api.models.guaranteed_inventory_service_inventory_detail_status.GuaranteedInventoryServiceInventoryDetailStatus()  # noqa: E501
        if include_optional :
            return GuaranteedInventoryServiceInventoryDetailStatus(
            )
        else :
            return GuaranteedInventoryServiceInventoryDetailStatus(
        )

    def testGuaranteedInventoryServiceInventoryDetailStatus(self):
        """Test GuaranteedInventoryServiceInventoryDetailStatus"""
