...
from yahoo_display_api.models.guaranteed_inventory_service_gender import GuaranteedInventoryServiceGender  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestGuaranteedInventoryServiceGender(unittest.TestCase):
    """GuaranteedInventoryServiceGender unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test GuaranteedInventoryServiceGender
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = yahoo_display_api.models.guaranteed_inventory_service_gender.GuaranteedInventoryServiceGender()  # noqa: E501
        if include_optional :
            return GuaranteedInventoryServiceGender(
            )
        else :
            return GuaranteedInventoryServiceGender(
        )

    def testGuaranteedInventoryServiceGender(self):
        """Test GuaranteedInventoryServiceGender"""
