...
from yahoo_display_api.models.report_definition_service_product_type import ReportDefinitionServiceProductType  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestReportDefinitionServiceProductType(unittest.TestCase):
    """ReportDefinitionServiceProductType unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_display_api.models.report_definition_service_product_type.ReportDefinitionServiceProductType()  # noqa: E501
        if include_optional :
            return ReportDefinitionServiceProductType(
            )
        else :
            return ReportDefinitionServiceProductType(
        )

    def testReportDefinitionServiceProductType(self):
        """Test ReportDefinitionServiceProductType"""
