...
from yahoo_display_api.models.guaranteed_simulation_service_device_app_type import GuaranteedSimulationServiceDeviceAppType  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestGuaranteedSimulationServiceDeviceAppType(unittest.TestCase):
    """GuaranteedSimulationServiceDeviceAppType unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_display_api.models.guaranteed_simulation_service_device_app_type.GuaranteedSimulationServiceDeviceAppType()  # noqa: E501
        if include_optional :
            return GuaranteedSimulationServiceDeviceAppType(
            )
        else :
            return GuaranteedSimulationServiceDeviceAppType(
        )

    def testGuaranteedSimulationServiceDeviceAppType(self):
        """Test GuaranteedSimulationServiceDeviceAppType"""
