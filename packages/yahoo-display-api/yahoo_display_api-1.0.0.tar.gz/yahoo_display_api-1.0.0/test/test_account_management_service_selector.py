...
from yahoo_display_api.models.account_management_service_selector import AccountManagementServiceSelector  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestAccountManagementServiceSelector(unittest.TestCase):
    """AccountManagementServiceSelector unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_display_api.models.account_management_service_selector.AccountManagementServiceSelector()  # noqa: E501
        if include_optional :
            return AccountManagementServiceSelector(
                account_ids = [
                    56
                    ], 
                account_statuses = [
                ...
                auth_type = 'REFERABLE', 
                include_test_account = 'ONLY_TEST', 
                number_results = 1, 
                start_index = 1
            )
        else :
    ...
    def testAccountManagementServiceSelector(self):
        """Test AccountManagementServiceSelector"""
