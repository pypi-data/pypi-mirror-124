...
from yahoo_display_api.models.guaranteed_simulation_service_placement_category_type import GuaranteedSimulationServicePlacementCategoryType  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestGuaranteedSimulationServicePlacementCategoryType(unittest.TestCase):
    """GuaranteedSimulationServicePlacementCategoryType unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test GuaranteedSimulationServicePlacementCategoryType
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = yahoo_display_api.models.guaranteed_simulation_service_placement_category_type.GuaranteedSimulationServicePlacementCategoryType()  # noqa: E501
        if include_optional :
            return GuaranteedSimulationServicePlacementCategoryType(
            )
        else :
            return GuaranteedSimulationServicePlacementCategoryType(
        )

    def testGuaranteedSimulationServicePlacementCategoryType(self):
        """Test GuaranteedSimulationServicePlacementCategoryType"""
