...
from yahoo_display_api.models.guaranteed_simulation_service_age import GuaranteedSimulationServiceAge  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestGuaranteedSimulationServiceAge(unittest.TestCase):
    """GuaranteedSimulationServiceAge unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_display_api.models.guaranteed_simulation_service_age.GuaranteedSimulationServiceAge()  # noqa: E501
        if include_optional :
            return GuaranteedSimulationServiceAge(
            )
        else :
            return GuaranteedSimulationServiceAge(
        )

    def testGuaranteedSimulationServiceAge(self):
        """Test GuaranteedSimulationServiceAge"""
