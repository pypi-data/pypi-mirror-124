...
from yahoo_display_api.models.guaranteed_simulation_service_unreservable_reason import GuaranteedSimulationServiceUnreservableReason  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestGuaranteedSimulationServiceUnreservableReason(unittest.TestCase):
    """GuaranteedSimulationServiceUnreservableReason unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_display_api.models.guaranteed_simulation_service_unreservable_reason.GuaranteedSimulationServiceUnreservableReason()  # noqa: E501
        if include_optional :
            return GuaranteedSimulationServiceUnreservableReason(
            )
        else :
            return GuaranteedSimulationServiceUnreservableReason(
        )

    def testGuaranteedSimulationServiceUnreservableReason(self):
        """Test GuaranteedSimulationServiceUnreservableReason"""
