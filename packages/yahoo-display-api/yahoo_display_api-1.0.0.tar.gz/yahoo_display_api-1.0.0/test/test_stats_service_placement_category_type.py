...
from yahoo_display_api.models.stats_service_placement_category_type import StatsServicePlacementCategoryType  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestStatsServicePlacementCategoryType(unittest.TestCase):
    """StatsServicePlacementCategoryType unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test StatsServicePlacementCategoryType
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = yahoo_display_api.models.stats_service_placement_category_type.StatsServicePlacementCategoryType()  # noqa: E501
        if include_optional :
            return StatsServicePlacementCategoryType(
            )
        else :
            return StatsServicePlacementCategoryType(
        )

    def testStatsServicePlacementCategoryType(self):
        """Test StatsServicePlacementCategoryType"""
