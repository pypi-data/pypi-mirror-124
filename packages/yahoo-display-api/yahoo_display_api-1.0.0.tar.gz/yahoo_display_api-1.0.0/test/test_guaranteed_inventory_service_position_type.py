...
from yahoo_display_api.models.guaranteed_inventory_service_position_type import GuaranteedInventoryServicePositionType  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestGuaranteedInventoryServicePositionType(unittest.TestCase):
    """GuaranteedInventoryServicePositionType unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test GuaranteedInventoryServicePositionType
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = yahoo_display_api.models.guaranteed_inventory_service_position_type.GuaranteedInventoryServicePositionType()  # noqa: E501
        if include_optional :
            return GuaranteedInventoryServicePositionType(
            )
        else :
            return GuaranteedInventoryServicePositionType(
        )

    def testGuaranteedInventoryServicePositionType(self):
        """Test GuaranteedInventoryServicePositionType"""
