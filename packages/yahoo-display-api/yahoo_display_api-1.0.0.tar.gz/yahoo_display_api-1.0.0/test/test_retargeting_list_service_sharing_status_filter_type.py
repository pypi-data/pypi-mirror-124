...
from yahoo_display_api.models.retargeting_list_service_sharing_status_filter_type import RetargetingListServiceSharingStatusFilterType  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestRetargetingListServiceSharingStatusFilterType(unittest.TestCase):
    """RetargetingListServiceSharingStatusFilterType unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_display_api.models.retargeting_list_service_sharing_status_filter_type.RetargetingListServiceSharingStatusFilterType()  # noqa: E501
        if include_optional :
            return RetargetingListServiceSharingStatusFilterType(
            )
        else :
            return RetargetingListServiceSharingStatusFilterType(
        )

    def testRetargetingListServiceSharingStatusFilterType(self):
        """Test RetargetingListServiceSharingStatusFilterType"""
