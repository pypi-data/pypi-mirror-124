...
from yahoo_display_api.models.account_service_is_manager_account import AccountServiceIsManagerAccount  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestAccountServiceIsManagerAccount(unittest.TestCase):
    """AccountServiceIsManagerAccount unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_display_api.models.account_service_is_manager_account.AccountServiceIsManagerAccount()  # noqa: E501
        if include_optional :
            return AccountServiceIsManagerAccount(
            )
        else :
            return AccountServiceIsManagerAccount(
        )

    def testAccountServiceIsManagerAccount(self):
        """Test AccountServiceIsManagerAccount"""
