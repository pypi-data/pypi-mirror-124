...
from yahoo_display_api.models.guaranteed_simulation_service_device_type import GuaranteedSimulationServiceDeviceType  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestGuaranteedSimulationServiceDeviceType(unittest.TestCase):
    """GuaranteedSimulationServiceDeviceType unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_display_api.models.guaranteed_simulation_service_device_type.GuaranteedSimulationServiceDeviceType()  # noqa: E501
        if include_optional :
            return GuaranteedSimulationServiceDeviceType(
            )
        else :
            return GuaranteedSimulationServiceDeviceType(
        )

    def testGuaranteedSimulationServiceDeviceType(self):
        """Test GuaranteedSimulationServiceDeviceType"""
