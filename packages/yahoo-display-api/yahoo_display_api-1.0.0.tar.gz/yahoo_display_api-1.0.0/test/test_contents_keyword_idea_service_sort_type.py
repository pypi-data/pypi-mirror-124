...
from yahoo_display_api.models.contents_keyword_idea_service_sort_type import ContentsKeywordIdeaServiceSortType  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestContentsKeywordIdeaServiceSortType(unittest.TestCase):
    """ContentsKeywordIdeaServiceSortType unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test ContentsKeywordIdeaServiceSortType
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = yahoo_display_api.models.contents_keyword_idea_service_sort_type.ContentsKeywordIdeaServiceSortType()  # noqa: E501
        if include_optional :
            return ContentsKeywordIdeaServiceSortType(
            )
        else :
            return ContentsKeywordIdeaServiceSortType(
        )

    def testContentsKeywordIdeaServiceSortType(self):
        """Test ContentsKeywordIdeaServiceSortType"""
