...
from yahoo_display_api.models.brand_lift_service_get_response import BrandLiftServiceGetResponse  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestBrandLiftServiceGetResponse(unittest.TestCase):
    """BrandLiftServiceGetResponse unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_display_api.models.brand_lift_service_get_response.BrandLiftServiceGetResponse()  # noqa: E501
        if include_optional :
            return BrandLiftServiceGetResponse(
                ...
                rid = '0', 
                rval = yahoo_display_api.models.brand_lift_service_page.BrandLiftServicePage(
                    total_num_entries = 56, 
                    values = [
                        yahoo_display_api.models.brand_lift_service_value.BrandLiftServiceValue(
                            brand_lift = yahoo_display_api.models.brand_lift.BrandLift(
                                account_id = 56, 
                                campaign_id = 56, 
                                brand_lift_id = 56, 
                                questions = [
    ...
    def testBrandLiftServiceGetResponse(self):
        """Test BrandLiftServiceGetResponse"""
