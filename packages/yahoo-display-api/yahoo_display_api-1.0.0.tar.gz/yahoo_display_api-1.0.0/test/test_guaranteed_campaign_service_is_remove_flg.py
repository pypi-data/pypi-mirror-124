...
from yahoo_display_api.models.guaranteed_campaign_service_is_remove_flg import GuaranteedCampaignServiceIsRemoveFlg  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestGuaranteedCampaignServiceIsRemoveFlg(unittest.TestCase):
    """GuaranteedCampaignServiceIsRemoveFlg unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test GuaranteedCampaignServiceIsRemoveFlg
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = yahoo_display_api.models.guaranteed_campaign_service_is_remove_flg.GuaranteedCampaignServiceIsRemoveFlg()  # noqa: E501
        if include_optional :
            return GuaranteedCampaignServiceIsRemoveFlg(
            )
        else :
            return GuaranteedCampaignServiceIsRemoveFlg(
        )

    def testGuaranteedCampaignServiceIsRemoveFlg(self):
        """Test GuaranteedCampaignServiceIsRemoveFlg"""
