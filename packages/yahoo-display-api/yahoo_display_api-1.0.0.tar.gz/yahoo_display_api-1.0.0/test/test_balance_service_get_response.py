...
from yahoo_display_api.models.balance_service_get_response import BalanceServiceGetResponse  # noqa: E501
...
class TestBalanceServiceGetResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_display_api.models.balance_service_get_response.BalanceServiceGetResponse()  # noqa: E501
        if include_optional :
            return BalanceServiceGetResponse(
                ...
                rid = '0', 
                rval = yahoo_display_api.models.balance_service_page.BalanceServicePage(
                    total_num_entries = 56, 
                    values = yahoo_display_api.models.balance_service_value.BalanceServiceValue(
                        balance = yahoo_display_api.models.balance.Balance(
                            account_id = 56, ), 
                        errors = [
                            yahoo_display_api.models.error.Error(
                                code = '0', 
