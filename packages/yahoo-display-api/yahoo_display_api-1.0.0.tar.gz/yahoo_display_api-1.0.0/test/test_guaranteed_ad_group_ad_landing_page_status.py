...
from yahoo_display_api.models.guaranteed_ad_group_ad_landing_page_status import GuaranteedAdGroupAdLandingPageStatus  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestGuaranteedAdGroupAdLandingPageStatus(unittest.TestCase):
    """GuaranteedAdGroupAdLandingPageStatus unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_display_api.models.guaranteed_ad_group_ad_landing_page_status.GuaranteedAdGroupAdLandingPageStatus()  # noqa: E501
        if include_optional :
            return GuaranteedAdGroupAdLandingPageStatus(
            )
        else :
            return GuaranteedAdGroupAdLandingPageStatus(
        )

    def testGuaranteedAdGroupAdLandingPageStatus(self):
        """Test GuaranteedAdGroupAdLandingPageStatus"""
