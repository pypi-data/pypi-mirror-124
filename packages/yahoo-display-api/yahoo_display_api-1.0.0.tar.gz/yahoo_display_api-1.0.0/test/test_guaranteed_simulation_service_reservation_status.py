...
from yahoo_display_api.models.guaranteed_simulation_service_reservation_status import GuaranteedSimulationServiceReservationStatus  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestGuaranteedSimulationServiceReservationStatus(unittest.TestCase):
    """GuaranteedSimulationServiceReservationStatus unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_display_api.models.guaranteed_simulation_service_reservation_status.GuaranteedSimulationServiceReservationStatus()  # noqa: E501
        if include_optional :
            return GuaranteedSimulationServiceReservationStatus(
            )
        else :
            return GuaranteedSimulationServiceReservationStatus(
        )

    def testGuaranteedSimulationServiceReservationStatus(self):
        """Test GuaranteedSimulationServiceReservationStatus"""
