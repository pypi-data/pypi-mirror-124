...
from yahoo_display_api.models.retargeting_list_service_selector import RetargetingListServiceSelector  # noqa: E501
...
class TestRetargetingListServiceSelector(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_display_api.models.retargeting_list_service_selector.RetargetingListServiceSelector()  # noqa: E501
        if include_optional :
            return RetargetingListServiceSelector(
                ...
                sharing_status_filter_type = 'ALL'
            )
        else :
            return RetargetingListServiceSelector(
                account_id = 56,
