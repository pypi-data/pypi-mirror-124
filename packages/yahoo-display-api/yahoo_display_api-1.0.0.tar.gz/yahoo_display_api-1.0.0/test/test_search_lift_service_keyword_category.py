...
from yahoo_display_api.models.search_lift_service_keyword_category import SearchLiftServiceKeywordCategory  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestSearchLiftServiceKeywordCategory(unittest.TestCase):
    """SearchLiftServiceKeywordCategory unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_display_api.models.search_lift_service_keyword_category.SearchLiftServiceKeywordCategory()  # noqa: E501
        if include_optional :
            return SearchLiftServiceKeywordCategory(
            )
        else :
            return SearchLiftServiceKeywordCategory(
        )

    def testSearchLiftServiceKeywordCategory(self):
        """Test SearchLiftServiceKeywordCategory"""
