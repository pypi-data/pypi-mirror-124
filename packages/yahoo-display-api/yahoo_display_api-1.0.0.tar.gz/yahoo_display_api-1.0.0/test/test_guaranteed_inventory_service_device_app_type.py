...
from yahoo_display_api.models.guaranteed_inventory_service_device_app_type import GuaranteedInventoryServiceDeviceAppType  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestGuaranteedInventoryServiceDeviceAppType(unittest.TestCase):
    """GuaranteedInventoryServiceDeviceAppType unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test GuaranteedInventoryServiceDeviceAppType
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = yahoo_display_api.models.guaranteed_inventory_service_device_app_type.GuaranteedInventoryServiceDeviceAppType()  # noqa: E501
        if include_optional :
            return GuaranteedInventoryServiceDeviceAppType(
            )
        else :
            return GuaranteedInventoryServiceDeviceAppType(
        )

    def testGuaranteedInventoryServiceDeviceAppType(self):
        """Test GuaranteedInventoryServiceDeviceAppType"""
