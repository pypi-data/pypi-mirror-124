...
from yahoo_display_api.models.guaranteed_inventory_service_age_target import GuaranteedInventoryServiceAgeTarget  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestGuaranteedInventoryServiceAgeTarget(unittest.TestCase):
    """GuaranteedInventoryServiceAgeTarget unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test GuaranteedInventoryServiceAgeTarget
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = yahoo_display_api.models.guaranteed_inventory_service_age_target.GuaranteedInventoryServiceAgeTarget()  # noqa: E501
        if include_optional :
            return GuaranteedInventoryServiceAgeTarget(
                age = 'GT_RANGE13_14'
            )
        else :
            return GuaranteedInventoryServiceAgeTarget(
    ...
    def testGuaranteedInventoryServiceAgeTarget(self):
        """Test GuaranteedInventoryServiceAgeTarget"""
