...
from yahoo_display_api.models.guaranteed_simulation_service_price_type import GuaranteedSimulationServicePriceType  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestGuaranteedSimulationServicePriceType(unittest.TestCase):
    """GuaranteedSimulationServicePriceType unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_display_api.models.guaranteed_simulation_service_price_type.GuaranteedSimulationServicePriceType()  # noqa: E501
        if include_optional :
            return GuaranteedSimulationServicePriceType(
            )
        else :
            return GuaranteedSimulationServicePriceType(
        )

    def testGuaranteedSimulationServicePriceType(self):
        """Test GuaranteedSimulationServicePriceType"""
