...
from yahoo_display_api.models.guaranteed_inventory_service_unreservable_reason import GuaranteedInventoryServiceUnreservableReason  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestGuaranteedInventoryServiceUnreservableReason(unittest.TestCase):
    """GuaranteedInventoryServiceUnreservableReason unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test GuaranteedInventoryServiceUnreservableReason
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = yahoo_display_api.models.guaranteed_inventory_service_unreservable_reason.GuaranteedInventoryServiceUnreservableReason()  # noqa: E501
        if include_optional :
            return GuaranteedInventoryServiceUnreservableReason(
            )
        else :
            return GuaranteedInventoryServiceUnreservableReason(
        )

    def testGuaranteedInventoryServiceUnreservableReason(self):
        """Test GuaranteedInventoryServiceUnreservableReason"""
