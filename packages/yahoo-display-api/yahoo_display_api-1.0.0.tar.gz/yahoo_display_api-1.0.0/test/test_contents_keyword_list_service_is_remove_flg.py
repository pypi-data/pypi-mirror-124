...
from yahoo_display_api.models.contents_keyword_list_service_is_remove_flg import ContentsKeywordListServiceIsRemoveFlg  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestContentsKeywordListServiceIsRemoveFlg(unittest.TestCase):
    """ContentsKeywordListServiceIsRemoveFlg unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test ContentsKeywordListServiceIsRemoveFlg
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = yahoo_display_api.models.contents_keyword_list_service_is_remove_flg.ContentsKeywordListServiceIsRemoveFlg()  # noqa: E501
        if include_optional :
            return ContentsKeywordListServiceIsRemoveFlg(
            )
        else :
            return ContentsKeywordListServiceIsRemoveFlg(
        )

    def testContentsKeywordListServiceIsRemoveFlg(self):
        """Test ContentsKeywordListServiceIsRemoveFlg"""
