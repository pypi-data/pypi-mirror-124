...
from yahoo_display_api.models.ad_group_service_bidding_value_cpc_range import AdGroupServiceBiddingValueCpcRange  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestAdGroupServiceBiddingValueCpcRange(unittest.TestCase):
    """AdGroupServiceBiddingValueCpcRange unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test AdGroupServiceBiddingValueCpcRange
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = yahoo_display_api.models.ad_group_service_bidding_value_cpc_range.AdGroupServiceBiddingValueCpcRange()  # noqa: E501
        if include_optional :
            return AdGroupServiceBiddingValueCpcRange(
                min = 56, 
                max = 56
            )
        else :
    ...
    def testAdGroupServiceBiddingValueCpcRange(self):
        """Test AdGroupServiceBiddingValueCpcRange"""
