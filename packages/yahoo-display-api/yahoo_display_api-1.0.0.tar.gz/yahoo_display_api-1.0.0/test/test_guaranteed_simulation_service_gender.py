...
from yahoo_display_api.models.guaranteed_simulation_service_gender import GuaranteedSimulationServiceGender  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestGuaranteedSimulationServiceGender(unittest.TestCase):
    """GuaranteedSimulationServiceGender unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_display_api.models.guaranteed_simulation_service_gender.GuaranteedSimulationServiceGender()  # noqa: E501
        if include_optional :
            return GuaranteedSimulationServiceGender(
            )
        else :
            return GuaranteedSimulationServiceGender(
        )

    def testGuaranteedSimulationServiceGender(self):
        """Test GuaranteedSimulationServiceGender"""
