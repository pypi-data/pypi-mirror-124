...
from yahoo_display_api.models.campaign_service_budget_amount_range import CampaignServiceBudgetAmountRange  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestCampaignServiceBudgetAmountRange(unittest.TestCase):
    """CampaignServiceBudgetAmountRange unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test CampaignServiceBudgetAmountRange
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = yahoo_display_api.models.campaign_service_budget_amount_range.CampaignServiceBudgetAmountRange()  # noqa: E501
        if include_optional :
            return CampaignServiceBudgetAmountRange(
                min = 56, 
                max = 56
            )
        else :
    ...
    def testCampaignServiceBudgetAmountRange(self):
        """Test CampaignServiceBudgetAmountRange"""
