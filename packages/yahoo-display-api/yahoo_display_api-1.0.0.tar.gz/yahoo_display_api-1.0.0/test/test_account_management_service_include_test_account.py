...
from yahoo_display_api.models.account_management_service_include_test_account import AccountManagementServiceIncludeTestAccount  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestAccountManagementServiceIncludeTestAccount(unittest.TestCase):
    """AccountManagementServiceIncludeTestAccount unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_display_api.models.account_management_service_include_test_account.AccountManagementServiceIncludeTestAccount()  # noqa: E501
        if include_optional :
            return AccountManagementServiceIncludeTestAccount(
            )
        else :
            return AccountManagementServiceIncludeTestAccount(
        )

    def testAccountManagementServiceIncludeTestAccount(self):
        """Test AccountManagementServiceIncludeTestAccount"""
