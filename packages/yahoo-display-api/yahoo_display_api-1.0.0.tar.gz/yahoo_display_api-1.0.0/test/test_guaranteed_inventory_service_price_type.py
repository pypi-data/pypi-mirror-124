...
from yahoo_display_api.models.guaranteed_inventory_service_price_type import GuaranteedInventoryServicePriceType  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestGuaranteedInventoryServicePriceType(unittest.TestCase):
    """GuaranteedInventoryServicePriceType unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test GuaranteedInventoryServicePriceType
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = yahoo_display_api.models.guaranteed_inventory_service_price_type.GuaranteedInventoryServicePriceType()  # noqa: E501
        if include_optional :
            return GuaranteedInventoryServicePriceType(
            )
        else :
            return GuaranteedInventoryServicePriceType(
        )

    def testGuaranteedInventoryServicePriceType(self):
        """Test GuaranteedInventoryServicePriceType"""
