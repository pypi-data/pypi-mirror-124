...
from yahoo_display_api.models.guaranteed_reservation_service_conversion_tracker import GuaranteedReservationServiceConversionTracker  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestGuaranteedReservationServiceConversionTracker(unittest.TestCase):
    """GuaranteedReservationServiceConversionTracker unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test GuaranteedReservationServiceConversionTracker
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = yahoo_display_api.models.guaranteed_reservation_service_conversion_tracker.GuaranteedReservationServiceConversionTracker()  # noqa: E501
        if include_optional :
            return GuaranteedReservationServiceConversionTracker(
    ...
    def testGuaranteedReservationServiceConversionTracker(self):
        """Test GuaranteedReservationServiceConversionTracker"""
