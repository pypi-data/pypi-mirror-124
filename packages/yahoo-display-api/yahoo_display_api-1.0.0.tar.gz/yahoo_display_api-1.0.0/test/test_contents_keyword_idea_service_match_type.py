...
from yahoo_display_api.models.contents_keyword_idea_service_match_type import ContentsKeywordIdeaServiceMatchType  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestContentsKeywordIdeaServiceMatchType(unittest.TestCase):
    """ContentsKeywordIdeaServiceMatchType unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test ContentsKeywordIdeaServiceMatchType
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = yahoo_display_api.models.contents_keyword_idea_service_match_type.ContentsKeywordIdeaServiceMatchType()  # noqa: E501
        if include_optional :
            return ContentsKeywordIdeaServiceMatchType(
            )
        else :
            return ContentsKeywordIdeaServiceMatchType(
        )

    def testContentsKeywordIdeaServiceMatchType(self):
        """Test ContentsKeywordIdeaServiceMatchType"""
