...
from yahoo_display_api.models.account_management_service_is_test_account import AccountManagementServiceIsTestAccount  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestAccountManagementServiceIsTestAccount(unittest.TestCase):
    """AccountManagementServiceIsTestAccount unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_display_api.models.account_management_service_is_test_account.AccountManagementServiceIsTestAccount()  # noqa: E501
        if include_optional :
            return AccountManagementServiceIsTestAccount(
            )
        else :
            return AccountManagementServiceIsTestAccount(
        )

    def testAccountManagementServiceIsTestAccount(self):
        """Test AccountManagementServiceIsTestAccount"""
