...
from yahoo_display_api.api.balance_service_api import BalanceServiceApi  # noqa: E501
...
class TestBalanceServiceApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = yahoo_display_api.api.balance_service_api.BalanceServiceApi()  # noqa: E501
