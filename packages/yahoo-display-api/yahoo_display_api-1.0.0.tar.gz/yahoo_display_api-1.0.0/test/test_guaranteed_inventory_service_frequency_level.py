...
from yahoo_display_api.models.guaranteed_inventory_service_frequency_level import GuaranteedInventoryServiceFrequencyLevel  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestGuaranteedInventoryServiceFrequencyLevel(unittest.TestCase):
    """GuaranteedInventoryServiceFrequencyLevel unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test GuaranteedInventoryServiceFrequencyLevel
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = yahoo_display_api.models.guaranteed_inventory_service_frequency_level.GuaranteedInventoryServiceFrequencyLevel()  # noqa: E501
        if include_optional :
            return GuaranteedInventoryServiceFrequencyLevel(
            )
        else :
            return GuaranteedInventoryServiceFrequencyLevel(
        )

    def testGuaranteedInventoryServiceFrequencyLevel(self):
        """Test GuaranteedInventoryServiceFrequencyLevel"""
