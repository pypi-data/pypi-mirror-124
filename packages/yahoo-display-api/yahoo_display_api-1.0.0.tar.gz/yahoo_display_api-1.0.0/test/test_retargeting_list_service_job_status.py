...
from yahoo_display_api.models.retargeting_list_service_job_status import RetargetingListServiceJobStatus  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestRetargetingListServiceJobStatus(unittest.TestCase):
    """RetargetingListServiceJobStatus unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_display_api.models.retargeting_list_service_job_status.RetargetingListServiceJobStatus()  # noqa: E501
        if include_optional :
            return RetargetingListServiceJobStatus(
            )
        else :
            return RetargetingListServiceJobStatus(
        )

    def testRetargetingListServiceJobStatus(self):
        """Test RetargetingListServiceJobStatus"""
