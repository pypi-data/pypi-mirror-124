...
from yahoo_display_api.models.account_service_include_manager_account import AccountServiceIncludeManagerAccount  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestAccountServiceIncludeManagerAccount(unittest.TestCase):
    """AccountServiceIncludeManagerAccount unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_display_api.models.account_service_include_manager_account.AccountServiceIncludeManagerAccount()  # noqa: E501
        if include_optional :
            return AccountServiceIncludeManagerAccount(
            )
        else :
            return AccountServiceIncludeManagerAccount(
        )

    def testAccountServiceIncludeManagerAccount(self):
        """Test AccountServiceIncludeManagerAccount"""
