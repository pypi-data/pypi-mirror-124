...
from yahoo_display_api.models.ad_group_service_operation import AdGroupServiceOperation  # noqa: E501
...
class TestAdGroupServiceOperation(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_display_api.models.ad_group_service_operation.AdGroupServiceOperation()  # noqa: E501
        if include_optional :
            return AdGroupServiceOperation(
                account_id = 56, 
                operand = [
                    yahoo_display_api.models.ad_group.AdGroup(
                        account_id = 56, 
