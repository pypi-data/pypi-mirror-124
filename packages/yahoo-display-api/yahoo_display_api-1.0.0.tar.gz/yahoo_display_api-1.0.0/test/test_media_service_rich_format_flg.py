...
from yahoo_display_api.models.media_service_rich_format_flg import MediaServiceRichFormatFlg  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestMediaServiceRichFormatFlg(unittest.TestCase):
    """MediaServiceRichFormatFlg unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_display_api.models.media_service_rich_format_flg.MediaServiceRichFormatFlg()  # noqa: E501
        if include_optional :
            return MediaServiceRichFormatFlg(
            )
        else :
            return MediaServiceRichFormatFlg(
        )

    def testMediaServiceRichFormatFlg(self):
        """Test MediaServiceRichFormatFlg"""
