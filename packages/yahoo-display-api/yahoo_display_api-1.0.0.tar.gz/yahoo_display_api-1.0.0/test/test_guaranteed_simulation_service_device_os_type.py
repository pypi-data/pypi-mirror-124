...
from yahoo_display_api.models.guaranteed_simulation_service_device_os_type import GuaranteedSimulationServiceDeviceOsType  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestGuaranteedSimulationServiceDeviceOsType(unittest.TestCase):
    """GuaranteedSimulationServiceDeviceOsType unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_display_api.models.guaranteed_simulation_service_device_os_type.GuaranteedSimulationServiceDeviceOsType()  # noqa: E501
        if include_optional :
            return GuaranteedSimulationServiceDeviceOsType(
            )
        else :
            return GuaranteedSimulationServiceDeviceOsType(
        )

    def testGuaranteedSimulationServiceDeviceOsType(self):
        """Test GuaranteedSimulationServiceDeviceOsType"""
