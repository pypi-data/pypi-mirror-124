...
from yahoo_display_api.models.account_management_service_enterprise_type import AccountManagementServiceEnterpriseType  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestAccountManagementServiceEnterpriseType(unittest.TestCase):
    """AccountManagementServiceEnterpriseType unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_display_api.models.account_management_service_enterprise_type.AccountManagementServiceEnterpriseType()  # noqa: E501
        if include_optional :
            return AccountManagementServiceEnterpriseType(
            )
        else :
            return AccountManagementServiceEnterpriseType(
        )

    def testAccountManagementServiceEnterpriseType(self):
        """Test AccountManagementServiceEnterpriseType"""
