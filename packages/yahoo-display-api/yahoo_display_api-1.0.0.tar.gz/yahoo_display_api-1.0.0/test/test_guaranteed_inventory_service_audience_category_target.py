...
from yahoo_display_api.models.guaranteed_inventory_service_audience_category_target import GuaranteedInventoryServiceAudienceCategoryTarget  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestGuaranteedInventoryServiceAudienceCategoryTarget(unittest.TestCase):
    """GuaranteedInventoryServiceAudienceCategoryTarget unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test GuaranteedInventoryServiceAudienceCategoryTarget
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = yahoo_display_api.models.guaranteed_inventory_service_audience_category_target.GuaranteedInventoryServiceAudienceCategoryTarget()  # noqa: E501
        if include_optional :
            return GuaranteedInventoryServiceAudienceCategoryTarget(
    ...
    def testGuaranteedInventoryServiceAudienceCategoryTarget(self):
        """Test GuaranteedInventoryServiceAudienceCategoryTarget"""
