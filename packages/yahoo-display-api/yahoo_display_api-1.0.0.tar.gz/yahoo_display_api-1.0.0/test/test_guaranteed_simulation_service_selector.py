...
from yahoo_display_api.models.guaranteed_simulation_service_selector import GuaranteedSimulationServiceSelector  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestGuaranteedSimulationServiceSelector(unittest.TestCase):
    """GuaranteedSimulationServiceSelector unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_display_api.models.guaranteed_simulation_service_selector.GuaranteedSimulationServiceSelector()  # noqa: E501
        if include_optional :
            return GuaranteedSimulationServiceSelector(
                account_id = 56, 
                guaranteed_simulation_ids = [
                    56
                    ], 
                number_results = 1, 
                start_index = 1
    ...
    def testGuaranteedSimulationServiceSelector(self):
        """Test GuaranteedSimulationServiceSelector"""
