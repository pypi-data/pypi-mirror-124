...
from yahoo_display_api.models.campaign_service_operation import CampaignServiceOperation  # noqa: E501
...
class TestCampaignServiceOperation(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_display_api.models.campaign_service_operation.CampaignServiceOperation()  # noqa: E501
        if include_optional :
            return CampaignServiceOperation(
                account_id = 56, 
                operand = [
                    yahoo_display_api.models.campaign.Campaign(
                        account_id = 56, 
                        app_id = '0', 
                        app_name = '0', 
