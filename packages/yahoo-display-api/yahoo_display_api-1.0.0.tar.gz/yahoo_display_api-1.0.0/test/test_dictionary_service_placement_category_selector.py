...
from yahoo_display_api.models.dictionary_service_placement_category_selector import DictionaryServicePlacementCategorySelector  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestDictionaryServicePlacementCategorySelector(unittest.TestCase):
    """DictionaryServicePlacementCategorySelector unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test DictionaryServicePlacementCategorySelector
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = yahoo_display_api.models.dictionary_service_placement_category_selector.DictionaryServicePlacementCategorySelector()  # noqa: E501
        if include_optional :
            return DictionaryServicePlacementCategorySelector(
                placement_category_list_ids = [
                    56
                    ]
            )
        else :
    ...
    def testDictionaryServicePlacementCategorySelector(self):
        """Test DictionaryServicePlacementCategorySelector"""
