...
from yahoo_display_api.models.feed_item_service_mutate_response import FeedItemServiceMutateResponse  # noqa: E501
...
class TestFeedItemServiceMutateResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_display_api.models.feed_item_service_mutate_response.FeedItemServiceMutateResponse()  # noqa: E501
        if include_optional :
            return FeedItemServiceMutateResponse(
                ...
                rid = '0', 
                rval = yahoo_display_api.models.feed_item_service_return_value.FeedItemServiceReturnValue(
                    values = [
                        yahoo_display_api.models.feed_item_service_value.FeedItemServiceValue(
                            errors = [
                                yahoo_display_api.models.error.Error(
                                    code = '0', 
                                    message = '0', 
