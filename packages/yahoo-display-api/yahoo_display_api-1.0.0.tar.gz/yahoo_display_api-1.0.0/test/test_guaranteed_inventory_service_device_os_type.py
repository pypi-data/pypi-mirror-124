...
from yahoo_display_api.models.guaranteed_inventory_service_device_os_type import GuaranteedInventoryServiceDeviceOsType  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestGuaranteedInventoryServiceDeviceOsType(unittest.TestCase):
    """GuaranteedInventoryServiceDeviceOsType unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test GuaranteedInventoryServiceDeviceOsType
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = yahoo_display_api.models.guaranteed_inventory_service_device_os_type.GuaranteedInventoryServiceDeviceOsType()  # noqa: E501
        if include_optional :
            return GuaranteedInventoryServiceDeviceOsType(
            )
        else :
            return GuaranteedInventoryServiceDeviceOsType(
        )

    def testGuaranteedInventoryServiceDeviceOsType(self):
        """Test GuaranteedInventoryServiceDeviceOsType"""
