...
from yahoo_display_api.models.guaranteed_ad_group_ad_service_user_status import GuaranteedAdGroupAdServiceUserStatus  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestGuaranteedAdGroupAdServiceUserStatus(unittest.TestCase):
    """GuaranteedAdGroupAdServiceUserStatus unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_display_api.models.guaranteed_ad_group_ad_service_user_status.GuaranteedAdGroupAdServiceUserStatus()  # noqa: E501
        if include_optional :
            return GuaranteedAdGroupAdServiceUserStatus(
            )
        else :
            return GuaranteedAdGroupAdServiceUserStatus(
        )

    def testGuaranteedAdGroupAdServiceUserStatus(self):
        """Test GuaranteedAdGroupAdServiceUserStatus"""
