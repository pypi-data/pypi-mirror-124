...
from yahoo_display_api.models.guaranteed_ad_group_ad_service_ad_style import GuaranteedAdGroupAdServiceAdStyle  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestGuaranteedAdGroupAdServiceAdStyle(unittest.TestCase):
    """GuaranteedAdGroupAdServiceAdStyle unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_display_api.models.guaranteed_ad_group_ad_service_ad_style.GuaranteedAdGroupAdServiceAdStyle()  # noqa: E501
        if include_optional :
            return GuaranteedAdGroupAdServiceAdStyle(
            )
        else :
            return GuaranteedAdGroupAdServiceAdStyle(
        )

    def testGuaranteedAdGroupAdServiceAdStyle(self):
        """Test GuaranteedAdGroupAdServiceAdStyle"""
