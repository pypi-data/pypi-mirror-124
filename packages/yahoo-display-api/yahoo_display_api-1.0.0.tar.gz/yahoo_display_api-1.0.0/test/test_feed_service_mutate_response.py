...
from yahoo_display_api.models.feed_service_mutate_response import FeedServiceMutateResponse  # noqa: E501
...
class TestFeedServiceMutateResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_display_api.models.feed_service_mutate_response.FeedServiceMutateResponse()  # noqa: E501
        if include_optional :
            return FeedServiceMutateResponse(
                ...
                rid = '0', 
                rval = yahoo_display_api.models.feed_service_return_value.FeedServiceReturnValue(
                    values = [
                        yahoo_display_api.models.feed_service_value.FeedServiceValue(
                            feed = yahoo_display_api.models.feed.Feed(
                                account_id = 56, 
                                feed_id = 56, 
                                feed_name = '0', 
                                item_count = 56, 
                            ...
                            upload_limits = [
                                yahoo_display_api.models.feed_service_upload_limit.FeedServiceUploadLimit(
