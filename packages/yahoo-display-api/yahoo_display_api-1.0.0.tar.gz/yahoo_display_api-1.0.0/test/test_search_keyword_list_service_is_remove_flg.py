...
from yahoo_display_api.models.search_keyword_list_service_is_remove_flg import SearchKeywordListServiceIsRemoveFlg  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestSearchKeywordListServiceIsRemoveFlg(unittest.TestCase):
    """SearchKeywordListServiceIsRemoveFlg unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_display_api.models.search_keyword_list_service_is_remove_flg.SearchKeywordListServiceIsRemoveFlg()  # noqa: E501
        if include_optional :
            return SearchKeywordListServiceIsRemoveFlg(
            )
        else :
            return SearchKeywordListServiceIsRemoveFlg(
        )

    def testSearchKeywordListServiceIsRemoveFlg(self):
        """Test SearchKeywordListServiceIsRemoveFlg"""
