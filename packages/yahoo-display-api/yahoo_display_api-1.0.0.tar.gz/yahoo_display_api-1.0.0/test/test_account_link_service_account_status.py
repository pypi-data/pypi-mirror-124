...
from yahoo_display_api.models.account_link_service_account_status import AccountLinkServiceAccountStatus  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestAccountLinkServiceAccountStatus(unittest.TestCase):
    """AccountLinkServiceAccountStatus unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_display_api.models.account_link_service_account_status.AccountLinkServiceAccountStatus()  # noqa: E501
        if include_optional :
            return AccountLinkServiceAccountStatus(
            )
        else :
            return AccountLinkServiceAccountStatus(
        )

    def testAccountLinkServiceAccountStatus(self):
        """Test AccountLinkServiceAccountStatus"""
