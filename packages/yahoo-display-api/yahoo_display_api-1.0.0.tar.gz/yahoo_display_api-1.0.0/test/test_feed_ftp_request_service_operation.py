...
from yahoo_display_api.models.feed_ftp_request_service_operation import FeedFtpRequestServiceOperation  # noqa: E501
...
class TestFeedFtpRequestServiceOperation(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_display_api.models.feed_ftp_request_service_operation.FeedFtpRequestServiceOperation()  # noqa: E501
        if include_optional :
            return FeedFtpRequestServiceOperation(
                account_id = 56, 
                operand = [
                    yahoo_display_api.models.feed_ftp_request.FeedFtpRequest(
                        feed_id = 56, )
                    ]
            )
        else :
