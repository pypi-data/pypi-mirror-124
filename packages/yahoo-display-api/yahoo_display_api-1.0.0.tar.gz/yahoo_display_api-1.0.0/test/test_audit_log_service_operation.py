...
from yahoo_display_api.models.audit_log_service_operation import AuditLogServiceOperation  # noqa: E501
...
class TestAuditLogServiceOperation(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_display_api.models.audit_log_service_operation.AuditLogServiceOperation()  # noqa: E501
        if include_optional :
            return AuditLogServiceOperation(
                account_id = 56, 
                operand = [
                    yahoo_display_api.models.audit_log_service_job.AuditLogServiceJob(
                        account_id = 56, 
