...
from yahoo_display_api.models.account_authority_service_get_response import AccountAuthorityServiceGetResponse  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestAccountAuthorityServiceGetResponse(unittest.TestCase):
    """AccountAuthorityServiceGetResponse unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_display_api.models.account_authority_service_get_response.AccountAuthorityServiceGetResponse()  # noqa: E501
        if include_optional :
            return AccountAuthorityServiceGetResponse(
                ...
                rid = '0', 
                rval = yahoo_display_api.models.account_authority_service_page.AccountAuthorityServicePage(
                    total_num_entries = 56, 
                    values = [
                        yahoo_display_api.models.account_authority_service_value.AccountAuthorityServiceValue(
                            account_authority = yahoo_display_api.models.account_authority.AccountAuthority(
                                account_id = 56, 
                                authorities = [
                                    '0'
                                    ], ), 
    ...
    def testAccountAuthorityServiceGetResponse(self):
        """Test AccountAuthorityServiceGetResponse"""
