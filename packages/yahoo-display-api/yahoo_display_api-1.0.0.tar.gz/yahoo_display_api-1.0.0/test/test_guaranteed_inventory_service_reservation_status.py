...
from yahoo_display_api.models.guaranteed_inventory_service_reservation_status import GuaranteedInventoryServiceReservationStatus  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestGuaranteedInventoryServiceReservationStatus(unittest.TestCase):
    """GuaranteedInventoryServiceReservationStatus unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test GuaranteedInventoryServiceReservationStatus
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = yahoo_display_api.models.guaranteed_inventory_service_reservation_status.GuaranteedInventoryServiceReservationStatus()  # noqa: E501
        if include_optional :
            return GuaranteedInventoryServiceReservationStatus(
            )
        else :
            return GuaranteedInventoryServiceReservationStatus(
        )

    def testGuaranteedInventoryServiceReservationStatus(self):
        """Test GuaranteedInventoryServiceReservationStatus"""
