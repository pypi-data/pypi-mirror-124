...
from yahoo_display_api.models.guaranteed_campaign_service_frequency_level import GuaranteedCampaignServiceFrequencyLevel  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestGuaranteedCampaignServiceFrequencyLevel(unittest.TestCase):
    """GuaranteedCampaignServiceFrequencyLevel unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_display_api.models.guaranteed_campaign_service_frequency_level.GuaranteedCampaignServiceFrequencyLevel()  # noqa: E501
        if include_optional :
            return GuaranteedCampaignServiceFrequencyLevel(
            )
        else :
            return GuaranteedCampaignServiceFrequencyLevel(
        )

    def testGuaranteedCampaignServiceFrequencyLevel(self):
        """Test GuaranteedCampaignServiceFrequencyLevel"""
