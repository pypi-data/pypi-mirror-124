...
from yahoo_display_api.models.guaranteed_inventory_service_inventory_unit import GuaranteedInventoryServiceInventoryUnit  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestGuaranteedInventoryServiceInventoryUnit(unittest.TestCase):
    """GuaranteedInventoryServiceInventoryUnit unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test GuaranteedInventoryServiceInventoryUnit
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = yahoo_display_api.models.guaranteed_inventory_service_inventory_unit.GuaranteedInventoryServiceInventoryUnit()  # noqa: E501
        if include_optional :
            return GuaranteedInventoryServiceInventoryUnit(
            )
        else :
            return GuaranteedInventoryServiceInventoryUnit(
        )

    def testGuaranteedInventoryServiceInventoryUnit(self):
        """Test GuaranteedInventoryServiceInventoryUnit"""
