...
from yahoo_display_api.models.guaranteed_simulation_service_frequency_level import GuaranteedSimulationServiceFrequencyLevel  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestGuaranteedSimulationServiceFrequencyLevel(unittest.TestCase):
    """GuaranteedSimulationServiceFrequencyLevel unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_display_api.models.guaranteed_simulation_service_frequency_level.GuaranteedSimulationServiceFrequencyLevel()  # noqa: E501
        if include_optional :
            return GuaranteedSimulationServiceFrequencyLevel(
            )
        else :
            return GuaranteedSimulationServiceFrequencyLevel(
        )

    def testGuaranteedSimulationServiceFrequencyLevel(self):
        """Test GuaranteedSimulationServiceFrequencyLevel"""
