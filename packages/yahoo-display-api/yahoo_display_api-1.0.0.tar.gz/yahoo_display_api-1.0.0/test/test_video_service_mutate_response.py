...
from yahoo_display_api.models.video_service_mutate_response import VideoServiceMutateResponse  # noqa: E501
...
class TestVideoServiceMutateResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_display_api.models.video_service_mutate_response.VideoServiceMutateResponse()  # noqa: E501
        if include_optional :
            return VideoServiceMutateResponse(
                ...
                rid = '0', 
                rval = yahoo_display_api.models.video_service_return_value.VideoServiceReturnValue(
                    values = [
                        yahoo_display_api.models.video_service_value.VideoServiceValue(
                            errors = [
                                yahoo_display_api.models.error.Error(
                                    code = '0', 
                                    message = '0', 
                            ...
                            video = yahoo_display_api.models.video.Video(
                                account_id = 56, 
                                ...
                                user_status = 'ACTIVE', 
                                video_name = '0', 
                                video_setting = yahoo_display_api.models.video_service_setting.VideoServiceSetting(
                                    file_size = 56, 
                                    file_type = 'MP4', 
                                    height = 56, 
                                    playback_time = 56, 
