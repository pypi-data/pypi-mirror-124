...
from yahoo_display_api.models.guaranteed_inventory_service_os_target import GuaranteedInventoryServiceOsTarget  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestGuaranteedInventoryServiceOsTarget(unittest.TestCase):
    """GuaranteedInventoryServiceOsTarget unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test GuaranteedInventoryServiceOsTarget
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = yahoo_display_api.models.guaranteed_inventory_service_os_target.GuaranteedInventoryServiceOsTarget()  # noqa: E501
        if include_optional :
            return GuaranteedInventoryServiceOsTarget(
                device_os_type = 'IOS'
            )
        else :
            return GuaranteedInventoryServiceOsTarget(
    ...
    def testGuaranteedInventoryServiceOsTarget(self):
        """Test GuaranteedInventoryServiceOsTarget"""
