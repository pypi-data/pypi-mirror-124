...
from yahoo_display_api.models.feed_ftp_request_service_mutate_response import FeedFtpRequestServiceMutateResponse  # noqa: E501
...
class TestFeedFtpRequestServiceMutateResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_display_api.models.feed_ftp_request_service_mutate_response.FeedFtpRequestServiceMutateResponse()  # noqa: E501
        if include_optional :
            return FeedFtpRequestServiceMutateResponse(
                ...
                rid = '0', 
                rval = yahoo_display_api.models.feed_ftp_request_service_return_value.FeedFtpRequestServiceReturnValue(
                    values = [
                        yahoo_display_api.models.feed_ftp_request_service_value.FeedFtpRequestServiceValue(
                            errors = [
                                yahoo_display_api.models.error.Error(
                                    code = '0', 
                                    message = '0', 
                            ...
                            feed_ftp_request = yahoo_display_api.models.feed_ftp_request.FeedFtpRequest(
                                feed_id = 56, ), 
