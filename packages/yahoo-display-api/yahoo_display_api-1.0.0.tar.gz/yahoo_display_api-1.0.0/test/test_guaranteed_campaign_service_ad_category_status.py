...
from yahoo_display_api.models.guaranteed_campaign_service_ad_category_status import GuaranteedCampaignServiceAdCategoryStatus  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestGuaranteedCampaignServiceAdCategoryStatus(unittest.TestCase):
    """GuaranteedCampaignServiceAdCategoryStatus unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_display_api.models.guaranteed_campaign_service_ad_category_status.GuaranteedCampaignServiceAdCategoryStatus()  # noqa: E501
        if include_optional :
            return GuaranteedCampaignServiceAdCategoryStatus(
            )
        else :
            return GuaranteedCampaignServiceAdCategoryStatus(
        )

    def testGuaranteedCampaignServiceAdCategoryStatus(self):
        """Test GuaranteedCampaignServiceAdCategoryStatus"""
