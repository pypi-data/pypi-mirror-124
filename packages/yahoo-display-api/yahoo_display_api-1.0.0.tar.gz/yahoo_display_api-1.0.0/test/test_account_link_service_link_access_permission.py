...
from yahoo_display_api.models.account_link_service_link_access_permission import AccountLinkServiceLinkAccessPermission  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestAccountLinkServiceLinkAccessPermission(unittest.TestCase):
    """AccountLinkServiceLinkAccessPermission unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_display_api.models.account_link_service_link_access_permission.AccountLinkServiceLinkAccessPermission()  # noqa: E501
        if include_optional :
            return AccountLinkServiceLinkAccessPermission(
            )
        else :
            return AccountLinkServiceLinkAccessPermission(
        )

    def testAccountLinkServiceLinkAccessPermission(self):
        """Test AccountLinkServiceLinkAccessPermission"""
