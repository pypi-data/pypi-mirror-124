...
from yahoo_display_api.models.guaranteed_inventory_service_geo_target import GuaranteedInventoryServiceGeoTarget  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestGuaranteedInventoryServiceGeoTarget(unittest.TestCase):
    """GuaranteedInventoryServiceGeoTarget unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test GuaranteedInventoryServiceGeoTarget
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = yahoo_display_api.models.guaranteed_inventory_service_geo_target.GuaranteedInventoryServiceGeoTarget()  # noqa: E501
        if include_optional :
            return GuaranteedInventoryServiceGeoTarget(
                geo_name_en = '0', 
                geo_name_ja = '0'
            )
        else :
    ...
    def testGuaranteedInventoryServiceGeoTarget(self):
        """Test GuaranteedInventoryServiceGeoTarget"""
