...
from yahoo_display_api.models.retargeting_tag_service_mutate_response import RetargetingTagServiceMutateResponse  # noqa: E501
...
class TestRetargetingTagServiceMutateResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_display_api.models.retargeting_tag_service_mutate_response.RetargetingTagServiceMutateResponse()  # noqa: E501
        if include_optional :
            return RetargetingTagServiceMutateResponse(
                ...
                rid = '0', 
                rval = yahoo_display_api.models.retargeting_tag_service_return_value.RetargetingTagServiceReturnValue(
                    values = [
                        yahoo_display_api.models.retargeting_tag_service_value.RetargetingTagServiceValue(
                            errors = [
                                yahoo_display_api.models.error.Error(
                                    code = '0', 
                                    message = '0', 
                            ...
                            retargeting_tag = yahoo_display_api.models.retargeting_tag.RetargetingTag(
                                account_id = 56, 
