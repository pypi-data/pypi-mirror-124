...
from yahoo_display_api.models.guaranteed_simulation_service_ad_type import GuaranteedSimulationServiceAdType  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestGuaranteedSimulationServiceAdType(unittest.TestCase):
    """GuaranteedSimulationServiceAdType unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_display_api.models.guaranteed_simulation_service_ad_type.GuaranteedSimulationServiceAdType()  # noqa: E501
        if include_optional :
            return GuaranteedSimulationServiceAdType(
            )
        else :
            return GuaranteedSimulationServiceAdType(
        )

    def testGuaranteedSimulationServiceAdType(self):
        """Test GuaranteedSimulationServiceAdType"""
