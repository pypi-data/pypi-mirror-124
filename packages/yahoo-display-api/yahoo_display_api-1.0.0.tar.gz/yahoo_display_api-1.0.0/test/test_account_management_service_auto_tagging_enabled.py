...
from yahoo_display_api.models.account_management_service_auto_tagging_enabled import AccountManagementServiceAutoTaggingEnabled  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestAccountManagementServiceAutoTaggingEnabled(unittest.TestCase):
    """AccountManagementServiceAutoTaggingEnabled unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_display_api.models.account_management_service_auto_tagging_enabled.AccountManagementServiceAutoTaggingEnabled()  # noqa: E501
        if include_optional :
            return AccountManagementServiceAutoTaggingEnabled(
            )
        else :
            return AccountManagementServiceAutoTaggingEnabled(
        )

    def testAccountManagementServiceAutoTaggingEnabled(self):
        """Test AccountManagementServiceAutoTaggingEnabled"""
