...
from yahoo_display_api.models.guaranteed_inventory_service_prediction_result import GuaranteedInventoryServicePredictionResult  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestGuaranteedInventoryServicePredictionResult(unittest.TestCase):
    """GuaranteedInventoryServicePredictionResult unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test GuaranteedInventoryServicePredictionResult
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = yahoo_display_api.models.guaranteed_inventory_service_prediction_result.GuaranteedInventoryServicePredictionResult()  # noqa: E501
        if include_optional :
            return GuaranteedInventoryServicePredictionResult(
                lifetime_budget = 56, 
                reach = 56, 
                v_imps = 56, 
                vcpm = 56, 
    ...
    def testGuaranteedInventoryServicePredictionResult(self):
        """Test GuaranteedInventoryServicePredictionResult"""
