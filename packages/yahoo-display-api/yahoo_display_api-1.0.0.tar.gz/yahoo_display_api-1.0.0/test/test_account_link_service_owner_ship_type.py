...
from yahoo_display_api.models.account_link_service_owner_ship_type import AccountLinkServiceOwnerShipType  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestAccountLinkServiceOwnerShipType(unittest.TestCase):
    """AccountLinkServiceOwnerShipType unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_display_api.models.account_link_service_owner_ship_type.AccountLinkServiceOwnerShipType()  # noqa: E501
        if include_optional :
            return AccountLinkServiceOwnerShipType(
            )
        else :
            return AccountLinkServiceOwnerShipType(
        )

    def testAccountLinkServiceOwnerShipType(self):
        """Test AccountLinkServiceOwnerShipType"""
