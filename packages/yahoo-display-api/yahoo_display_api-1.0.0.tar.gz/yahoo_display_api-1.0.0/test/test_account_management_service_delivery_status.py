...
from yahoo_display_api.models.account_management_service_delivery_status import AccountManagementServiceDeliveryStatus  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestAccountManagementServiceDeliveryStatus(unittest.TestCase):
    """AccountManagementServiceDeliveryStatus unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_display_api.models.account_management_service_delivery_status.AccountManagementServiceDeliveryStatus()  # noqa: E501
        if include_optional :
            return AccountManagementServiceDeliveryStatus(
            )
        else :
            return AccountManagementServiceDeliveryStatus(
        )

    def testAccountManagementServiceDeliveryStatus(self):
        """Test AccountManagementServiceDeliveryStatus"""
