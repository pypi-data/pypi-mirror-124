...
from yahoo_display_api.models.guaranteed_inventory_service_target_type import GuaranteedInventoryServiceTargetType  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestGuaranteedInventoryServiceTargetType(unittest.TestCase):
    """GuaranteedInventoryServiceTargetType unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test GuaranteedInventoryServiceTargetType
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = yahoo_display_api.models.guaranteed_inventory_service_target_type.GuaranteedInventoryServiceTargetType()  # noqa: E501
        if include_optional :
            return GuaranteedInventoryServiceTargetType(
            )
        else :
            return GuaranteedInventoryServiceTargetType(
        )

    def testGuaranteedInventoryServiceTargetType(self):
        """Test GuaranteedInventoryServiceTargetType"""
