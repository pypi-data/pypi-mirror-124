...
from yahoo_display_api.models.guaranteed_inventory_service_placement_monopoly_flg import GuaranteedInventoryServicePlacementMonopolyFlg  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestGuaranteedInventoryServicePlacementMonopolyFlg(unittest.TestCase):
    """GuaranteedInventoryServicePlacementMonopolyFlg unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test GuaranteedInventoryServicePlacementMonopolyFlg
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = yahoo_display_api.models.guaranteed_inventory_service_placement_monopoly_flg.GuaranteedInventoryServicePlacementMonopolyFlg()  # noqa: E501
        if include_optional :
            return GuaranteedInventoryServicePlacementMonopolyFlg(
            )
        else :
            return GuaranteedInventoryServicePlacementMonopolyFlg(
        )

    def testGuaranteedInventoryServicePlacementMonopolyFlg(self):
        """Test GuaranteedInventoryServicePlacementMonopolyFlg"""
