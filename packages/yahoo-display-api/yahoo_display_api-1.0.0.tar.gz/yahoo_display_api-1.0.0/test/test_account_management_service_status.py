...
from yahoo_display_api.models.account_management_service_status import AccountManagementServiceStatus  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestAccountManagementServiceStatus(unittest.TestCase):
    """AccountManagementServiceStatus unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_display_api.models.account_management_service_status.AccountManagementServiceStatus()  # noqa: E501
        if include_optional :
            return AccountManagementServiceStatus(
            )
        else :
            return AccountManagementServiceStatus(
        )

    def testAccountManagementServiceStatus(self):
        """Test AccountManagementServiceStatus"""
