...
from yahoo_display_api.models.report_definition_service_cross_campaign_buying_type import ReportDefinitionServiceCrossCampaignBuyingType  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestReportDefinitionServiceCrossCampaignBuyingType(unittest.TestCase):
    """ReportDefinitionServiceCrossCampaignBuyingType unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_display_api.models.report_definition_service_cross_campaign_buying_type.ReportDefinitionServiceCrossCampaignBuyingType()  # noqa: E501
        if include_optional :
            return ReportDefinitionServiceCrossCampaignBuyingType(
            )
        else :
            return ReportDefinitionServiceCrossCampaignBuyingType(
        )

    def testReportDefinitionServiceCrossCampaignBuyingType(self):
        """Test ReportDefinitionServiceCrossCampaignBuyingType"""
