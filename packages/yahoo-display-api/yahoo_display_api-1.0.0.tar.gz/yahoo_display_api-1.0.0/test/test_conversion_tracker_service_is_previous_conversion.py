...
from yahoo_display_api.models.conversion_tracker_service_is_previous_conversion import ConversionTrackerServiceIsPreviousConversion  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestConversionTrackerServiceIsPreviousConversion(unittest.TestCase):
    """ConversionTrackerServiceIsPreviousConversion unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test ConversionTrackerServiceIsPreviousConversion
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = yahoo_display_api.models.conversion_tracker_service_is_previous_conversion.ConversionTrackerServiceIsPreviousConversion()  # noqa: E501
        if include_optional :
            return ConversionTrackerServiceIsPreviousConversion(
            )
        else :
            return ConversionTrackerServiceIsPreviousConversion(
        )

    def testConversionTrackerServiceIsPreviousConversion(self):
        """Test ConversionTrackerServiceIsPreviousConversion"""
