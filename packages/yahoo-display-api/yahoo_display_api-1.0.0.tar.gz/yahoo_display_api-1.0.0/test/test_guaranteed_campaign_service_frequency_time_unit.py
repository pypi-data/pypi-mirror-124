...
from yahoo_display_api.models.guaranteed_campaign_service_frequency_time_unit import GuaranteedCampaignServiceFrequencyTimeUnit  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestGuaranteedCampaignServiceFrequencyTimeUnit(unittest.TestCase):
    """GuaranteedCampaignServiceFrequencyTimeUnit unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_display_api.models.guaranteed_campaign_service_frequency_time_unit.GuaranteedCampaignServiceFrequencyTimeUnit()  # noqa: E501
        if include_optional :
            return GuaranteedCampaignServiceFrequencyTimeUnit(
            )
        else :
            return GuaranteedCampaignServiceFrequencyTimeUnit(
        )

    def testGuaranteedCampaignServiceFrequencyTimeUnit(self):
        """Test GuaranteedCampaignServiceFrequencyTimeUnit"""
