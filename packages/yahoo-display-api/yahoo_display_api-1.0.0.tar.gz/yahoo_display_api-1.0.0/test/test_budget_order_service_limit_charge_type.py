...
from yahoo_display_api.models.budget_order_service_limit_charge_type import BudgetOrderServiceLimitChargeType  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestBudgetOrderServiceLimitChargeType(unittest.TestCase):
    """BudgetOrderServiceLimitChargeType unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_display_api.models.budget_order_service_limit_charge_type.BudgetOrderServiceLimitChargeType()  # noqa: E501
        if include_optional :
            return BudgetOrderServiceLimitChargeType(
            )
        else :
            return BudgetOrderServiceLimitChargeType(
        )

    def testBudgetOrderServiceLimitChargeType(self):
        """Test BudgetOrderServiceLimitChargeType"""
