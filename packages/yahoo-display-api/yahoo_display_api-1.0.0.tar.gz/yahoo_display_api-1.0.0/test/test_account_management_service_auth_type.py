...
from yahoo_display_api.models.account_management_service_auth_type import AccountManagementServiceAuthType  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestAccountManagementServiceAuthType(unittest.TestCase):
    """AccountManagementServiceAuthType unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_display_api.models.account_management_service_auth_type.AccountManagementServiceAuthType()  # noqa: E501
        if include_optional :
            return AccountManagementServiceAuthType(
            )
        else :
            return AccountManagementServiceAuthType(
        )

    def testAccountManagementServiceAuthType(self):
        """Test AccountManagementServiceAuthType"""
