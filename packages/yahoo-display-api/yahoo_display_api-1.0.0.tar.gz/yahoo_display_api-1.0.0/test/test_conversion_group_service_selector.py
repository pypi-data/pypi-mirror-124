...
from yahoo_display_api.models.conversion_group_service_selector import ConversionGroupServiceSelector  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestConversionGroupServiceSelector(unittest.TestCase):
    """ConversionGroupServiceSelector unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test ConversionGroupServiceSelector
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = yahoo_display_api.models.conversion_group_service_selector.ConversionGroupServiceSelector()  # noqa: E501
        if include_optional :
            return ConversionGroupServiceSelector(
                account_id = 56, 
                conversion_group_ids = [
                    56
                    ], 
    ...
    def testConversionGroupServiceSelector(self):
        """Test ConversionGroupServiceSelector"""
