...
from yahoo_display_api.models.guaranteed_preview_service_ad_type import GuaranteedPreviewServiceAdType  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestGuaranteedPreviewServiceAdType(unittest.TestCase):
    """GuaranteedPreviewServiceAdType unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_display_api.models.guaranteed_preview_service_ad_type.GuaranteedPreviewServiceAdType()  # noqa: E501
        if include_optional :
            return GuaranteedPreviewServiceAdType(
            )
        else :
            return GuaranteedPreviewServiceAdType(
        )

    def testGuaranteedPreviewServiceAdType(self):
        """Test GuaranteedPreviewServiceAdType"""
