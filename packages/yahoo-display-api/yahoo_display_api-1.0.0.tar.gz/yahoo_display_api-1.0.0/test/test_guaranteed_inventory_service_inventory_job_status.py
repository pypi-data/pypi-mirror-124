...
from yahoo_display_api.models.guaranteed_inventory_service_inventory_job_status import GuaranteedInventoryServiceInventoryJobStatus  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestGuaranteedInventoryServiceInventoryJobStatus(unittest.TestCase):
    """GuaranteedInventoryServiceInventoryJobStatus unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test GuaranteedInventoryServiceInventoryJobStatus
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = yahoo_display_api.models.guaranteed_inventory_service_inventory_job_status.GuaranteedInventoryServiceInventoryJobStatus()  # noqa: E501
        if include_optional :
            return GuaranteedInventoryServiceInventoryJobStatus(
            )
        else :
            return GuaranteedInventoryServiceInventoryJobStatus(
        )

    def testGuaranteedInventoryServiceInventoryJobStatus(self):
        """Test GuaranteedInventoryServiceInventoryJobStatus"""
