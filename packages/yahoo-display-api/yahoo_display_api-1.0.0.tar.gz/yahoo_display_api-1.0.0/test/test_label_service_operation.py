...
from yahoo_display_api.models.label_service_operation import LabelServiceOperation  # noqa: E501
...
class TestLabelServiceOperation(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_display_api.models.label_service_operation.LabelServiceOperation()  # noqa: E501
        if include_optional :
            return LabelServiceOperation(
                account_id = 56, 
                operand = [
                    yahoo_display_api.models.label.Label(
                        account_id = 56, 
                        color = '0', 
                        description = '0', 
                        label_id = 56, 
