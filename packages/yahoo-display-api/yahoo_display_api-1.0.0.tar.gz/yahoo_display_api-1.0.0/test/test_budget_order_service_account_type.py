...
from yahoo_display_api.models.budget_order_service_account_type import BudgetOrderServiceAccountType  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestBudgetOrderServiceAccountType(unittest.TestCase):
    """BudgetOrderServiceAccountType unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_display_api.models.budget_order_service_account_type.BudgetOrderServiceAccountType()  # noqa: E501
        if include_optional :
            return BudgetOrderServiceAccountType(
            )
        else :
            return BudgetOrderServiceAccountType(
        )

    def testBudgetOrderServiceAccountType(self):
        """Test BudgetOrderServiceAccountType"""
