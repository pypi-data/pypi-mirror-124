...
from yahoo_display_api.models.guaranteed_inventory_service_ad_type import GuaranteedInventoryServiceAdType  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestGuaranteedInventoryServiceAdType(unittest.TestCase):
    """GuaranteedInventoryServiceAdType unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test GuaranteedInventoryServiceAdType
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = yahoo_display_api.models.guaranteed_inventory_service_ad_type.GuaranteedInventoryServiceAdType()  # noqa: E501
        if include_optional :
            return GuaranteedInventoryServiceAdType(
            )
        else :
            return GuaranteedInventoryServiceAdType(
        )

    def testGuaranteedInventoryServiceAdType(self):
        """Test GuaranteedInventoryServiceAdType"""
