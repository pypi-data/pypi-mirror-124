...
from yahoo_display_api.models.guaranteed_ad_group_ad_service_carousel_ad import GuaranteedAdGroupAdServiceCarouselAd  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestGuaranteedAdGroupAdServiceCarouselAd(unittest.TestCase):
    """GuaranteedAdGroupAdServiceCarouselAd unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test GuaranteedAdGroupAdServiceCarouselAd
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = yahoo_display_api.models.guaranteed_ad_group_ad_service_carousel_ad.GuaranteedAdGroupAdServiceCarouselAd()  # noqa: E501
        if include_optional :
            return GuaranteedAdGroupAdServiceCarouselAd(
                display_url = '0', 
                logo_media_id = 56, 
                principal = '0', 
                url = '0', 
    ...
    def testGuaranteedAdGroupAdServiceCarouselAd(self):
        """Test GuaranteedAdGroupAdServiceCarouselAd"""
