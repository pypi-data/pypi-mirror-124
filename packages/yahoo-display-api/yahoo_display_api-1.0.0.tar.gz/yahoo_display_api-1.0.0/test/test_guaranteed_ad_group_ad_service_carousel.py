...
from yahoo_display_api.models.guaranteed_ad_group_ad_service_carousel import GuaranteedAdGroupAdServiceCarousel  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestGuaranteedAdGroupAdServiceCarousel(unittest.TestCase):
    """GuaranteedAdGroupAdServiceCarousel unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test GuaranteedAdGroupAdServiceCarousel
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = yahoo_display_api.models.guaranteed_ad_group_ad_service_carousel.GuaranteedAdGroupAdServiceCarousel()  # noqa: E501
        if include_optional :
            return GuaranteedAdGroupAdServiceCarousel(
                display_order = 56, 
                media_id = 56, 
                headline = '0', 
                description = '0', 
    ...
    def testGuaranteedAdGroupAdServiceCarousel(self):
        """Test GuaranteedAdGroupAdServiceCarousel"""
