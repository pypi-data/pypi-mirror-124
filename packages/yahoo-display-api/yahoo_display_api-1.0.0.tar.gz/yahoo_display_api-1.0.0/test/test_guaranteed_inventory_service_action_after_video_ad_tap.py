...
from yahoo_display_api.models.guaranteed_inventory_service_action_after_video_ad_tap import GuaranteedInventoryServiceActionAfterVideoAdTap  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestGuaranteedInventoryServiceActionAfterVideoAdTap(unittest.TestCase):
    """GuaranteedInventoryServiceActionAfterVideoAdTap unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test GuaranteedInventoryServiceActionAfterVideoAdTap
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = yahoo_display_api.models.guaranteed_inventory_service_action_after_video_ad_tap.GuaranteedInventoryServiceActionAfterVideoAdTap()  # noqa: E501
        if include_optional :
            return GuaranteedInventoryServiceActionAfterVideoAdTap(
            )
        else :
            return GuaranteedInventoryServiceActionAfterVideoAdTap(
        )

    def testGuaranteedInventoryServiceActionAfterVideoAdTap(self):
        """Test GuaranteedInventoryServiceActionAfterVideoAdTap"""
