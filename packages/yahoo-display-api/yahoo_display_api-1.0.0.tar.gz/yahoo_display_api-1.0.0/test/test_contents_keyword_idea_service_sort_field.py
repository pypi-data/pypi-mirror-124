...
from yahoo_display_api.models.contents_keyword_idea_service_sort_field import ContentsKeywordIdeaServiceSortField  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestContentsKeywordIdeaServiceSortField(unittest.TestCase):
    """ContentsKeywordIdeaServiceSortField unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test ContentsKeywordIdeaServiceSortField
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = yahoo_display_api.models.contents_keyword_idea_service_sort_field.ContentsKeywordIdeaServiceSortField()  # noqa: E501
        if include_optional :
            return ContentsKeywordIdeaServiceSortField(
            )
        else :
            return ContentsKeywordIdeaServiceSortField(
        )

    def testContentsKeywordIdeaServiceSortField(self):
        """Test ContentsKeywordIdeaServiceSortField"""
