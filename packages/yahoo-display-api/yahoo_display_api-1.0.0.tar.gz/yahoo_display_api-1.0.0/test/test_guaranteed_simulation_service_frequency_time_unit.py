...
from yahoo_display_api.models.guaranteed_simulation_service_frequency_time_unit import GuaranteedSimulationServiceFrequencyTimeUnit  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestGuaranteedSimulationServiceFrequencyTimeUnit(unittest.TestCase):
    """GuaranteedSimulationServiceFrequencyTimeUnit unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_display_api.models.guaranteed_simulation_service_frequency_time_unit.GuaranteedSimulationServiceFrequencyTimeUnit()  # noqa: E501
        if include_optional :
            return GuaranteedSimulationServiceFrequencyTimeUnit(
            )
        else :
            return GuaranteedSimulationServiceFrequencyTimeUnit(
        )

    def testGuaranteedSimulationServiceFrequencyTimeUnit(self):
        """Test GuaranteedSimulationServiceFrequencyTimeUnit"""
