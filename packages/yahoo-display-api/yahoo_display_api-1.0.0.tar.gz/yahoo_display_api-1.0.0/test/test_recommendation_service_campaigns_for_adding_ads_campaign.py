...
from yahoo_display_api.models.recommendation_service_campaigns_for_adding_ads_campaign import RecommendationServiceCampaignsForAddingAdsCampaign  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestRecommendationServiceCampaignsForAddingAdsCampaign(unittest.TestCase):
    """RecommendationServiceCampaignsForAddingAdsCampaign unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test RecommendationServiceCampaignsForAddingAdsCampaign
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = yahoo_display_api.models.recommendation_service_campaigns_for_adding_ads_campaign.RecommendationServiceCampaignsForAddingAdsCampaign()  # noqa: E501
        if include_optional :
            return RecommendationServiceCampaignsForAddingAdsCampaign(
    ...
    def testRecommendationServiceCampaignsForAddingAdsCampaign(self):
        """Test RecommendationServiceCampaignsForAddingAdsCampaign"""
