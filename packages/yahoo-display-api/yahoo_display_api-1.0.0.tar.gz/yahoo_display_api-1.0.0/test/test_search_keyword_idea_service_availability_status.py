...
from yahoo_display_api.models.search_keyword_idea_service_availability_status import SearchKeywordIdeaServiceAvailabilityStatus  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestSearchKeywordIdeaServiceAvailabilityStatus(unittest.TestCase):
    """SearchKeywordIdeaServiceAvailabilityStatus unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_display_api.models.search_keyword_idea_service_availability_status.SearchKeywordIdeaServiceAvailabilityStatus()  # noqa: E501
        if include_optional :
            return SearchKeywordIdeaServiceAvailabilityStatus(
            )
        else :
            return SearchKeywordIdeaServiceAvailabilityStatus(
        )

    def testSearchKeywordIdeaServiceAvailabilityStatus(self):
        """Test SearchKeywordIdeaServiceAvailabilityStatus"""
