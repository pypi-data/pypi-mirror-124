...
from yahoo_display_api.models.placement_url_list_service_operation import PlacementUrlListServiceOperation  # noqa: E501
...
class TestPlacementUrlListServiceOperation(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_display_api.models.placement_url_list_service_operation.PlacementUrlListServiceOperation()  # noqa: E501
        if include_optional :
            return PlacementUrlListServiceOperation(
                account_id = 56, 
                operand = [
                    yahoo_display_api.models.placement_url_list.PlacementUrlList(
                        account_id = 56, 
                        description = '0', 
