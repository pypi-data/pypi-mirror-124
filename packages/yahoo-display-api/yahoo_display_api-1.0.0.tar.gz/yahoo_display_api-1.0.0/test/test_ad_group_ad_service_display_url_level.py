...
from yahoo_display_api.models.ad_group_ad_service_display_url_level import AdGroupAdServiceDisplayUrlLevel  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestAdGroupAdServiceDisplayUrlLevel(unittest.TestCase):
    """AdGroupAdServiceDisplayUrlLevel unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test AdGroupAdServiceDisplayUrlLevel
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = yahoo_display_api.models.ad_group_ad_service_display_url_level.AdGroupAdServiceDisplayUrlLevel()  # noqa: E501
        if include_optional :
            return AdGroupAdServiceDisplayUrlLevel(
            )
        else :
            return AdGroupAdServiceDisplayUrlLevel(
        )

    def testAdGroupAdServiceDisplayUrlLevel(self):
        """Test AdGroupAdServiceDisplayUrlLevel"""
