...
from yahoo_display_api.models.feed_ftp_service_operation import FeedFtpServiceOperation  # noqa: E501
...
class TestFeedFtpServiceOperation(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_display_api.models.feed_ftp_service_operation.FeedFtpServiceOperation()  # noqa: E501
        if include_optional :
            return FeedFtpServiceOperation(
                account_id = 56, 
                operand = [
                    yahoo_display_api.models.feed_ftp.FeedFtp(
                        account_id = 56, 
