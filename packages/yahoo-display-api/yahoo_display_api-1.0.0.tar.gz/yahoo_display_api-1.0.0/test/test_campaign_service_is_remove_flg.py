...
from yahoo_display_api.models.campaign_service_is_remove_flg import CampaignServiceIsRemoveFlg  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestCampaignServiceIsRemoveFlg(unittest.TestCase):
    """CampaignServiceIsRemoveFlg unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test CampaignServiceIsRemoveFlg
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = yahoo_display_api.models.campaign_service_is_remove_flg.CampaignServiceIsRemoveFlg()  # noqa: E501
        if include_optional :
            return CampaignServiceIsRemoveFlg(
            )
        else :
            return CampaignServiceIsRemoveFlg(
        )

    def testCampaignServiceIsRemoveFlg(self):
        """Test CampaignServiceIsRemoveFlg"""
