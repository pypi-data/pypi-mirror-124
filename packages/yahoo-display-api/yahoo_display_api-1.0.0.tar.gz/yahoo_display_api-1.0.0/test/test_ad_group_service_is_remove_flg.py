...
from yahoo_display_api.models.ad_group_service_is_remove_flg import AdGroupServiceIsRemoveFlg  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestAdGroupServiceIsRemoveFlg(unittest.TestCase):
    """AdGroupServiceIsRemoveFlg unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test AdGroupServiceIsRemoveFlg
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = yahoo_display_api.models.ad_group_service_is_remove_flg.AdGroupServiceIsRemoveFlg()  # noqa: E501
        if include_optional :
            return AdGroupServiceIsRemoveFlg(
            )
        else :
            return AdGroupServiceIsRemoveFlg(
        )

    def testAdGroupServiceIsRemoveFlg(self):
        """Test AdGroupServiceIsRemoveFlg"""
