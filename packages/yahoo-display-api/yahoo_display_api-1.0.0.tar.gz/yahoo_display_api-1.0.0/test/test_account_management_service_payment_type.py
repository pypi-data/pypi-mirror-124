...
from yahoo_display_api.models.account_management_service_payment_type import AccountManagementServicePaymentType  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestAccountManagementServicePaymentType(unittest.TestCase):
    """AccountManagementServicePaymentType unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_display_api.models.account_management_service_payment_type.AccountManagementServicePaymentType()  # noqa: E501
        if include_optional :
            return AccountManagementServicePaymentType(
            )
        else :
            return AccountManagementServicePaymentType(
        )

    def testAccountManagementServicePaymentType(self):
        """Test AccountManagementServicePaymentType"""
