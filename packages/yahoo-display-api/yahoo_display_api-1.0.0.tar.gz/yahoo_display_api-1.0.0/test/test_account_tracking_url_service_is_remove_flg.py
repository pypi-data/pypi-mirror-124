...
from yahoo_display_api.models.account_tracking_url_service_is_remove_flg import AccountTrackingUrlServiceIsRemoveFlg  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestAccountTrackingUrlServiceIsRemoveFlg(unittest.TestCase):
    """AccountTrackingUrlServiceIsRemoveFlg unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test AccountTrackingUrlServiceIsRemoveFlg
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = yahoo_display_api.models.account_tracking_url_service_is_remove_flg.AccountTrackingUrlServiceIsRemoveFlg()  # noqa: E501
        if include_optional :
            return AccountTrackingUrlServiceIsRemoveFlg(
            )
        else :
            return AccountTrackingUrlServiceIsRemoveFlg(
        )

    def testAccountTrackingUrlServiceIsRemoveFlg(self):
        """Test AccountTrackingUrlServiceIsRemoveFlg"""
