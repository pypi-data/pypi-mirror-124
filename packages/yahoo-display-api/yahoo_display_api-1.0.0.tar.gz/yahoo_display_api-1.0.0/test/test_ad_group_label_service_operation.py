...
from yahoo_display_api.models.ad_group_label_service_operation import AdGroupLabelServiceOperation  # noqa: E501
...
class TestAdGroupLabelServiceOperation(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_display_api.models.ad_group_label_service_operation.AdGroupLabelServiceOperation()  # noqa: E501
        if include_optional :
            return AdGroupLabelServiceOperation(
                account_id = 56, 
                operand = [
                    yahoo_display_api.models.ad_group_label.AdGroupLabel(
                        account_id = 56, 
                        ad_group_id = 56, 
                        campaign_id = 56, 
                        label_id = 56, )
