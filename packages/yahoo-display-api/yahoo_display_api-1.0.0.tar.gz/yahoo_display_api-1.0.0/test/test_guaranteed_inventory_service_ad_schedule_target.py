...
from yahoo_display_api.models.guaranteed_inventory_service_ad_schedule_target import GuaranteedInventoryServiceAdScheduleTarget  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestGuaranteedInventoryServiceAdScheduleTarget(unittest.TestCase):
    """GuaranteedInventoryServiceAdScheduleTarget unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test GuaranteedInventoryServiceAdScheduleTarget
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = yahoo_display_api.models.guaranteed_inventory_service_ad_schedule_target.GuaranteedInventoryServiceAdScheduleTarget()  # noqa: E501
        if include_optional :
            return GuaranteedInventoryServiceAdScheduleTarget(
                day_of_week = 'MONDAY', 
                end_hour = 56, 
                start_hour = 56
            )
    ...
    def testGuaranteedInventoryServiceAdScheduleTarget(self):
        """Test GuaranteedInventoryServiceAdScheduleTarget"""
