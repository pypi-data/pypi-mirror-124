...
from yahoo_display_api.models.guaranteed_inventory_service_unavailable_reason import GuaranteedInventoryServiceUnavailableReason  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestGuaranteedInventoryServiceUnavailableReason(unittest.TestCase):
    """GuaranteedInventoryServiceUnavailableReason unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test GuaranteedInventoryServiceUnavailableReason
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = yahoo_display_api.models.guaranteed_inventory_service_unavailable_reason.GuaranteedInventoryServiceUnavailableReason()  # noqa: E501
        if include_optional :
            return GuaranteedInventoryServiceUnavailableReason(
                date = '0', 
                hours = [
                    56
                    ], 
    ...
    def testGuaranteedInventoryServiceUnavailableReason(self):
        """Test GuaranteedInventoryServiceUnavailableReason"""
