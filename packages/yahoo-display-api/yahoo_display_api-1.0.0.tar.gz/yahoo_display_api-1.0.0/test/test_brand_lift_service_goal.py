...
from yahoo_display_api.models.brand_lift_service_goal import BrandLiftServiceGoal  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestBrandLiftServiceGoal(unittest.TestCase):
    """BrandLiftServiceGoal unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_display_api.models.brand_lift_service_goal.BrandLiftServiceGoal()  # noqa: E501
        if include_optional :
            return BrandLiftServiceGoal(
            )
        else :
            return BrandLiftServiceGoal(
        )

    def testBrandLiftServiceGoal(self):
        """Test BrandLiftServiceGoal"""
