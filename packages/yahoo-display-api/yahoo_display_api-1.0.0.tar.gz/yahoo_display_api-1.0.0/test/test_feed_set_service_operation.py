...
from yahoo_display_api.models.feed_set_service_operation import FeedSetServiceOperation  # noqa: E501
...
class TestFeedSetServiceOperation(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_display_api.models.feed_set_service_operation.FeedSetServiceOperation()  # noqa: E501
        if include_optional :
            return FeedSetServiceOperation(
                account_id = 56, 
                operand = [
                    yahoo_display_api.models.feed_set.FeedSet(
                        account_id = 56, 
                        condition_sets = [
