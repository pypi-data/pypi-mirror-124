...
from yahoo_display_api.models.guaranteed_inventory_service_app_target import GuaranteedInventoryServiceAppTarget  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestGuaranteedInventoryServiceAppTarget(unittest.TestCase):
    """GuaranteedInventoryServiceAppTarget unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test GuaranteedInventoryServiceAppTarget
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = yahoo_display_api.models.guaranteed_inventory_service_app_target.GuaranteedInventoryServiceAppTarget()  # noqa: E501
        if include_optional :
            return GuaranteedInventoryServiceAppTarget(
                device_app_type = 'APP'
            )
        else :
            return GuaranteedInventoryServiceAppTarget(
    ...
    def testGuaranteedInventoryServiceAppTarget(self):
        """Test GuaranteedInventoryServiceAppTarget"""
