...
from yahoo_display_api.models.video_service_selector import VideoServiceSelector  # noqa: E501
...
class TestVideoServiceSelector(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_display_api.models.video_service_selector.VideoServiceSelector()  # noqa: E501
        if include_optional :
            return VideoServiceSelector(
                ...
                created_date_range = yahoo_display_api.models.video_service_created_date_range.VideoServiceCreatedDateRange(
                    start_date = '0', 
                    end_date = '0', )
            )
        else :
