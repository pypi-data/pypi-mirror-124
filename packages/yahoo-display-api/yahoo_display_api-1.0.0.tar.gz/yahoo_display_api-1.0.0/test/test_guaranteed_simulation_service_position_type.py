...
from yahoo_display_api.models.guaranteed_simulation_service_position_type import GuaranteedSimulationServicePositionType  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestGuaranteedSimulationServicePositionType(unittest.TestCase):
    """GuaranteedSimulationServicePositionType unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_display_api.models.guaranteed_simulation_service_position_type.GuaranteedSimulationServicePositionType()  # noqa: E501
        if include_optional :
            return GuaranteedSimulationServicePositionType(
            )
        else :
            return GuaranteedSimulationServicePositionType(
        )

    def testGuaranteedSimulationServicePositionType(self):
        """Test GuaranteedSimulationServicePositionType"""
