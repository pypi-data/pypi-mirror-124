...
from yahoo_display_api.models.placement_url_list_service_is_remove_flg import PlacementUrlListServiceIsRemoveFlg  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestPlacementUrlListServiceIsRemoveFlg(unittest.TestCase):
    """PlacementUrlListServiceIsRemoveFlg unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_display_api.models.placement_url_list_service_is_remove_flg.PlacementUrlListServiceIsRemoveFlg()  # noqa: E501
        if include_optional :
            return PlacementUrlListServiceIsRemoveFlg(
            )
        else :
            return PlacementUrlListServiceIsRemoveFlg(
        )

    def testPlacementUrlListServiceIsRemoveFlg(self):
        """Test PlacementUrlListServiceIsRemoveFlg"""
