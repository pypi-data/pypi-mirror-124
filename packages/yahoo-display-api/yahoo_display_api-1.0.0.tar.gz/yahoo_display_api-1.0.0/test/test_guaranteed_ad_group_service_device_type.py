...
from yahoo_display_api.models.guaranteed_ad_group_service_device_type import GuaranteedAdGroupServiceDeviceType  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestGuaranteedAdGroupServiceDeviceType(unittest.TestCase):
    """GuaranteedAdGroupServiceDeviceType unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_display_api.models.guaranteed_ad_group_service_device_type.GuaranteedAdGroupServiceDeviceType()  # noqa: E501
        if include_optional :
            return GuaranteedAdGroupServiceDeviceType(
            )
        else :
            return GuaranteedAdGroupServiceDeviceType(
        )

    def testGuaranteedAdGroupServiceDeviceType(self):
        """Test GuaranteedAdGroupServiceDeviceType"""
