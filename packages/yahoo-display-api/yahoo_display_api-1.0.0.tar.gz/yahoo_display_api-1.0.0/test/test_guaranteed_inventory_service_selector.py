...
from yahoo_display_api.models.guaranteed_inventory_service_selector import GuaranteedInventoryServiceSelector  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestGuaranteedInventoryServiceSelector(unittest.TestCase):
    """GuaranteedInventoryServiceSelector unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test GuaranteedInventoryServiceSelector
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = yahoo_display_api.models.guaranteed_inventory_service_selector.GuaranteedInventoryServiceSelector()  # noqa: E501
        if include_optional :
            return GuaranteedInventoryServiceSelector(
                account_id = 56, 
                inventory_job_ids = [
                    56
                    ], 
    ...
    def testGuaranteedInventoryServiceSelector(self):
        """Test GuaranteedInventoryServiceSelector"""
