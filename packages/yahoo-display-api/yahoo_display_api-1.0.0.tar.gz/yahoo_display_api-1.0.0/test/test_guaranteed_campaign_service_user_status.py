...
from yahoo_display_api.models.guaranteed_campaign_service_user_status import GuaranteedCampaignServiceUserStatus  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestGuaranteedCampaignServiceUserStatus(unittest.TestCase):
    """GuaranteedCampaignServiceUserStatus unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_display_api.models.guaranteed_campaign_service_user_status.GuaranteedCampaignServiceUserStatus()  # noqa: E501
        if include_optional :
            return GuaranteedCampaignServiceUserStatus(
            )
        else :
            return GuaranteedCampaignServiceUserStatus(
        )

    def testGuaranteedCampaignServiceUserStatus(self):
        """Test GuaranteedCampaignServiceUserStatus"""
