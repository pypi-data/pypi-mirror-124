...
from yahoo_display_api.models.guaranteed_inventory_service_day_of_week import GuaranteedInventoryServiceDayOfWeek  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestGuaranteedInventoryServiceDayOfWeek(unittest.TestCase):
    """GuaranteedInventoryServiceDayOfWeek unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test GuaranteedInventoryServiceDayOfWeek
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = yahoo_display_api.models.guaranteed_inventory_service_day_of_week.GuaranteedInventoryServiceDayOfWeek()  # noqa: E501
        if include_optional :
            return GuaranteedInventoryServiceDayOfWeek(
            )
        else :
            return GuaranteedInventoryServiceDayOfWeek(
        )

    def testGuaranteedInventoryServiceDayOfWeek(self):
        """Test GuaranteedInventoryServiceDayOfWeek"""
