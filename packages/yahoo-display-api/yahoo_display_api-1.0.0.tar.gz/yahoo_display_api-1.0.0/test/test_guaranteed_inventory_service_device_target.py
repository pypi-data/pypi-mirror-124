...
from yahoo_display_api.models.guaranteed_inventory_service_device_target import GuaranteedInventoryServiceDeviceTarget  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestGuaranteedInventoryServiceDeviceTarget(unittest.TestCase):
    """GuaranteedInventoryServiceDeviceTarget unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test GuaranteedInventoryServiceDeviceTarget
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = yahoo_display_api.models.guaranteed_inventory_service_device_target.GuaranteedInventoryServiceDeviceTarget()  # noqa: E501
        if include_optional :
            return GuaranteedInventoryServiceDeviceTarget(
                device_type = 'DESKTOP'
            )
        else :
            return GuaranteedInventoryServiceDeviceTarget(
    ...
    def testGuaranteedInventoryServiceDeviceTarget(self):
        """Test GuaranteedInventoryServiceDeviceTarget"""
