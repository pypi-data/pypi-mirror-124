...
from yahoo_display_api.models.media_service_mutate_response import MediaServiceMutateResponse  # noqa: E501
...
class TestMediaServiceMutateResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_display_api.models.media_service_mutate_response.MediaServiceMutateResponse()  # noqa: E501
        if include_optional :
            return MediaServiceMutateResponse(
                ...
                rid = '0', 
                rval = yahoo_display_api.models.media_service_return_value.MediaServiceReturnValue(
                    values = [
                        yahoo_display_api.models.media_service_value.MediaServiceValue(
                            errors = [
                                yahoo_display_api.models.error.Error(
                                    code = '0', 
                                    message = '0', 
                            ...
                            media_record = yahoo_display_api.models.media_service_record.MediaServiceRecord(
                                account_id = 56, 
                                ...
                                logo_flg = 'FALSE', 
                                image_media = yahoo_display_api.models.media_service_image_media.MediaServiceImageMedia(
                                    media_type = 'IMAGE', 
                                    aspect_ratio = '0', 
                                    data = 'YQ==', 
                                    file_size = 56, 
