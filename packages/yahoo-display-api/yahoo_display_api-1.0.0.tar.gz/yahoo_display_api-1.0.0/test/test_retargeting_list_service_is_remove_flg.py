...
from yahoo_display_api.models.retargeting_list_service_is_remove_flg import RetargetingListServiceIsRemoveFlg  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestRetargetingListServiceIsRemoveFlg(unittest.TestCase):
    """RetargetingListServiceIsRemoveFlg unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_display_api.models.retargeting_list_service_is_remove_flg.RetargetingListServiceIsRemoveFlg()  # noqa: E501
        if include_optional :
            return RetargetingListServiceIsRemoveFlg(
            )
        else :
            return RetargetingListServiceIsRemoveFlg(
        )

    def testRetargetingListServiceIsRemoveFlg(self):
        """Test RetargetingListServiceIsRemoveFlg"""
