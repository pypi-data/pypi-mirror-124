...
from yahoo_display_api.models.guaranteed_inventory_service_device_type import GuaranteedInventoryServiceDeviceType  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestGuaranteedInventoryServiceDeviceType(unittest.TestCase):
    """GuaranteedInventoryServiceDeviceType unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test GuaranteedInventoryServiceDeviceType
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = yahoo_display_api.models.guaranteed_inventory_service_device_type.GuaranteedInventoryServiceDeviceType()  # noqa: E501
        if include_optional :
            return GuaranteedInventoryServiceDeviceType(
            )
        else :
            return GuaranteedInventoryServiceDeviceType(
        )

    def testGuaranteedInventoryServiceDeviceType(self):
        """Test GuaranteedInventoryServiceDeviceType"""
