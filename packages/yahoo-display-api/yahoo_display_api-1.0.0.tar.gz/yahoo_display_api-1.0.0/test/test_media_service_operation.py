...
from yahoo_display_api.models.media_service_operation import MediaServiceOperation  # noqa: E501
...
class TestMediaServiceOperation(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_display_api.models.media_service_operation.MediaServiceOperation()  # noqa: E501
        if include_optional :
            return MediaServiceOperation(
                account_id = 56, 
                operand = [
                    yahoo_display_api.models.media_service_record.MediaServiceRecord(
                        account_id = 56, 
