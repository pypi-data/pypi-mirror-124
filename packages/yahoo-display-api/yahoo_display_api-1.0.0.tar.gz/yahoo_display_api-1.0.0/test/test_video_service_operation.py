...
from yahoo_display_api.models.video_service_operation import VideoServiceOperation  # noqa: E501
...
class TestVideoServiceOperation(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_display_api.models.video_service_operation.VideoServiceOperation()  # noqa: E501
        if include_optional :
            return VideoServiceOperation(
                account_id = 56, 
                operand = [
                    yahoo_display_api.models.video.Video(
                        account_id = 56, 
