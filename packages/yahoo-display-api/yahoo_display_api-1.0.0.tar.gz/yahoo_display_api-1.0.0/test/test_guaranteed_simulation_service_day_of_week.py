...
from yahoo_display_api.models.guaranteed_simulation_service_day_of_week import GuaranteedSimulationServiceDayOfWeek  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestGuaranteedSimulationServiceDayOfWeek(unittest.TestCase):
    """GuaranteedSimulationServiceDayOfWeek unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_display_api.models.guaranteed_simulation_service_day_of_week.GuaranteedSimulationServiceDayOfWeek()  # noqa: E501
        if include_optional :
            return GuaranteedSimulationServiceDayOfWeek(
            )
        else :
            return GuaranteedSimulationServiceDayOfWeek(
        )

    def testGuaranteedSimulationServiceDayOfWeek(self):
        """Test GuaranteedSimulationServiceDayOfWeek"""
