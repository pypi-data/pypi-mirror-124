...
from yahoo_display_api.models.ad_group_target_service_placement_category_type import AdGroupTargetServicePlacementCategoryType  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestAdGroupTargetServicePlacementCategoryType(unittest.TestCase):
    """AdGroupTargetServicePlacementCategoryType unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test AdGroupTargetServicePlacementCategoryType
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = yahoo_display_api.models.ad_group_target_service_placement_category_type.AdGroupTargetServicePlacementCategoryType()  # noqa: E501
        if include_optional :
            return AdGroupTargetServicePlacementCategoryType(
            )
        else :
            return AdGroupTargetServicePlacementCategoryType(
        )

    def testAdGroupTargetServicePlacementCategoryType(self):
        """Test AdGroupTargetServicePlacementCategoryType"""
