...
from yahoo_display_api.models.guaranteed_inventory_service_viewable_frequency_cap import GuaranteedInventoryServiceViewableFrequencyCap  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestGuaranteedInventoryServiceViewableFrequencyCap(unittest.TestCase):
    """GuaranteedInventoryServiceViewableFrequencyCap unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test GuaranteedInventoryServiceViewableFrequencyCap
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = yahoo_display_api.models.guaranteed_inventory_service_viewable_frequency_cap.GuaranteedInventoryServiceViewableFrequencyCap()  # noqa: E501
        if include_optional :
            return GuaranteedInventoryServiceViewableFrequencyCap(
    ...
    def testGuaranteedInventoryServiceViewableFrequencyCap(self):
        """Test GuaranteedInventoryServiceViewableFrequencyCap"""
