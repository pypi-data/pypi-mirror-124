...
from yahoo_display_api.models.guaranteed_ad_group_service_device_os_type import GuaranteedAdGroupServiceDeviceOsType  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestGuaranteedAdGroupServiceDeviceOsType(unittest.TestCase):
    """GuaranteedAdGroupServiceDeviceOsType unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_display_api.models.guaranteed_ad_group_service_device_os_type.GuaranteedAdGroupServiceDeviceOsType()  # noqa: E501
        if include_optional :
            return GuaranteedAdGroupServiceDeviceOsType(
            )
        else :
            return GuaranteedAdGroupServiceDeviceOsType(
        )

    def testGuaranteedAdGroupServiceDeviceOsType(self):
        """Test GuaranteedAdGroupServiceDeviceOsType"""
