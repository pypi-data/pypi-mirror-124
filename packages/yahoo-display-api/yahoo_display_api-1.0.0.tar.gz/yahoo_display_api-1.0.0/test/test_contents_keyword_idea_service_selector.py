...
from yahoo_display_api.models.contents_keyword_idea_service_selector import ContentsKeywordIdeaServiceSelector  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestContentsKeywordIdeaServiceSelector(unittest.TestCase):
    """ContentsKeywordIdeaServiceSelector unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test ContentsKeywordIdeaServiceSelector
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = yahoo_display_api.models.contents_keyword_idea_service_selector.ContentsKeywordIdeaServiceSelector()  # noqa: E501
        if include_optional :
            return ContentsKeywordIdeaServiceSelector(
                keyword_ids = [
                    56
                    ], 
                keyword = yahoo_display_api.models.contents_keyword_idea_service_keyword.ContentsKeywordIdeaServiceKeyword(
                    keywords = [
                        '0'
                        ], 
                    match_type = 'EXACT', ), 
    ...
    def testContentsKeywordIdeaServiceSelector(self):
        """Test ContentsKeywordIdeaServiceSelector"""
