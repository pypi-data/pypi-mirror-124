...
from yahoo_display_api.models.media_service_selector import MediaServiceSelector  # noqa: E501
...
class TestMediaServiceSelector(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_display_api.models.media_service_selector.MediaServiceSelector()  # noqa: E501
        if include_optional :
            return MediaServiceSelector(
                ...
                created_date_range = yahoo_display_api.models.media_service_created_date_range.MediaServiceCreatedDateRange(
                    start_date = '0', 
                    end_date = '0', )
            )
        else :
