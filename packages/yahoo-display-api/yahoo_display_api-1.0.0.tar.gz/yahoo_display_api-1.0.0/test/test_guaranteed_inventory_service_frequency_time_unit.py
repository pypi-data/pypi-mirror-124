...
from yahoo_display_api.models.guaranteed_inventory_service_frequency_time_unit import GuaranteedInventoryServiceFrequencyTimeUnit  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestGuaranteedInventoryServiceFrequencyTimeUnit(unittest.TestCase):
    """GuaranteedInventoryServiceFrequencyTimeUnit unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test GuaranteedInventoryServiceFrequencyTimeUnit
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = yahoo_display_api.models.guaranteed_inventory_service_frequency_time_unit.GuaranteedInventoryServiceFrequencyTimeUnit()  # noqa: E501
        if include_optional :
            return GuaranteedInventoryServiceFrequencyTimeUnit(
            )
        else :
            return GuaranteedInventoryServiceFrequencyTimeUnit(
        )

    def testGuaranteedInventoryServiceFrequencyTimeUnit(self):
        """Test GuaranteedInventoryServiceFrequencyTimeUnit"""
