...
from yahoo_display_api.models.contents_keyword_list_service_selector import ContentsKeywordListServiceSelector  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestContentsKeywordListServiceSelector(unittest.TestCase):
    """ContentsKeywordListServiceSelector unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test ContentsKeywordListServiceSelector
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = yahoo_display_api.models.contents_keyword_list_service_selector.ContentsKeywordListServiceSelector()  # noqa: E501
        if include_optional :
            return ContentsKeywordListServiceSelector(
                account_id = 56, 
                number_results = 1, 
                contents_keyword_list_ids = [
                    56
                    ], 
                start_index = 1
            )
    ...
    def testContentsKeywordListServiceSelector(self):
        """Test ContentsKeywordListServiceSelector"""
