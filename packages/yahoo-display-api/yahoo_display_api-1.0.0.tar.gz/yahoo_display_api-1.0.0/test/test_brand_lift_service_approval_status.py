...
from yahoo_display_api.models.brand_lift_service_approval_status import BrandLiftServiceApprovalStatus  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestBrandLiftServiceApprovalStatus(unittest.TestCase):
    """BrandLiftServiceApprovalStatus unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_display_api.models.brand_lift_service_approval_status.BrandLiftServiceApprovalStatus()  # noqa: E501
        if include_optional :
            return BrandLiftServiceApprovalStatus(
            )
        else :
            return BrandLiftServiceApprovalStatus(
        )

    def testBrandLiftServiceApprovalStatus(self):
        """Test BrandLiftServiceApprovalStatus"""
