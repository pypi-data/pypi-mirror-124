...
from yahoo_display_api.models.report_definition_service_cross_campaign_type import ReportDefinitionServiceCrossCampaignType  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestReportDefinitionServiceCrossCampaignType(unittest.TestCase):
    """ReportDefinitionServiceCrossCampaignType unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_display_api.models.report_definition_service_cross_campaign_type.ReportDefinitionServiceCrossCampaignType()  # noqa: E501
        if include_optional :
            return ReportDefinitionServiceCrossCampaignType(
            )
        else :
            return ReportDefinitionServiceCrossCampaignType(
        )

    def testReportDefinitionServiceCrossCampaignType(self):
        """Test ReportDefinitionServiceCrossCampaignType"""
