...
from yahoo_display_api.models.campaign_label_service_operation import CampaignLabelServiceOperation  # noqa: E501
...
class TestCampaignLabelServiceOperation(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_display_api.models.campaign_label_service_operation.CampaignLabelServiceOperation()  # noqa: E501
        if include_optional :
            return CampaignLabelServiceOperation(
                account_id = 56, 
                operand = [
                    yahoo_display_api.models.campaign_label.CampaignLabel(
                        account_id = 56, 
                        campaign_id = 56, 
                        label_id = 56, )
                    ]
