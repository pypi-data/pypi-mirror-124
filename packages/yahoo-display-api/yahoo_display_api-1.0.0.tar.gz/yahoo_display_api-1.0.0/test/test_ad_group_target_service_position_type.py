...
from yahoo_display_api.models.ad_group_target_service_position_type import AdGroupTargetServicePositionType  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestAdGroupTargetServicePositionType(unittest.TestCase):
    """AdGroupTargetServicePositionType unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_display_api.models.ad_group_target_service_position_type.AdGroupTargetServicePositionType()  # noqa: E501
        if include_optional :
            return AdGroupTargetServicePositionType(
            )
        else :
            return AdGroupTargetServicePositionType(
        )

    def testAdGroupTargetServicePositionType(self):
        """Test AdGroupTargetServicePositionType"""
