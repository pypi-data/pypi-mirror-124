...
from yahoo_display_api.models.guaranteed_ad_group_ad_service_approval_status import GuaranteedAdGroupAdServiceApprovalStatus  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestGuaranteedAdGroupAdServiceApprovalStatus(unittest.TestCase):
    """GuaranteedAdGroupAdServiceApprovalStatus unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_display_api.models.guaranteed_ad_group_ad_service_approval_status.GuaranteedAdGroupAdServiceApprovalStatus()  # noqa: E501
        if include_optional :
            return GuaranteedAdGroupAdServiceApprovalStatus(
            )
        else :
            return GuaranteedAdGroupAdServiceApprovalStatus(
        )

    def testGuaranteedAdGroupAdServiceApprovalStatus(self):
        """Test GuaranteedAdGroupAdServiceApprovalStatus"""
