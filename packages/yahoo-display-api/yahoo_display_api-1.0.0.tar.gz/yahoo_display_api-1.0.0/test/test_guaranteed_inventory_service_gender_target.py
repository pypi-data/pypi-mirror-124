...
from yahoo_display_api.models.guaranteed_inventory_service_gender_target import GuaranteedInventoryServiceGenderTarget  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestGuaranteedInventoryServiceGenderTarget(unittest.TestCase):
    """GuaranteedInventoryServiceGenderTarget unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test GuaranteedInventoryServiceGenderTarget
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = yahoo_display_api.models.guaranteed_inventory_service_gender_target.GuaranteedInventoryServiceGenderTarget()  # noqa: E501
        if include_optional :
            return GuaranteedInventoryServiceGenderTarget(
                gender = 'ST_MALE'
            )
        else :
            return GuaranteedInventoryServiceGenderTarget(
    ...
    def testGuaranteedInventoryServiceGenderTarget(self):
        """Test GuaranteedInventoryServiceGenderTarget"""
