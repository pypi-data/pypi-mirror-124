...
from yahoo_display_api.models.conversion_tracker_service_exclude_previous_conversion import ConversionTrackerServiceExcludePreviousConversion  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestConversionTrackerServiceExcludePreviousConversion(unittest.TestCase):
    """ConversionTrackerServiceExcludePreviousConversion unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test ConversionTrackerServiceExcludePreviousConversion
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = yahoo_display_api.models.conversion_tracker_service_exclude_previous_conversion.ConversionTrackerServiceExcludePreviousConversion()  # noqa: E501
        if include_optional :
            return ConversionTrackerServiceExcludePreviousConversion(
            )
        else :
            return ConversionTrackerServiceExcludePreviousConversion(
        )

    def testConversionTrackerServiceExcludePreviousConversion(self):
        """Test ConversionTrackerServiceExcludePreviousConversion"""
