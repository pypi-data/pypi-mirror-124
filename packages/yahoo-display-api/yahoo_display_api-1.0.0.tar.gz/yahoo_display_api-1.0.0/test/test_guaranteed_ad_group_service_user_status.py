...
from yahoo_display_api.models.guaranteed_ad_group_service_user_status import GuaranteedAdGroupServiceUserStatus  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestGuaranteedAdGroupServiceUserStatus(unittest.TestCase):
    """GuaranteedAdGroupServiceUserStatus unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_display_api.models.guaranteed_ad_group_service_user_status.GuaranteedAdGroupServiceUserStatus()  # noqa: E501
        if include_optional :
            return GuaranteedAdGroupServiceUserStatus(
            )
        else :
            return GuaranteedAdGroupServiceUserStatus(
        )

    def testGuaranteedAdGroupServiceUserStatus(self):
        """Test GuaranteedAdGroupServiceUserStatus"""
