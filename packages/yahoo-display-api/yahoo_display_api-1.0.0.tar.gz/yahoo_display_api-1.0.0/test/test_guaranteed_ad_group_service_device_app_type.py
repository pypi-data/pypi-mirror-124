...
from yahoo_display_api.models.guaranteed_ad_group_service_device_app_type import GuaranteedAdGroupServiceDeviceAppType  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestGuaranteedAdGroupServiceDeviceAppType(unittest.TestCase):
    """GuaranteedAdGroupServiceDeviceAppType unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_display_api.models.guaranteed_ad_group_service_device_app_type.GuaranteedAdGroupServiceDeviceAppType()  # noqa: E501
        if include_optional :
            return GuaranteedAdGroupServiceDeviceAppType(
            )
        else :
            return GuaranteedAdGroupServiceDeviceAppType(
        )

    def testGuaranteedAdGroupServiceDeviceAppType(self):
        """Test GuaranteedAdGroupServiceDeviceAppType"""
