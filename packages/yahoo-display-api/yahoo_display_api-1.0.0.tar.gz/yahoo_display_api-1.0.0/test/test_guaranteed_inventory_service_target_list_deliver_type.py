...
from yahoo_display_api.models.guaranteed_inventory_service_target_list_deliver_type import GuaranteedInventoryServiceTargetListDeliverType  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestGuaranteedInventoryServiceTargetListDeliverType(unittest.TestCase):
    """GuaranteedInventoryServiceTargetListDeliverType unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test GuaranteedInventoryServiceTargetListDeliverType
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = yahoo_display_api.models.guaranteed_inventory_service_target_list_deliver_type.GuaranteedInventoryServiceTargetListDeliverType()  # noqa: E501
        if include_optional :
            return GuaranteedInventoryServiceTargetListDeliverType(
            )
        else :
            return GuaranteedInventoryServiceTargetListDeliverType(
        )

    def testGuaranteedInventoryServiceTargetListDeliverType(self):
        """Test GuaranteedInventoryServiceTargetListDeliverType"""
