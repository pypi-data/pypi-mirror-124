...
from yahoo_display_api.models.account_service_selector import AccountServiceSelector  # noqa: E501
...
class TestAccountServiceSelector(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_display_api.models.account_service_selector.AccountServiceSelector()  # noqa: E501
        if include_optional :
            return AccountServiceSelector(
                ...
                include_manager_account = 'EXCLUDE_MANAGER', 
                number_results = 1, 
                start_index = 1
            )
        else :
