...
from yahoo_display_api.models.guaranteed_inventory_service_placement_category_type import GuaranteedInventoryServicePlacementCategoryType  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestGuaranteedInventoryServicePlacementCategoryType(unittest.TestCase):
    """GuaranteedInventoryServicePlacementCategoryType unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test GuaranteedInventoryServicePlacementCategoryType
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = yahoo_display_api.models.guaranteed_inventory_service_placement_category_type.GuaranteedInventoryServicePlacementCategoryType()  # noqa: E501
        if include_optional :
            return GuaranteedInventoryServicePlacementCategoryType(
            )
        else :
            return GuaranteedInventoryServicePlacementCategoryType(
        )

    def testGuaranteedInventoryServicePlacementCategoryType(self):
        """Test GuaranteedInventoryServicePlacementCategoryType"""
