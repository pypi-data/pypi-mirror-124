...
from yahoo_display_api.models.account_management_service_client_type import AccountManagementServiceClientType  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestAccountManagementServiceClientType(unittest.TestCase):
    """AccountManagementServiceClientType unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_display_api.models.account_management_service_client_type.AccountManagementServiceClientType()  # noqa: E501
        if include_optional :
            return AccountManagementServiceClientType(
            )
        else :
            return AccountManagementServiceClientType(
        )

    def testAccountManagementServiceClientType(self):
        """Test AccountManagementServiceClientType"""
