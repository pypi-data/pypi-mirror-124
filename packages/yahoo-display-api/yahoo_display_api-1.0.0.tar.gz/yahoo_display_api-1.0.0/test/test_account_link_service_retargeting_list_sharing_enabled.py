...
from yahoo_display_api.models.account_link_service_retargeting_list_sharing_enabled import AccountLinkServiceRetargetingListSharingEnabled  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestAccountLinkServiceRetargetingListSharingEnabled(unittest.TestCase):
    """AccountLinkServiceRetargetingListSharingEnabled unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_display_api.models.account_link_service_retargeting_list_sharing_enabled.AccountLinkServiceRetargetingListSharingEnabled()  # noqa: E501
        if include_optional :
            return AccountLinkServiceRetargetingListSharingEnabled(
            )
        else :
            return AccountLinkServiceRetargetingListSharingEnabled(
        )

    def testAccountLinkServiceRetargetingListSharingEnabled(self):
        """Test AccountLinkServiceRetargetingListSharingEnabled"""
