...
from yahoo_display_api.models.guaranteed_inventory_service_mutate_response import GuaranteedInventoryServiceMutateResponse  # noqa: E501
from yahoo_display_api.rest import ApiException

class TestGuaranteedInventoryServiceMutateResponse(unittest.TestCase):
    """GuaranteedInventoryServiceMutateResponse unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test GuaranteedInventoryServiceMutateResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = yahoo_display_api.models.guaranteed_inventory_service_mutate_response.GuaranteedInventoryServiceMutateResponse()  # noqa: E501
        if include_optional :
            return GuaranteedInventoryServiceMutateResponse(
                ...
                rid = '0', 
                rval = yahoo_display_api.models.guaranteed_inventory_service_return_value.GuaranteedInventoryServiceReturnValue(
                    values = [
                        yahoo_display_api.models.guaranteed_inventory_service_value.GuaranteedInventoryServiceValue(
                            errors = [
                                yahoo_display_api.models.error.Error(
                                    code = '0', 
                                    message = '0', 
                            ...
                            guaranteed_inventory_job = yahoo_display_api.models.guaranteed_inventory_job.GuaranteedInventoryJob(
                                account_id = 56, 
                                inventory_job_id = 56, 
                                inventory_job_name = '0', 
                                notification_business_ids = [
                                    '0'
                                    ], 
                                inventory_job_start_date = '0', 
                                inventory_job_end_date = '0', 
                                created_business_id = '0', 
                                is_expired_package = True, 
                                inventory_job_status = 'PROCESSING', 
                                inventories = [
                                    yahoo_display_api.models.guaranteed_inventory.GuaranteedInventory(
                                        account_id = 56, 
                                        lifetime_budget = 56, 
                                        reach = 56, 
                                        v_imps = 56, 
    ...
    def testGuaranteedInventoryServiceMutateResponse(self):
        """Test GuaranteedInventoryServiceMutateResponse"""
