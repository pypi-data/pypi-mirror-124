...
class GuaranteedSimulationServiceTargetType(object):
    ...
    allowable_values = [AD_SCHEDULE_TARGET, GEO_TARGET, AGE_TARGET, GENDER_TARGET, DEVICE_TARGET, APP_TARGET, OS_TARGET, AUDIENCE_CATEGORY_TARGET, PLACEMENT_CATEGORY_TARGET, PLACEMENT_CATEGORY_DETAIL_TARGET, POSITION_TARGET, SITE_RETARGETING, UNKNOWN]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """GuaranteedSimulationServiceTargetType - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GuaranteedSimulationServiceTargetType):
            return False
