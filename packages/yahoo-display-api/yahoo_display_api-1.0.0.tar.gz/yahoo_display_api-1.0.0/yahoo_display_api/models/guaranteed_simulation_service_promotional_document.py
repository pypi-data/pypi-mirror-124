...
class GuaranteedSimulationServicePromotionalDocument(object):
    ...
    """
    openapi_types = {
        'files': 'list[GuaranteedSimulationServiceDocumentFile]'
    }
    ...
    def __init__(self, files=None, local_vars_configuration=None):  # noqa: E501
        """GuaranteedSimulationServicePromotionalDocument - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def files(self):
        """Gets the files of this GuaranteedSimulationServicePromotionalDocument.  # noqa: E501


        :return: The files of this GuaranteedSimulationServicePromotionalDocument.  # noqa: E501
        :rtype: list[GuaranteedSimulationServiceDocumentFile]
        """
        return self._files

    @files.setter
    def files(self, files):
        """Sets the files of this GuaranteedSimulationServicePromotionalDocument.


        :param files: The files of this GuaranteedSimulationServicePromotionalDocument.  # noqa: E501
        :type: list[GuaranteedSimulationServiceDocumentFile]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GuaranteedSimulationServicePromotionalDocument):
            return False
