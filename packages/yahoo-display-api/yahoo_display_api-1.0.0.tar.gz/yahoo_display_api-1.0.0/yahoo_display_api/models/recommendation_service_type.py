...
class RecommendationServiceType(object):
    ...
    allowable_values = [DAILY_BUDGET_OVER, IMPRESSION_SHARE_BUDGET_LOSS_OVER, BID_STRATEGY_TO_TARGET_CPA, SEARCH_KEYWORD_LIST_IDEA, CAMPAIGNS_FOR_ADDING_ADS, UNKNOWN]  # noqa: E501
