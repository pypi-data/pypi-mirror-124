...
class ReportDefinitionServiceType(object):
    ...
    allowable_values = [AD, AUDIENCE_CATEGORY, CONVERSION_PATH, CROSS_CAMPAIGN_REACHES, SITE_RETARGETING, SEARCH_TARGET, PLACEMENT_TARGET, LABEL, REACH, SITE_CATEGORY, URL, UNKNOWN]  # noqa: E501
