...
class GuaranteedSimulationServicePackagePermissionType(object):
    ...
    allowable_values = [FORBIDDEN, PERMITTED_NON_TARGET_ENABLE, PERMITTED_NON_TARGET_DISABLE, FIXED, UNKNOWN]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """GuaranteedSimulationServicePackagePermissionType - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GuaranteedSimulationServicePackagePermissionType):
            return False
