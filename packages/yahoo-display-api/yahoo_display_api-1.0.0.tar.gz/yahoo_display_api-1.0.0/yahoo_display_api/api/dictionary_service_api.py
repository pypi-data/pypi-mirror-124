...
class DictionaryServiceApi(object):
    ...
    def dictionary_service_get_station_placement_category_post(self, **kwargs):  # noqa: E501
        """dictionary_service_get_station_placement_category_post  # noqa: E501

        <div lang=\"ja\"> プレイスメントカテゴリリストに含まれる駅情報一覧を取得します。 </div> <div lang=\"en\">Obtains the list of station information included in placement category list.</div>   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.dictionary_service_get_station_placement_category_post(async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param DictionaryServicePlacementCategorySelector dictionary_service_placement_category_selector:
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.dictionary_service_get_station_placement_category_post_with_http_info(**kwargs)  # noqa: E501

    def dictionary_service_get_station_placement_category_post_with_http_info(self, **kwargs):  # noqa: E501
        """dictionary_service_get_station_placement_category_post  # noqa: E501

        <div lang=\"ja\"> プレイスメントカテゴリリストに含まれる駅情報一覧を取得します。 </div> <div lang=\"en\">Obtains the list of station information included in placement category list.</div>   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.dictionary_service_get_station_placement_category_post_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(DictionaryServiceGetPlacementCategoryResponse, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        all_params = [
            'dictionary_service_placement_category_selector'
        ]
        all_params.extend(
            [
                'async_req',
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method dictionary_service_get_station_placement_category_post" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        ...
        body_params = None
        if 'dictionary_service_placement_category_selector' in local_var_params:
            body_params = local_var_params['dictionary_service_placement_category_selector']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
        ...
        return self.api_client.call_api(
            '/DictionaryService/getStationPlacementCategory', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='DictionaryServiceGetPlacementCategoryResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
