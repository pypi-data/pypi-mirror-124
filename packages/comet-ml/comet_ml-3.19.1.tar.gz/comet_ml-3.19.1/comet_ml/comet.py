...
class Streamer(BaseStreamer):
    ...
    def _send_ws_message(self, message, offset):
        ...
        """The method to be used as callback for parameters batching processing"""
        try:
