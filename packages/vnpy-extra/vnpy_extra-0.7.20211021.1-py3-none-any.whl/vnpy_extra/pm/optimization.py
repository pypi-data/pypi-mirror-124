...
def fit_and_merge_key_stats_dic(
        ...
        max_vt_symbol_weight=None, max_strategy_weight=None, **kwargs
    ...
    if max_vt_symbol_weight:
        ...
        _key_weight_dic = update_weights_dic_by_constrain(_key_weight_dic, key_vt_symbol_dic, max_vt_symbol_weight)
    ...
    if max_strategy_weight:
        ...
        _key_weight_dic = update_weights_dic_by_constrain(_key_weight_dic, key_strategy_dic, max_strategy_weight)
...
def update_weights_dic_by_constrain(key_weight_dic, key_group_dic, max_weight):
    ...
    for key, weight in key_weight_dic.items():
        group_weight_pairs_dic[key_group_dic[key]].append(
            (key, weight))
