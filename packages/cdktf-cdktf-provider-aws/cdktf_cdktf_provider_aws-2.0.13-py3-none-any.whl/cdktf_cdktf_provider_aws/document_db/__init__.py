...
class DocdbClusterParameterGroup(
    ...
    def parameter(
        ...
        return typing.cast(typing.Optional[typing.List["DocdbClusterParameterGroupParameter"]], jsii.get(self, "parameter"))

    @parameter.setter
    def parameter(
        self,
        value: typing.Optional[typing.List["DocdbClusterParameterGroupParameter"]],
    ) -> None:
