...
class CloudhsmV2Cluster(
    ...
    def source_backup_identifier(self) -> typing.Optional[builtins.str]:
        return typing.cast(typing.Optional[builtins.str], jsii.get(self, "sourceBackupIdentifier"))

    @source_backup_identifier.setter
    def source_backup_identifier(self, value: typing.Optional[builtins.str]) -> None:
...
class DataAwsCloudhsmV2Cluster(
    ...
    def cluster_state(self) -> typing.Optional[builtins.str]:
        return typing.cast(typing.Optional[builtins.str], jsii.get(self, "clusterState"))

    @cluster_state.setter
    def cluster_state(self, value: typing.Optional[builtins.str]) -> None:
