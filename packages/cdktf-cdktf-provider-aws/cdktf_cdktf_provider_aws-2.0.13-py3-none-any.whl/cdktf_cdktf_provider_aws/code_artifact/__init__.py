...
class CodeartifactDomainPermissionsPolicy(
    ...
    def policy_revision(self) -> typing.Optional[builtins.str]:
        return typing.cast(typing.Optional[builtins.str], jsii.get(self, "policyRevision"))

    @policy_revision.setter
    def policy_revision(self, value: typing.Optional[builtins.str]) -> None:
...
class CodeartifactRepository(
    ...
    def upstream(
        ...
        return typing.cast(typing.Optional[typing.List["CodeartifactRepositoryUpstream"]], jsii.get(self, "upstream"))

    @upstream.setter
    def upstream(
        self,
        value: typing.Optional[typing.List["CodeartifactRepositoryUpstream"]],
    ) -> None:
