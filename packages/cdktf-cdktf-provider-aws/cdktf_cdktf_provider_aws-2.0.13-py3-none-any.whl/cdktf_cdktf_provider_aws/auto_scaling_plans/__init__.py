...
class AutoscalingplansScalingPlanApplicationSourceOutputReference(
    ...
    def cloudformation_stack_arn(self) -> typing.Optional[builtins.str]:
        return typing.cast(typing.Optional[builtins.str], jsii.get(self, "cloudformationStackArn"))

    @cloudformation_stack_arn.setter
    def cloudformation_stack_arn(self, value: typing.Optional[builtins.str]) -> None:
    ...
    def tag_filter(
        ...
        return typing.cast(typing.Optional[typing.List["AutoscalingplansScalingPlanApplicationSourceTagFilter"]], jsii.get(self, "tagFilter"))

    @tag_filter.setter
    def tag_filter(
        self,
        value: typing.Optional[typing.List["AutoscalingplansScalingPlanApplicationSourceTagFilter"]],
    ) -> None:
