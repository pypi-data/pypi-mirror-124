...
class GlacierVault(
    ...
    def access_policy(self) -> typing.Optional[builtins.str]:
        return typing.cast(typing.Optional[builtins.str], jsii.get(self, "accessPolicy"))

    @access_policy.setter
    def access_policy(self, value: typing.Optional[builtins.str]) -> None:
...
class GlacierVaultLock(
    ...
    def ignore_deletion_error(
        ...
        return typing.cast(typing.Optional[typing.Union[builtins.bool, cdktf.IResolvable]], jsii.get(self, "ignoreDeletionError"))
