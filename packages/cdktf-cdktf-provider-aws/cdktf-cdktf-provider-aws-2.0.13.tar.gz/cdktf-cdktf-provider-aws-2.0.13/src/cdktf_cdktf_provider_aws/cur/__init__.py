...
class CurReportDefinition(
    ...
    def refresh_closed_reports(
        ...
        return typing.cast(typing.Optional[typing.Union[builtins.bool, cdktf.IResolvable]], jsii.get(self, "refreshClosedReports"))
    ...
    def report_versioning(self) -> typing.Optional[builtins.str]:
        return typing.cast(typing.Optional[builtins.str], jsii.get(self, "reportVersioning"))

    @report_versioning.setter
    def report_versioning(self, value: typing.Optional[builtins.str]) -> None:
