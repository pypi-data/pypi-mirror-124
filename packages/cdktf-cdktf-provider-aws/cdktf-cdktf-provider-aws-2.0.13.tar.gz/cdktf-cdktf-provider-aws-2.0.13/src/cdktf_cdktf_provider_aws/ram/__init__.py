...
class DataAwsRamResourceShare(
    ...
    def filter(self) -> typing.Optional[typing.List["DataAwsRamResourceShareFilter"]]:
        return typing.cast(typing.Optional[typing.List["DataAwsRamResourceShareFilter"]], jsii.get(self, "filter"))

    @filter.setter
    def filter(
        self,
        value: typing.Optional[typing.List["DataAwsRamResourceShareFilter"]],
    ) -> None:
...
class RamResourceShare(
    ...
    def allow_external_principals(
        ...
        return typing.cast(typing.Optional[typing.Union[builtins.bool, cdktf.IResolvable]], jsii.get(self, "allowExternalPrincipals"))
