...
class CodepipelineWebhookAuthenticationConfigurationOutputReference(
    ...
    def allowed_ip_range(self) -> typing.Optional[builtins.str]:
        return typing.cast(typing.Optional[builtins.str], jsii.get(self, "allowedIpRange"))

    @allowed_ip_range.setter
    def allowed_ip_range(self, value: typing.Optional[builtins.str]) -> None:
        jsii.set(self, "allowedIpRange", value)

    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="secretToken")
    def secret_token(self) -> typing.Optional[builtins.str]:
        return typing.cast(typing.Optional[builtins.str], jsii.get(self, "secretToken"))

    @secret_token.setter
    def secret_token(self, value: typing.Optional[builtins.str]) -> None:
