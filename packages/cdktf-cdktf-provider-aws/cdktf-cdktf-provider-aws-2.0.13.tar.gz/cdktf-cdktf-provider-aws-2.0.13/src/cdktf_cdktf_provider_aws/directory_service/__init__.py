...
class DirectoryServiceDirectory(
    ...
    def enable_sso(
        ...
        return typing.cast(typing.Optional[typing.Union[builtins.bool, cdktf.IResolvable]], jsii.get(self, "enableSso"))
    ...
    def size(self) -> typing.Optional[builtins.str]:
        return typing.cast(typing.Optional[builtins.str], jsii.get(self, "size"))

    @size.setter
    def size(self, value: typing.Optional[builtins.str]) -> None:
