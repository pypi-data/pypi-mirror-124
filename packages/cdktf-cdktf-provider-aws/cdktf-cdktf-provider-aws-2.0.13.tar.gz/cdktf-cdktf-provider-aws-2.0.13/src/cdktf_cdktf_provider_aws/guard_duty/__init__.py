...
class GuarddutyMember(
    ...
    def disable_email_notification(
        ...
        return typing.cast(typing.Optional[typing.Union[builtins.bool, cdktf.IResolvable]], jsii.get(self, "disableEmailNotification"))
...
class GuarddutyPublishingDestination(
    ...
    def destination_type(self) -> typing.Optional[builtins.str]:
        return typing.cast(typing.Optional[builtins.str], jsii.get(self, "destinationType"))

    @destination_type.setter
    def destination_type(self, value: typing.Optional[builtins.str]) -> None:
