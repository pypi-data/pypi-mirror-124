...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'digitalocean', '4.8.0-alpha.1634661669+f3465b9f'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource digitalocean 4.8.0-alpha.1634661669+f3465b9f`
                """)
            else:
                raise
