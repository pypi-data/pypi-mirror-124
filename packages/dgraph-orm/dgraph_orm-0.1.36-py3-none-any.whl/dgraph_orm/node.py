...
class Node(BaseModel):
    ...
    def base_set_remove_d(
        ...
        for field_name in self.Dgraph.patch_model.__fields__.keys():
            ...
            if current_val != original_val:
                ...
                if {type(current_val), type(original_val)} & {list, set}:
    ...
    async def _add(
        ...
        *,
        ...
        j = await gql(query_str=query_str, variables=variables, url=cls.Dgraph.url)
    ...
    async def update_from_set_remove_ds(
        ...
        *,
        ...
        j = await gql(query_str=query_str, variables=variables, url=self.Dgraph.url)
