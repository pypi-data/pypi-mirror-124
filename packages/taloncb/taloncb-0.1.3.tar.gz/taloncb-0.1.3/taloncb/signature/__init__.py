...
EXTRACTOR_FILENAME = pkg_resources.resource_stream('taloncb', 'signature/data/classifier')
EXTRACTOR_DATA = pkg_resources.resource_stream('taloncb', 'signature/data/train.data')
