...
EXTRACTOR_FILENAME = pkg_resources.resource_filename('taloncb', 'signature/data/classifier')
EXTRACTOR_DATA = pkg_resources.resource_filename('taloncb', 'signature/data/train.data')
