...
EXTRACTOR_FILENAME = pkg_resources.resources_filename('taloncb', 'signature/data/classifier')
EXTRACTOR_DATA = pkg_resources.resources_filename('taloncb', 'signature/data/train.data')
