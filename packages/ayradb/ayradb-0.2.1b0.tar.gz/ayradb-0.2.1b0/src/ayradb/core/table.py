...
class Table:
    ...
    def create(self, fill_type, columns: [], table_max_size=1, key_max_size=-1, replication=MINIMUM_REPLICATION) -> Promise:
    ...
    def restructure(self, columns: [], servers: [], table_max_size=1, replication=MINIMUM_REPLICATION) -> Promise:
        return restructure_table(self.name, servers, table_max_size, replication, columns)
