...
import logging
import base64
# добавил "QApplication, QListView"
from PyQt5.QtWidgets import QMainWindow, qApp, QMessageBox, QApplication, QListView
from PyQt5.QtGui import QStandardItemModel, QStandardItem, QBrush, QColor
# добавил "QEvent"
from PyQt5.QtCore import pyqtSlot, QEvent, Qt
# import sys
# добавляем крипто-библиотеки
...
# from packets.packet_client.client.common.errors import ServerError
...
class ClientMainWindow(QMainWindow):
    ...
    def __init__(self, database, transport, keys):
        ...
        # Дополнительно требующиеся атрибуты
    ...
    def select_active_user(self):
        ...
        """
        # Выбранный пользователем (даблклик) находится в выделеном элементе
        # в QListView
    ...
    def message(self, message):
        ...
        if sender == self.current_chat:
            ...
            if self.database.check_contact(sender):
                ...
                print('NO')
                # Раз нет, спрашиваем хотим ли добавить пользователя в контакты.
                if self.messages.question(self, 'Новое сообщение',
