...
# from server.common import ServerError
...
if __name__ == '__main__':
    ...
    if not client_name or not client_passwd:
        ...
        if start_dialog.ok_pressed:
            ...
            # при выкатывании в прод логирование имени и пароля пользователя запрещено
    ...
    keys.publickey().export_key()
    # ключь успешно загружен
    logger.debug("Keys sucсessfully loaded.")
